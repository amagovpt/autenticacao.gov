...
##
## The package name (e.g. pteid) is required in input. Optionally the name
...
if(@ARGV < 1)
{
  print STDERR "[Error] $0: Error! The package name was not given.\n" .
    "Please specify for which package we are packing the tarball (e.g. \"pteid\").\n".
...
## -- parse the version tag from _Builds/pteidversions.mak instead
...
## we want the files to be tarred into the directory pteid_x.y.z/
#######################################################################
