...
public class main
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			//--------------------------------------------
			for (int readerIdx = 0; readerIdx < PTEID_ReaderSet.instance().readerCount(); readerIdx++)
			{
				PTEID_ReaderContext readerContext = PTEID_ReaderSet.instance().getReaderByNum(readerIdx);
		...
		{
			System.out.println("PTEID_ExParamRange caught");
		}
