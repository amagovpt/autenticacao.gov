Portugal eID Firefox Extension
=============================
...
3. Close Firefox
4. Create a file portugaleid@eid.portugal.be. This file should contain the path to the your development directory where install.rdf can be found. 
...
7. Copy portugaleid@eid.portugal.be to the extensions folder
...
* Build on Windows
  ...
  Run build.bat. This will produce a file portugaleid.xpi in the same folder

* Build on Linux
  Run build.sh. This will produce a file portugaleid.xpi in the same folder. 

File Structure
--------------
portugaleid_extension
  portugaleid                    source code
    content
	  -- xul and js files
    defaults
      preferences
      portugaleid.js             platform independent configuration defaults 
    locale
      <lang>
        portugaleid.dtd          translation file
	portugaleid.properties   translation file
     platform
       Darwin
         defaults
           preferences
             portugaleid.js       Mac OS X configuration defaults 
       Linux
         defaults
           preferences
             portugaleid.js       Linux configuration defaults 
       WINNT
         defaults
           preferences
             portugaleid.js       Windows configuration defaults 
    skin
      icon.png                  icon that appears in addon list
      overlay.css               style file
    chrome.manifest           
    install.rdf               
  portugaleid@eid.portugal.be     file to put in extensions directory for testing
