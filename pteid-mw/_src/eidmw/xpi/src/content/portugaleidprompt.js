...
be.fedict.portugaleidpkcs11.portugaleidprompt = function() {
  ...
  if (infobody.textContent.search("BELPIC") != -1) {
    ...
    // set icon
    infoicon.setAttribute("src", "chrome://portugaleid/skin/icon40x40.png");
...
window.addEventListener("load", function() { be.fedict.portugaleidpkcs11.portugaleidprompt(); }, false);
