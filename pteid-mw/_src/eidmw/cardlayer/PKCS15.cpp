...
namespace eIDMW
{
  ...
  const static tPin PinBeidV1       = {true, "Basic PIN",0,1,1,1,0,NO_ID, 4, 8, 12, 1, 0xFF,PIN_ENC_ASCII,"","3F00"};
  const static tPin pinBeidAuthV2   = {true, "Authentication",0,1,1,1,0,NO_ID, 4, 8, 12, 0x85, 0xFF,PIN_ENC_ASCII,"","3F00"};
  const static tPin pinBeidSignV2   = {true, "Signature",0,1,1,1,0,NO_ID,4, 8, 12, 0x86, 0xFF,PIN_ENC_ASCII,"","3F00"};

  const static tPrivKey KeyAuthBeidV1 = {true, "Authentication", 0,2,0,1,0,0,0x82,"3F005F00", 256,true};
  const static tPrivKey KeySignBeidV1 = {true, "Signature", 0,3,0,1,0,0,0x83,"3F005F00", 256,true};
  const static tPrivKey KeyAuthBeidV2 = {true, "Authentication", 0,2,0,2,0,0,0x8A,"3F005F00", 256,true};
  const static tPrivKey KeySignBeidV2 = {true, "Signature", 0,3,0,2,0,0,0x89,"3F005F00", 256,true};
