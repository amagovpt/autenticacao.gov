...
%javaexception("java.lang.Exception") getRawData_PersoData	JAVA_CODE_THROW
...
%javaexception("java.lang.Exception") isFromPTeidValidChain	   JAVA_CODE_THROW
...
//--------------------------------------------------
%typemap(javaout) bool eIDMW::PTEID_Pin::changePin(const char *csPin1,const char *csPin2,unsigned long &ulRemaining)
{
	  long		pRemaining	= pteidlibJava_WrapperJNI.new_ulongp();				// get a C++ ptr
