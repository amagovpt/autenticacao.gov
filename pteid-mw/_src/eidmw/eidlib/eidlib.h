...
public:
	...
	PTEIDSDK_API virtual void setAllowTestCard(bool allow);
	  ...
	  */
	PTEIDSDK_API virtual PTEID_CertifStatus getDataStatus();
	...
	PTEIDSDK_API PTEID_Picture& getPicture();					/**< Get the picture document */
	...
	PTEIDSDK_API PTEID_Certificate &getRrn();					/**< Return the RRN certificate from the card */
	...
	PTEIDSDK_API virtual const PTEID_ByteArray& getRawData(PTEID_RawDataType type);
 	...
 	PTEIDSDK_API const PTEID_ByteArray& getRawData_Picture();			/**< Get the picture RawData */
 	...
 	PTEIDSDK_API const PTEID_ByteArray& getRawData_CertRRN();			/**< Get the Cert RRN RawData */
...
/******************************************************************************//**
  ...
  *********************************************************************************/
class PTEID_Picture : public PTEID_Biometric
{
public:
	PTEIDSDK_API virtual ~PTEID_Picture();				/**< Destructor */

	PTEIDSDK_API const PTEID_ByteArray& getData();		/**< Return the picture itself (jpg format) */
	PTEIDSDK_API const PTEID_ByteArray& getHash();		/**< Return the hash of the picture */

private:
	PTEID_Picture(const PTEID_Picture& doc);				/**< Copy not allowed - not implemented */
	PTEID_Picture& operator= (const PTEID_Picture& doc);	/**< Copy not allowed - not implemented */

	PTEID_Picture(const SDK_Context *context,APL_PictureEid *impl);/**< For internal use : Constructor */

friend PTEID_Picture& PTEID_EIDCard::getPicture();		/**< For internal use : This method must access protected constructor */
};
...
public:
	...
	PTEIDSDK_API const char *getNobility();				/**< Return Nobility field */
	PTEIDSDK_API const char *getNationality();			/**< Return Nationality field */
	PTEIDSDK_API const char *getNationalNumber();		/**< Return National Number field */
	...
	PTEIDSDK_API const char *getLogicalNumber();			/**< Return Logical Number field */
	PTEIDSDK_API const char *getChipNumber();			/**< Return Chip Number field */
	PTEIDSDK_API const char *getValidityBeginDate();		/**< Return Validity Begin Date field */
	PTEIDSDK_API const char *getValidityEndDate();		/**< Return Validity End Date field */
	PTEIDSDK_API const char *getIssuingMunicipality();	/**< Return Issuing Municipality field */
	...
	PTEIDSDK_API	const char *getSocialSecurityNo();				/**< Return field SocialSecurityNo */
	PTEIDSDK_API	const char *getHealthNo();						/**< Return field HealthNo */
	...
	PTEIDSDK_API	const char *getPhoto();							/**< Return field Photo */
...
public:
	...
	/**
	  ...
	  * @return true if success and false if failed
	  */
	PTEIDSDK_API bool changePin(const char *csPin1,const char *csPin2,unsigned long &ulRemaining);
