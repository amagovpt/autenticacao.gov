...
const char *PTEID_EId::getNobility()
{
	const char *out = NULL;
...
const char *PTEID_EId::getNationalNumber()
{
	const char *out = NULL;
...
const char *PTEID_EId::getChipNumber()
{
	const char *out = NULL;
...
const char *PTEID_EId::getMunicipality()
{
	const char *out = NULL;
...
const char *PTEID_EId::getSocialSecurityNo()
{
	const char *out = NULL;
...
const char *PTEID_EId::getHealthNo()
{
	const char *out = NULL;
...
const char *PTEID_EId::getCivilParish()
{
	const char *out = NULL;
...
const char *PTEID_EId::getStreetName()
{
	const char *out = NULL;
...
const char *PTEID_EId::getStreetType1()
{
	const char *out = NULL;
...
const char *PTEID_EId::getStreetType2()
{
	const char *out = NULL;
...
const char *PTEID_EId::getBuildingType1()
{
	const char *out = NULL;
...
const char *PTEID_EId::getBuildingType2()
{
	const char *out = NULL;
...
const char *PTEID_EId::getDoorNo()
{
	const char *out = NULL;
...
const char *PTEID_EId::getLocality()
{
	const char *out = NULL;
...
const char *PTEID_EId::getPostalLocality()
{
	const char *out = NULL;
...
const char *PTEID_EId::getDistrict()
{
	const char *out = NULL;
...
---------------------------------------- PTEID_Picture -----------------------------------------
*****************************************************************************************/
PTEID_Picture::PTEID_Picture(const SDK_Context *context,APL_PictureEid *impl):PTEID_Biometric(context,impl)
{
}

PTEID_Picture::~PTEID_Picture()
{
}

const PTEID_ByteArray& PTEID_Picture::getData()
{
	PTEID_ByteArray *out = NULL;
	...
	out = dynamic_cast<PTEID_ByteArray *>(getObject(INCLUDE_OBJECT_PICTUREEID_DATA));
	...
	if(!out)
	{
		...
		//if(!pbytearray)
		//{
			out = new PTEID_ByteArray(m_context,ppicture->getData());
			if(out)
...
const PTEID_ByteArray& PTEID_Picture::getHash()
{
	PTEID_ByteArray *out = NULL;
	...
	out = dynamic_cast<PTEID_ByteArray *>(getObject(INCLUDE_OBJECT_PICTUREEID_HASH));
	...
	if(!out)
	{
		...
		//if(!pbytearray)
		//{
			out = new PTEID_ByteArray(m_context,ppicture->getHash());
			if(out)
