...
PTEID_Certificate &PTEID_Certificates::getRrn()
{
	return getCert(PTEID_CERTIF_TYPE_RRN);
}
...
bool PTEID_Pin::changePin(const char *csPin1,const char *csPin2,unsigned long &ulRemaining)
{
	bool out = false;
