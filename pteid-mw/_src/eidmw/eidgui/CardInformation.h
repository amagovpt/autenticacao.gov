...
enum eCARD_BASETYPE
{
	...
	bool RetrieveData(PTEID_EIDCard& Card)
	{
		...
		try
		{
			...
			m_Fields[CHIP_NUMBER]		= QString::fromUtf8(pteid_eid.getChipNumber());
...
#define ADDRESS_POSTALLOCALITY	"address_postallocality"
	...
	bool RetrieveData(PTEID_EIDCard& Card)
	{
		...
		//m_Fields[ADDRESS_CITY]				= QString::fromUtf8(pteid_eid.getMunicipality());
...
// 		qDebug() << "Retrieving picture...";
		PTEID_EId& pteid_eid = Card.getID();
		m_pPictureData = QByteArray(pteid_eid.getPhoto(),14128);
...
#define PHOTO				"photo"
#define MEMBEROFFAMILY		"memberoffamily"
...
#define INITIALS		"initials"
	...
	bool RetrieveData(PTEID_EIDCard& Card)
	{
		...
		m_Fields[NATIONALNUMBER]			= QString::fromUtf8(pteid_eid.getNationalNumber());
		...
		m_Fields[TITLE]						= QString::fromUtf8(pteid_eid.getNobility());
		...
		m_Fields[HEALTHNO]					= QString::fromUtf8(pteid_eid.getHealthNo());
		m_Fields[SOCIALSECURITYNO]			= QString::fromUtf8(pteid_eid.getSocialSecurityNo());
		...
		m_Fields[MEMBEROFFAMILY]			= QString::fromUtf8(pteid_eid.getMemberOfFamily());
