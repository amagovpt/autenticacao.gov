...
bool CardInformation::LoadDataAddress(BEID_EIDCard& Card, QString const& cardReader)
{
	bool bRetVal = false;
...
bool CardInformation::LoadDataPersoData(BEID_EIDCard& Card, QString const& cardReader)
{
	bool bRetVal = false;
...
bool CardInformation::LoadDataCertificates(BEID_EIDCard& Card, QString const& cardReader)
{
	bool bRetVal = false;
