...
#define TRANSLATION_FILE_PREFIX	"eidmw_"
	...
	void Show_Address_Card(BEID_EIDCard& Card);
	void Show_PersoData_Card(BEID_EIDCard& Card);
	void Show_Certificates_Card(BEID_EIDCard& Card);
	void Show_Memory_Card(BEID_MemoryCard& Card);
	void LoadDataID(BEID_EIDCard& Card);
	void LoadDataAddress(BEID_EIDCard& Card);
	void LoadDataPersoData(BEID_EIDCard& Card);
	void LoadDataCertificates(BEID_EIDCard& Card);
