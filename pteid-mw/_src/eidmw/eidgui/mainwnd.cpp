...
{
	m_ui.lblIdentity_ImgPerson->setPixmap(m_imgPicture);
	//m_ui.lblIdentity_ImgPerson->setFixedHeight(10);
	//m_ui.lblIdentity_ImgPerson->setFixedWidth(10);
	...
	m_ui.txtIdentity_Parents->setText( CardFields[MEMBEROFFAMILY] );
	m_ui.txtIdentity_Parents->setAccessibleName( CardFields[MEMBEROFFAMILY] );
}
...
void MainWnd::refreshTabPersoData( void )
{
	...
	tFieldMap& PersoDataFields = m_CI_Data.m_PersonInfo.m_PersoDataInfo.getFields();
