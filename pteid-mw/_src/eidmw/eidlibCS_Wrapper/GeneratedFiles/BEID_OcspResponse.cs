...
public class BEID_OcspResponse : BEID_Object {
  ...
  public BEID_OcspResponse(string uri, BEID_HashAlgo hashAlgorithm, BEID_ByteArray issuerNameHash, BEID_ByteArray issuerKeyHash, BEID_ByteArray serialNumber) : this(beidlib_dotNetPINVOKE.new_BEID_OcspResponse(uri, (int)hashAlgorithm, BEID_ByteArray.getCPtr(issuerNameHash), BEID_ByteArray.getCPtr(issuerKeyHash), BEID_ByteArray.getCPtr(serialNumber)), true) {
