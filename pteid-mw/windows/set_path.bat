...
::=====================================
@set PTEID_DIR_QT_334=C:\Program Files\qt-win-free-msvc-3.3.4

::Qt 4.5.0 exe (uic, moc and rcc)
::===============================
@set PTEID_DIR_QT_450_EXE=C:\qt-win-opensource-src-4.5.0

::Qt 4.5.0 include
::================
@set PTEID_DIR_QT_450_INCLUDE=C:\qt-win-opensource-src-4.5.0

::Qt 4.5.0 dynamic library
::========================
@set PTEID_DIR_QT_450_DYNAMIC=C:\qt-win-opensource-src-4.5.0
...
::OpenSSL 0.9.8g
::==============
@set PTEID_DIR_OPENSSL_098G=C:\OpenSSL

::Xercess 3.1.0
::=============
@set PTEID_DIR_XERCES_310=C:\pteid-mw\_src\ThirdParty\xerces\Xerces-3.1.0

::7zip
::=============
@set PTEID_DIR_7ZIP=C:\pteid-mw\_src\ThirdParty\7-Zip
...
::====================================
@set PTEID_DIR_DOXYGEN=C:\Documents and Settings\Administrator\Desktop\doxygen
...
::====================
@set PTEID_DIR_MSM=C:\Program Files\Common Files\Merge Modules
