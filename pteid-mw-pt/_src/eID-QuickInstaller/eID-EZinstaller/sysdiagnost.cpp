...
bool CSysDiagnost::isMiddlewareLocked(void)											// I
{
	...
	if(!bUsed) bUsed=isLibraryUsed("pteid35common.dll");					//3.5

	if(!bUsed) bUsed=isLibraryUsed("pteidcommon.dll");					//3.0

	if(!bUsed) bUsed=isLibraryUsed("pteidwinscard.dll");					//2.5, 2.6
	if(!bUsed) bUsed=isLibraryUsed("pteidcsp.dll");						//2.5, 2.6
