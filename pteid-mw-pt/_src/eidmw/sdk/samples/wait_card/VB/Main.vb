...
Public Class frmMain
    ...
    Dim m_ReaderSet As PTEID_ReaderSet
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuit.Click
        ...
        Catch ex As PTEID_Exception
            MessageBox.Show("Crash PTEID_Exception : " & ex.GetError().ToString())
            PTEID_ReaderSet.releaseSDK()
            Application.Exit()
    ...
    Private Sub frmMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            m_ReaderSet = PTEID_ReaderSet.instance()
    ...
    Private Sub RunThread()
        Try
            ...
            Dim reader As PTEID_ReaderContext = WaitForCardPresent(5)
            ...
            Else
                ...
                Dim card As PTEID_EIDCard = reader.getEIDCard()
    ...
    '*****************************************************************************
    Private Function WaitForCardPresent(ByVal Timeout As Integer) As PTEID_ReaderContext
        Try
            Dim reader As PTEID_ReaderContext = Nothing
            ...
            While (bContinue)
                ...
                'if no reader is connected, an PTEID_ExNoReader exception is thrown
