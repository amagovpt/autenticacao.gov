...
copy /Y "..\..\..\pteidlib\dotNet\bin\release\pteid35libCS_Wrapper.dll" bin\release\
copy /Y "..\..\..\pteidlib\dotNet\bin\debug\pteid35libCS_Wrapper.dll" bin\debug\

copy /Y "..\..\..\pteidlib\dotNet\bin\release\pteid35libCS.dll" bin\release\
copy /Y "..\..\..\pteidlib\dotNet\bin\debug\pteid35libCS.dll" bin\debug\
