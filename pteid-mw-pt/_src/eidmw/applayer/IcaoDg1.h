...
public:
  ...
  EIDMW_APL_API std::string documentCode() const;
  EIDMW_APL_API std::string issuingOrg() const;
  EIDMW_APL_API std::string serialNumber() const;
  EIDMW_APL_API int serialNumberCheckDigit() const;
  EIDMW_APL_API std::string optionalData() const;
  EIDMW_APL_API std::string birthDay() const;
  EIDMW_APL_API int birthDayCheckDigit() const;
  EIDMW_APL_API char sex() const;
  EIDMW_APL_API std::string expireDay() const;
  EIDMW_APL_API int expireDayCheckDigit() const;
  EIDMW_APL_API std::string nationality() const;
  EIDMW_APL_API std::string optionalDataSecondLine() const;
  EIDMW_APL_API int optionalDataSecondLineCheckDigit() const;
  EIDMW_APL_API int compositeCheckDigit() const;
  EIDMW_APL_API std::string primaryIdentifier() const;
  EIDMW_APL_API std::string secondaryIdentifier() const;
