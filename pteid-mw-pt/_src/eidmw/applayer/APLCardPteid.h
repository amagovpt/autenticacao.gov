...
public:
	...
	EIDMW_APL_API APL_EidFile_PersoData *
	getFilePersoData();						   /**< Return a pointer to the file PersoData (NOT EXPORTED) */
...
private:
	...
	friend APL_CCXML_Doc &APL_EIDCard::getXmlCCDoc(
		APL_XmlUserRequestedInfo &userRequestedInfo); /**< This method must access protected constructor */
};
...
public:
	...
	getPersonalNotes(bool forceMap = false); /**< Return field AddressVersion from the Address file */
