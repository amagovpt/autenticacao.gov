...
public:
	...
	EIDMW_APL_API PhotoPteid(CByteArray &photo, CByteArray &cbeff, CByteArray &facialrechdr, CByteArray &facialinfo,
							 CByteArray &imageinfo);
	EIDMW_APL_API PhotoPteid(const CByteArray &photo);
