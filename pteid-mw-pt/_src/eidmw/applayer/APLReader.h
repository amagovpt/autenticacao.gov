...
/******************************************************************************/ /**
																				  * Singleton class that represent the
																				  *application layer -Singleton object
																				  *is create at the first instance call
																				  *		-Encapsulate a CCardLayer object
																				  *for access to CardLayer
																				  *********************************************************************************/
class CAppLayer {
public:
	/**
...
/******************************************************************************/ /**
																				  ...
																				  *
																				  * To get APL_ReaderContext object, we
																				  *have to ask it from CAppLayer
																				  *********************************************************************************/
class APL_ReaderContext {
public:
	/**
