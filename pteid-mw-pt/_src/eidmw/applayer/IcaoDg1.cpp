...
IcaoDg1::IcaoDg1(const CByteArray &byteArray)
{
  ...
  if (isPassport) {
    ...
    m_optionalDataSecondLine = byteArray.GetBytes(offsetCounter, MRZ_TD3_OPTIONAL_DATA_SIZE)
				   .hexToString();
...
std::string IcaoDg1::documentCode() const
{
  return m_documentCode;
}

std::string IcaoDg1::issuingOrg() const
{
  return m_issuingOrg;
}

std::string IcaoDg1::serialNumber() const
{
  return m_serialNumber;
}

int IcaoDg1::serialNumberCheckDigit() const
{
  return m_serialNumberCheckDigit;
}

std::string IcaoDg1::optionalData() const
{
  return m_optionalData;
}

std::string IcaoDg1::birthDay() const
{
  return m_birthDay;
}

int IcaoDg1::birthDayCheckDigit() const
{
  return m_birthDayCheckDigit;
}

char IcaoDg1::sex() const
{
  return m_sex;
}

std::string IcaoDg1::expireDay() const
{
  return m_expireDay;
}

int IcaoDg1::expireDayCheckDigit() const
{
  return m_expireDayCheckDigit;
}

std::string IcaoDg1::nationality() const
{
  return m_nationality;
}

std::string IcaoDg1::optionalDataSecondLine() const
{
  return m_optionalDataSecondLine;
}

int IcaoDg1::optionalDataSecondLineCheckDigit() const
{
  return m_optionalDataSecondLineCheckDigit;
}

int IcaoDg1::compositeCheckDigit() const
{
  return m_compositeCheckDigit;
}

std::string IcaoDg1::primaryIdentifier() const
{
  return m_primaryIdentifier;
}

std::string IcaoDg1::secondaryIdentifier() const
{
  return m_secondaryIdentifier;
}
} // namespace eIDMW
