...
unsigned long APL_Pin::getPinRef() { return m_pinP15.ulPinRef; }

unsigned long APL_Pin::getType() { return m_pinP15.ulPinType; }

unsigned long APL_Pin::getId() { return m_pinP15.ulID; }
...
bool APL_Pin::isVerified() { return m_card->isPinVerified(m_pinP15); }

unsigned long APL_Pin::getFlags() { return m_pinP15.ulPinFlags; }

const char *APL_Pin::getLabel() { return m_pinP15.csLabel.c_str(); }
