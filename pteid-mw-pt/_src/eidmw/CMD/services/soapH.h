...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_wsa__FaultSubcodeValues(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_wsa__RelationshipTypeValues(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:MultipleSignRequest", p->soap_type() == SOAP_TYPE_ns3__MultipleSignRequest ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:MultipleSignRequest", p->soap_type() == SOAP_TYPE_ns3__MultipleSignRequest ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns3__MultipleSignRequest(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:HashStructure", p->soap_type() == SOAP_TYPE_ns3__HashStructure ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:HashStructure", p->soap_type() == SOAP_TYPE_ns3__HashStructure ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns3__HashStructure(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:ArrayOfHashStructure", p->soap_type() == SOAP_TYPE_ns3__ArrayOfHashStructure ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:ArrayOfHashStructure", p->soap_type() == SOAP_TYPE_ns3__ArrayOfHashStructure ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns3__ArrayOfHashStructure(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
	...
	ns3__SignStatus *Status)
{
	...
	if (_p)
	{	_p->soap_default(soap);
		_p->ns3__SignResponse::ArrayOfHashStructure = ArrayOfHashStructure;
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:SignResponse", p->soap_type() == SOAP_TYPE_ns3__SignResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:SignResponse", p->soap_type() == SOAP_TYPE_ns3__SignResponse ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns3__SignResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:SignStatus", p->soap_type() == SOAP_TYPE_ns3__SignStatus ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:SignStatus", p->soap_type() == SOAP_TYPE_ns3__SignStatus ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns3__SignStatus(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:SignRequest", p->soap_type() == SOAP_TYPE_ns3__SignRequest ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns3:SignRequest", p->soap_type() == SOAP_TYPE_ns3__SignRequest ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns3__SignRequest(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelMultipleSignResponse", p->soap_type() == SOAP_TYPE__ns2__CCMovelMultipleSignResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelMultipleSignResponse", p->soap_type() == SOAP_TYPE__ns2__CCMovelMultipleSignResponse ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__CCMovelMultipleSignResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelMultipleSign", p->soap_type() == SOAP_TYPE__ns2__CCMovelMultipleSign ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelMultipleSign", p->soap_type() == SOAP_TYPE__ns2__CCMovelMultipleSign ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__CCMovelMultipleSign(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:ValidateOtpResponse", p->soap_type() == SOAP_TYPE__ns2__ValidateOtpResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:ValidateOtpResponse", p->soap_type() == SOAP_TYPE__ns2__ValidateOtpResponse ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__ValidateOtpResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:ValidateOtp", p->soap_type() == SOAP_TYPE__ns2__ValidateOtp ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:ValidateOtp", p->soap_type() == SOAP_TYPE__ns2__ValidateOtp ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__ValidateOtp(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:GetCertificateResponse", p->soap_type() == SOAP_TYPE__ns2__GetCertificateResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:GetCertificateResponse", p->soap_type() == SOAP_TYPE__ns2__GetCertificateResponse ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__GetCertificateResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:GetCertificate", p->soap_type() == SOAP_TYPE__ns2__GetCertificate ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:GetCertificate", p->soap_type() == SOAP_TYPE__ns2__GetCertificate ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__GetCertificate(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelSignResponse", p->soap_type() == SOAP_TYPE__ns2__CCMovelSignResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelSignResponse", p->soap_type() == SOAP_TYPE__ns2__CCMovelSignResponse ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__CCMovelSignResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelSign", p->soap_type() == SOAP_TYPE__ns2__CCMovelSign ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns2:CCMovelSign", p->soap_type() == SOAP_TYPE__ns2__CCMovelSign ? "" : NULL) || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__ns2__CCMovelSign(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
#ifndef SOAP_TYPE___tempuri__CCMovelMultipleSign_DEFINED
#define SOAP_TYPE___tempuri__CCMovelMultipleSign_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___tempuri__CCMovelMultipleSign(struct soap*, struct __tempuri__CCMovelMultipleSign *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___tempuri__CCMovelMultipleSign(struct soap*, const struct __tempuri__CCMovelMultipleSign *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___tempuri__CCMovelMultipleSign(struct soap*, const char*, int, const struct __tempuri__CCMovelMultipleSign *, const char*);
SOAP_FMAC3 struct __tempuri__CCMovelMultipleSign * SOAP_FMAC4 soap_in___tempuri__CCMovelMultipleSign(struct soap*, const char*, struct __tempuri__CCMovelMultipleSign *, const char*);
SOAP_FMAC1 struct __tempuri__CCMovelMultipleSign * SOAP_FMAC2 soap_instantiate___tempuri__CCMovelMultipleSign(struct soap*, int, const char*, const char*, size_t*);

inline struct __tempuri__CCMovelMultipleSign * soap_new___tempuri__CCMovelMultipleSign(struct soap *soap, int n = -1)
{
	return soap_instantiate___tempuri__CCMovelMultipleSign(soap, n, NULL, NULL, NULL);
}

inline struct __tempuri__CCMovelMultipleSign * soap_new_req___tempuri__CCMovelMultipleSign(
	struct soap *soap)
{
	struct __tempuri__CCMovelMultipleSign *_p = ::soap_new___tempuri__CCMovelMultipleSign(soap);
	if (_p)
	{	::soap_default___tempuri__CCMovelMultipleSign(soap, _p);
	}
	return _p;
}

inline struct __tempuri__CCMovelMultipleSign * soap_new_set___tempuri__CCMovelMultipleSign(
	struct soap *soap,
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___tempuri__CCMovelMultipleSign(struct soap*, const struct __tempuri__CCMovelMultipleSign *, const char*, const char*);

inline int soap_write___tempuri__CCMovelMultipleSign(struct soap *soap, struct __tempuri__CCMovelMultipleSign const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize___tempuri__CCMovelMultipleSign(soap, p), 0) || ::soap_put___tempuri__CCMovelMultipleSign(soap, p, "-tempuri:CCMovelMultipleSign", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT___tempuri__CCMovelMultipleSign(struct soap *soap, const char *URL, struct __tempuri__CCMovelMultipleSign const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__CCMovelMultipleSign(soap, p), 0) || ::soap_put___tempuri__CCMovelMultipleSign(soap, p, "-tempuri:CCMovelMultipleSign", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send___tempuri__CCMovelMultipleSign(struct soap *soap, const char *URL, struct __tempuri__CCMovelMultipleSign const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__CCMovelMultipleSign(soap, p), 0) || ::soap_put___tempuri__CCMovelMultipleSign(soap, p, "-tempuri:CCMovelMultipleSign", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
SOAP_FMAC3 struct __tempuri__CCMovelMultipleSign * SOAP_FMAC4 soap_get___tempuri__CCMovelMultipleSign(struct soap*, struct __tempuri__CCMovelMultipleSign *, const char*, const char*);

inline int soap_read___tempuri__CCMovelMultipleSign(struct soap *soap, struct __tempuri__CCMovelMultipleSign *p)
{
	if (p)
	{	::soap_default___tempuri__CCMovelMultipleSign(soap, p);
		if (soap_begin_recv(soap) || ::soap_get___tempuri__CCMovelMultipleSign(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET___tempuri__CCMovelMultipleSign(struct soap *soap, const char *URL, struct __tempuri__CCMovelMultipleSign *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__CCMovelMultipleSign(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv___tempuri__CCMovelMultipleSign(struct soap *soap, struct __tempuri__CCMovelMultipleSign *p)
{
	if (::soap_read___tempuri__CCMovelMultipleSign(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize___tempuri__ValidateOtp(soap, p), 0) || ::soap_put___tempuri__ValidateOtp(soap, p, "-tempuri:ValidateOtp", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT___tempuri__ValidateOtp(struct soap *soap, const char *URL, struct __tempuri__ValidateOtp const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__ValidateOtp(soap, p), 0) || ::soap_put___tempuri__ValidateOtp(soap, p, "-tempuri:ValidateOtp", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send___tempuri__ValidateOtp(struct soap *soap, const char *URL, struct __tempuri__ValidateOtp const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__ValidateOtp(soap, p), 0) || ::soap_put___tempuri__ValidateOtp(soap, p, "-tempuri:ValidateOtp", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET___tempuri__ValidateOtp(struct soap *soap, const char *URL, struct __tempuri__ValidateOtp *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__ValidateOtp(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv___tempuri__ValidateOtp(struct soap *soap, struct __tempuri__ValidateOtp *p)
{
	if (::soap_read___tempuri__ValidateOtp(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize___tempuri__GetCertificate(soap, p), 0) || ::soap_put___tempuri__GetCertificate(soap, p, "-tempuri:GetCertificate", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT___tempuri__GetCertificate(struct soap *soap, const char *URL, struct __tempuri__GetCertificate const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__GetCertificate(soap, p), 0) || ::soap_put___tempuri__GetCertificate(soap, p, "-tempuri:GetCertificate", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send___tempuri__GetCertificate(struct soap *soap, const char *URL, struct __tempuri__GetCertificate const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__GetCertificate(soap, p), 0) || ::soap_put___tempuri__GetCertificate(soap, p, "-tempuri:GetCertificate", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET___tempuri__GetCertificate(struct soap *soap, const char *URL, struct __tempuri__GetCertificate *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__GetCertificate(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv___tempuri__GetCertificate(struct soap *soap, struct __tempuri__GetCertificate *p)
{
	if (::soap_read___tempuri__GetCertificate(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize___tempuri__CCMovelSign(soap, p), 0) || ::soap_put___tempuri__CCMovelSign(soap, p, "-tempuri:CCMovelSign", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT___tempuri__CCMovelSign(struct soap *soap, const char *URL, struct __tempuri__CCMovelSign const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__CCMovelSign(soap, p), 0) || ::soap_put___tempuri__CCMovelSign(soap, p, "-tempuri:CCMovelSign", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send___tempuri__CCMovelSign(struct soap *soap, const char *URL, struct __tempuri__CCMovelSign const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize___tempuri__CCMovelSign(soap, p), 0) || ::soap_put___tempuri__CCMovelSign(soap, p, "-tempuri:CCMovelSign", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET___tempuri__CCMovelSign(struct soap *soap, const char *URL, struct __tempuri__CCMovelSign *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__CCMovelSign(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv___tempuri__CCMovelSign(struct soap *soap, struct __tempuri__CCMovelSign *p)
{
	if (::soap_read___tempuri__CCMovelSign(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_wsa__Relationship(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_wsa__ServiceNameType(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_wsa__ReferenceParametersType(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_wsa__ReferencePropertiesType(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
