...
#define ERR_INVALID_CERTIFICATE (ERR_ADDR_USER_BASE + 0x18)
...
#define SOAP_ERR_CERTIFICATE_PROCESSING 900		   // CERTIFICATE_PROCESSING_ERROR
#define SOAP_ERR_INVALID_CERTIFICATE_SERIAL_NUMBER 901 // INVALID_CERTIFICATE_SERIAL_NUMBER
