...
int BasicHttpBinding_USCORECCMovelSignatureProxy::send_SignDocumentPooling(const char *soap_endpoint_url, const char *soap_action, _ns2__SignDocumentPooling *ns2__SignDocumentPooling)
{
	...
	soap_tmp___ns2__SignDocumentPooling.ns2__SignDocumentPooling = ns2__SignDocumentPooling;
	soap_begin(soap);
	soap_set_version(soap, 1); /* use SOAP1.1 */
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__SignDocumentPooling(soap, &soap_tmp___ns2__SignDocumentPooling, "-ns2:SignDocumentPooling", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int BasicHttpBinding_USCORECCMovelSignatureProxy::recv_SignDocumentPooling(_ns2__SignDocumentPoolingResponse &ns2__SignDocumentPoolingResponse)
{
	ns2__SignDocumentPoolingResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns2__SignDocumentPoolingResponse.soap_get(soap, "ns2:SignDocumentPoolingResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
