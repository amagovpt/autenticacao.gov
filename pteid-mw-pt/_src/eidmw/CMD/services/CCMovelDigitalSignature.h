...
/* CCMovelDigitalSignature.h
   Generated by wsdl2h 2.8.131 from CCMovelDigitalSignature.wsdl and typemap.dat
   2023-11-08 11:29:37 GMT
...
class _ns2__SignDocumentPooling;

class _ns2__SignDocumentPoolingResponse;
...
///
/// @note class _ns2__SignDocumentPooling operations:
/// - _ns2__SignDocumentPooling* soap_new__ns2__SignDocumentPooling(soap*) allocate and default initialize
/// - _ns2__SignDocumentPooling* soap_new__ns2__SignDocumentPooling(soap*, int num) allocate and default initialize an
/// array
/// - _ns2__SignDocumentPooling* soap_new_req__ns2__SignDocumentPooling(soap*, ...) allocate, set required members
/// - _ns2__SignDocumentPooling* soap_new_set__ns2__SignDocumentPooling(soap*, ...) allocate, set all public members
/// - _ns2__SignDocumentPooling::soap_default(soap*) default initialize members
/// - int soap_read__ns2__SignDocumentPooling(soap*, _ns2__SignDocumentPooling*) deserialize from a stream
/// - int soap_write__ns2__SignDocumentPooling(soap*, _ns2__SignDocumentPooling*) serialize to a stream
/// - _ns2__SignDocumentPooling* _ns2__SignDocumentPooling::soap_dup(soap*) returns deep copy of
/// _ns2__SignDocumentPooling, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree
/// structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns2__SignDocumentPooling::soap_del() deep deletes _ns2__SignDocumentPooling data members, use only after
/// _ns2__SignDocumentPooling::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns2__SignDocumentPooling::soap_type() returns SOAP_TYPE__ns2__SignDocumentPooling or derived type identifier
class _ns2__SignDocumentPooling {
public:
	/// Element "applicationId" of type xs:base64Binary.
	xsd__base64Binary *applicationId 0; ///< Optional element.
...
///
/// @note class _ns2__SignDocumentPoolingResponse operations:
/// - _ns2__SignDocumentPoolingResponse* soap_new__ns2__SignDocumentPoolingResponse(soap*) allocate and default
/// initialize
/// - _ns2__SignDocumentPoolingResponse* soap_new__ns2__SignDocumentPoolingResponse(soap*, int num) allocate and default
/// initialize an array
/// - _ns2__SignDocumentPoolingResponse* soap_new_req__ns2__SignDocumentPoolingResponse(soap*, ...) allocate, set
/// required members
/// - _ns2__SignDocumentPoolingResponse* soap_new_set__ns2__SignDocumentPoolingResponse(soap*, ...) allocate, set all
/// public members
/// - _ns2__SignDocumentPoolingResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns2__SignDocumentPoolingResponse(soap*, _ns2__SignDocumentPoolingResponse*) deserialize from a
/// stream
/// - int soap_write__ns2__SignDocumentPoolingResponse(soap*, _ns2__SignDocumentPoolingResponse*) serialize to a stream
/// - _ns2__SignDocumentPoolingResponse* _ns2__SignDocumentPoolingResponse::soap_dup(soap*) returns deep copy of
/// _ns2__SignDocumentPoolingResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned)
/// tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns2__SignDocumentPoolingResponse::soap_del() deep deletes _ns2__SignDocumentPoolingResponse data members, use
/// only after _ns2__SignDocumentPoolingResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns2__SignDocumentPoolingResponse::soap_type() returns SOAP_TYPE__ns2__SignDocumentPoolingResponse or derived
/// type identifier
class _ns2__SignDocumentPoolingResponse {
public:
	/// Element "SignDocumentPoolingResult" of type
	/// "http://schemas.datacontract.org/2004/07/Ama.Structures.CCMovelSignature":SignResponse.
	ns3__SignResponse *SignDocumentPoolingResult 0; ///< Optional element.
													/// Pointer to soap context that manages this instance.
	struct soap *soap;
};
...
// https://preprod.cmd.autenticacao.gov.pt/AMA.Authentication.Frontend/CCMovelDigitalSignature.svc gsoap ns2  service
// namespace:	http://Ama.Authentication.Service/ gsoap ns2  service transport:	http://schemas.xmlsoap.org/soap/http
...
@code
  int soap_call___ns2__SignDocumentPooling(
	...
	// output parameters:
	_ns2__SignDocumentPoolingResponse  &ns2__SignDocumentPoolingResponse
  );
@endcode
...
// gsoap ns2  service method-protocol:	SignDocumentPooling SOAP
// gsoap ns2  service method-style:	SignDocumentPooling document
// gsoap ns2  service method-encoding:	SignDocumentPooling literal
// gsoap ns2  service method-input-action:	SignDocumentPooling
// http://Ama.Authentication.Service/CCMovelSignature/SignDocumentPooling gsoap ns2  service method-output-action:
// SignDocumentPooling http://Ama.Authentication.Service/CCMovelSignature/SignDocumentPoolingResponse
int __ns2__SignDocumentPooling(_ns2__SignDocumentPooling *ns2__SignDocumentPooling,				   ///< Input parameter
							   _ns2__SignDocumentPoolingResponse &ns2__SignDocumentPoolingResponse ///< Output parameter
);
...
_ns2__GetCertificateWithPinResponse*);
  ...
  - <ns2:SignDocumentPooling> @ref _ns2__SignDocumentPooling
	@code
	// Reader (returns SOAP_OK on success):
	soap_read__ns2__SignDocumentPooling(struct soap*, _ns2__SignDocumentPooling*);
	// Writer (returns SOAP_OK on success):
	soap_write__ns2__SignDocumentPooling(struct soap*, _ns2__SignDocumentPooling*);
	// REST GET (returns SOAP_OK on success):
	soap_GET__ns2__SignDocumentPooling(struct soap*, const char *URL, _ns2__SignDocumentPooling*);
	// REST PUT (returns SOAP_OK on success):
	soap_PUT__ns2__SignDocumentPooling(struct soap*, const char *URL, _ns2__SignDocumentPooling*);
	// REST POST (returns SOAP_OK on success):
	soap_POST_send__ns2__SignDocumentPooling(struct soap*, const char *URL, _ns2__SignDocumentPooling*);
	soap_POST_recv__ns2__SignDocumentPooling(struct soap*, _ns2__SignDocumentPooling*);
	@endcode

  - <ns2:SignDocumentPoolingResponse> @ref _ns2__SignDocumentPoolingResponse
	@code
	// Reader (returns SOAP_OK on success):
	soap_read__ns2__SignDocumentPoolingResponse(struct soap*, _ns2__SignDocumentPoolingResponse*);
	// Writer (returns SOAP_OK on success):
	soap_write__ns2__SignDocumentPoolingResponse(struct soap*, _ns2__SignDocumentPoolingResponse*);
	// REST GET (returns SOAP_OK on success):
	soap_GET__ns2__SignDocumentPoolingResponse(struct soap*, const char *URL, _ns2__SignDocumentPoolingResponse*);
	// REST PUT (returns SOAP_OK on success):
	soap_PUT__ns2__SignDocumentPoolingResponse(struct soap*, const char *URL, _ns2__SignDocumentPoolingResponse*);
	// REST POST (returns SOAP_OK on success):
	soap_POST_send__ns2__SignDocumentPoolingResponse(struct soap*, const char *URL, _ns2__SignDocumentPoolingResponse*);
	soap_POST_recv__ns2__SignDocumentPoolingResponse(struct soap*, _ns2__SignDocumentPoolingResponse*);
	@endcode
