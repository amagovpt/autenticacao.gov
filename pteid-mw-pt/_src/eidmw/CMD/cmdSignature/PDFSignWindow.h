...
class DraggableRectangle : public QGraphicsItem{
	public:
        DraggableRectangle( MyGraphicsScene *parent
                            , double max_y, double max_x
                            , double rect_h, double rect_w )
            : my_scene(parent), m_max_x(max_x), m_max_y(max_y), m_rect_w(rect_w), m_rect_h(rect_h){
            ...
            logo_pixmap_small = logo_pixmap.scaledToHeight( logo_pixmap.height() / 2
