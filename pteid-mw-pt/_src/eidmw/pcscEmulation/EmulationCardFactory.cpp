...
/////////////////////////////////////////////////////////////////////////////////
// This is a test card containing data provided by Pteid CARDS.
// It contains valid keys and valid/signature ID/address/photo values.

static CEmulationPteidCard *m_PteidV1Test1 = NULL;
static bool m_bPteidV1Test1Initialized = false;

CEmulationCard * CEmulationCardFactory::MakePteidV1Test1()
{
	if(!m_bCardInitialized)
		Init();

	CEmulationPteidCard *poEmulationCard = m_PteidV1Test1;

	if (m_bPteidV1Test1Initialized)
	...
	m_bPteidV1Test1Initialized = true;
...
static CEmulationPteidCard *m_PteidV1Test2 = NULL;
static bool m_bPteidV1Test2Initialized = false;

CEmulationCard * CEmulationCardFactory::MakePteidV1Test2()
{
	if(!m_bCardInitialized)
		Init();

	CEmulationPteidCard *poEmulationCard = m_PteidV1Test2;

	if (m_bPteidV1Test2Initialized)
		return poEmulationCard; // already intialized
	...
	m_bPteidV1Test2Initialized = true;
...
static CEmulationPteidCard *m_PteidV2Test1 = NULL;
static bool m_bPteidV2Test1Initialized = false;

CEmulationCard * CEmulationCardFactory::MakePteidV2Test1()
{
	if(!m_bCardInitialized)
		Init();

	CEmulationPteidCard *poEmulationCard = m_PteidV2Test1;

	if (m_bPteidV2Test1Initialized)
		return poEmulationCard; // already intialized
	...
	m_bPteidV2Test1Initialized = true;
...
static CEmulationPteidCard *m_PteidV1Test3 = NULL;
static bool m_bPteidV1Test3Initialized = false;

CEmulationCard * CEmulationCardFactory::MakePteidV1Test3()
{
	if(!m_bCardInitialized)
		Init();

	CEmulationPteidCard *poEmulationCard = m_PteidV1Test3;

	if (m_bPteidV1Test3Initialized)
		return poEmulationCard; // already intialized
	...
	m_bPteidV1Test3Initialized = true;
...
void CEmulationCardFactory::Init(){
  ...
  m_PteidV1Test1 = new CEmulationPteidCard(0x11);
  m_PteidV1Test2 = new CEmulationPteidCard(0x11);
  m_PteidV2Test1 = new CEmulationPteidCard(0x20);
  m_PteidV1Test3 = new CEmulationPteidCard(0x11);
...
{
  if( m_PteidV1Test1 != NULL) {
    delete m_PteidV1Test1;
    m_PteidV1Test1 = NULL;
  }
  if( m_PteidV1Test2 != NULL) {
    delete m_PteidV1Test2;
    m_PteidV1Test2 = NULL;
  }
  if( m_PteidV2Test1 != NULL) {
    delete m_PteidV2Test1;
    m_PteidV2Test1 = NULL;
  }
  if( m_SISTest1 != NULL) {
    delete m_SISTest1;
...
CEmulationCard *CEmulationCardFactory::getInstance(EmulationCard type)
{
	...
	switch(type)
	{
	case PTEID_V1_TEST1: return MakePteidV1Test1();
	case PTEID_V1_TEST2: return MakePteidV1Test2();
	case PTEID_V2_TEST1: return MakePteidV2Test1();
	case PTEID_V1_TEST3: return MakePteidV1Test3();
