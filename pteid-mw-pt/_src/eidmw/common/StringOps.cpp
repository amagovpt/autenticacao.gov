...
std::vector<std::string> wrapString(const std::string &content, double available_space, double font_size,
									MyriadFontType font, int available_lines, double first_line_offset) {
 ...
 */
WrapParams calculateWrapParams(const std::string &text, const std::string &label, int rect_height, double rect_width) {
...
FontParams calculateFontParams(bool small_signature_format, const std::string &reason, const std::string &name,
							   ...
							   const std::string &attributes, int rect_width, int rect_height) {
	unsigned int max_font_size = 8;
