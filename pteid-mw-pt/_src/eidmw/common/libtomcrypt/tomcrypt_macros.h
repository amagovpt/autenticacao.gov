...
#define LOAD64L(x, y)                                                                                                  \
	{                                                                                                                  \
		x = (((ulong64)((y)[7] & 255)) << 56) | (((ulong64)((y)[6] & 255)) << 48) |                                    \
			...
			(((ulong64)((y)[3] & 255)) << 24) | (((ulong64)((y)[2] & 255)) << 16) | (((ulong64)((y)[1] & 255)) << 8) | \
			(((ulong64)((y)[0] & 255)));                                                                               \
	}
...
#define LOAD64H(x, y)                                                                                                  \
	{                                                                                                                  \
		x = (((ulong64)((y)[0] & 255)) << 56) | (((ulong64)((y)[1] & 255)) << 48) |                                    \
			...
			(((ulong64)((y)[4] & 255)) << 24) | (((ulong64)((y)[5] & 255)) << 16) | (((ulong64)((y)[6] & 255)) << 8) | \
			(((ulong64)((y)[7] & 255)));                                                                               \
	}
...
#define ROLc(word, i)                                                                                                  \
	({                                                                                                                 \
		...
		__asm__("roll %2, %0" : "=r"(__ROLc_tmp) : "0"(__ROLc_tmp), "I"(i));                                           \
		__ROLc_tmp;                                                                                                    \
	})
...
#define RORc(word, i)                                                                                                  \
	({                                                                                                                 \
		...
		__asm__("rorl %2, %0" : "=r"(__RORc_tmp) : "0"(__RORc_tmp), "I"(i));                                           \
		__RORc_tmp;                                                                                                    \
	})
...
#define ROL64c(word, i)                                                                                                \
	({                                                                                                                 \
		...
		__asm__("rolq %2, %0" : "=r"(__ROL64c_tmp) : "0"(__ROL64c_tmp), "J"(i));                                       \
		__ROL64c_tmp;                                                                                                  \
	})
#define ROR64c(word, i)                                                                                                \
	({                                                                                                                 \
		ulong64 __ROR64c_tmp = word;                                                                                   \
		__asm__("rorq %2, %0" : "=r"(__ROR64c_tmp) : "0"(__ROR64c_tmp), "J"(i));                                       \
		__ROR64c_tmp;                                                                                                  \
	})
