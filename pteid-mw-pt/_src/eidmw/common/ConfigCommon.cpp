...
//GENERAL
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_TELEMETRY_ID 	=	{EIDMW_CNF_SECTION_GENERAL,	EIDMW_CNF_GENERAL_TELEMETRY_ID,   L"0"};
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_TELEMETRY_HOST = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_TELEMETRY_HOST, L"0"};
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GENERAL_TELEMETRY_STATUS = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_TELEMETRY_STATUS, 8};
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GENERAL_PTEID_CAN_CACHE_ENABLED = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_CAN_CACHE_ENABLED, 1};
#ifdef WIN32
...
//GUI
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_ASKSETTELEMETRY =	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_ASKSETTELEMETRY,	1};
...
//AutoUpdates
  ...
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_SCAP_USERID = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_SCAP_USERID, L"" };
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_SCAP_PASSWORD = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_SCAP_PASSWORD, L"" };
  ...
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_REMOTEADDR_CC2_BASEURL = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_REMOTEADDR_BASEURL_CC2, L"https://morada2.cartaodecidadao.pt" };
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_REMOTEADDR_BASEURL_TEST = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_REMOTEADDR_BASEURL_TST, L"https://morada2.teste.cartaodecidadao.pt" };

  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_ADMIN_CONFIGURATION = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_ADMIN_CONFIGURATION,	0 };
