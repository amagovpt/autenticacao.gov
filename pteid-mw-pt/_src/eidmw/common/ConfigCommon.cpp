...
//GENERAL
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GENERAL_PTEID_TELEMETRY_ENABLED = {EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_TELEMETRY_ENABLED, 1};
#ifdef WIN32
