...
//GUI
  ...
  const struct CConfig::Param_Num CConfig::EIDMW_CONFIG_PARAM_GUITOOL_ADMIN_CONFIGURATION =	{EIDMW_CNF_SECTION_GUITOOL, EIDMW_CNF_GUITOOL_ADMIN_CONFIGURATION,	0};
