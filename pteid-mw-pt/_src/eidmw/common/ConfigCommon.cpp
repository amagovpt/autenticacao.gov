...
//AutoUpdates
  ...
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_GENERAL_OAUTH_CLIENTID = { EIDMW_CNF_SECTION_GENERAL, EIDMW_CNF_GENERAL_OAUTH_CLIENTID, L"12345678910" };
