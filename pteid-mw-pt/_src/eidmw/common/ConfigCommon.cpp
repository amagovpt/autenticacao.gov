...
//AutoUpdates
  ...
  const struct CConfig::Param_Str CConfig::EIDMW_CONFIG_PARAM_AUTOUPDATES_NEWS_URL = { EIDMW_CNF_SECTION_AUTOUPDATES, EIDMW_CNF_AUTOUPDATES_NEWS_URL, L"http://localhost:8080/" };
