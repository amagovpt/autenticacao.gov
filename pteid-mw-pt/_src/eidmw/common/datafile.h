...
typedef struct st_key {
	...
	st_key(const t_Str &key, const t_Str &value, const t_Str &comment)
		: szKey(key), szValue(value), szComment(comment) {}
...
public:
	...
	bool SetValue(t_Str szKey, t_Str szValue, t_Str szComment = t_Str(L""), t_Str szSection = t_Str(L""));

	// SetLong: Sets the value of a given key. Will create the
	// key if it is not found and AUTOCREATE_KEYS is active.
	bool SetLong(t_Str szKey, long nValue, t_Str szComment = t_Str(L""), t_Str szSection = t_Str(L""));
	...
	bool CreateKey(t_Str szKey, t_Str szValue, t_Str szComment = t_Str(L""), t_Str szSection = t_Str(L""));
...
protected:
	...
	bool SetValueInt(t_Str szKey, t_Str szValue, t_Str szComment = t_Str(L""), t_Str szSection = t_Str(L""));
