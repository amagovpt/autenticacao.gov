...
CSLIB=pteidlibCS_Wrapper
CSLIB_MAJ=2
CSLIB_MIN=0
CSLIB_REV=0
CSLIB_COMPAT_VERSION=1.0
...
CSLIB_NAME=lib$(CSLIB)
CSLIB_NAME_x_y_z_dylib= $(CSLIB_NAME).$(CSLIB_MAJ).$(CSLIB_MIN).$(CSLIB_REV).dylib
CSLIB_NAME_x_y_dylib=   $(CSLIB_NAME).$(CSLIB_MAJ).$(CSLIB_MIN).dylib
CSLIB_NAME_x_dylib=     $(CSLIB_NAME).$(CSLIB_MAJ).dylib
CSLIB_NAME_dylib=       $(CSLIB_NAME).dylib
CSLIB_MAJR_VERSION=     $(CSLIB_MAJ).$(CSLIB_MIN).$(CSLIB_REV)