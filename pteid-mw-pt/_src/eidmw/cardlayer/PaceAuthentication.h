...
public:
	PaceAuthentication(PTEID_CardHandle hCard, CContext *poContext, PTEID_CardProtocol protocol);
	~PaceAuthentication();

	void initPaceAuthentication(PTEID_CardHandle &hCard, PTEID_CardProtocol protocol);
