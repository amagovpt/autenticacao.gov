...
static const unsigned char GEMSAFE_PTEID_APPLET_NATIONAL_DATA[] = {0x60, 0x46, 0x32, 0xFF, 0x00, 0x00, 0x04}; //60 46 32 FF 00 00 04
static const unsigned char GEMSAFE_PTEID_APPLET_EID[] = {0x60, 0x46, 0x32, 0xFF, 0x00, 0x00, 0x03}; //60 46 32 FF 00 00 03
