...
struct PTEID_CardInterfaceCallbacks {
	...
	int (*connect)(const char *csReader, PTEID_CardHandle *outHandle, unsigned long *outProtocol, unsigned long ulShareMode,
	...
	void (*control)(PTEID_CardHandle handle, unsigned long ulControl, const unsigned char *cmdData, unsigned long cmdLength,
