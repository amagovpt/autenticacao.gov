...
PTEID_CertifStatus PTEID_Certificate::getStatus() { return getStatus(true, true); }
...
PTEID_Certificate &PTEID_Certificates::getRoot() { return getCert(PTEID_CERTIF_TYPE_ROOT); }

PTEID_Certificate &PTEID_Certificates::getCA() { return getCert(PTEID_CERTIF_TYPE_ROOT_AUTH); }

PTEID_Certificate &PTEID_Certificates::getAuthentication() { return getCert(PTEID_CERTIF_TYPE_AUTHENTICATION); }

PTEID_Certificate &PTEID_Certificates::getSignature() { return getCert(PTEID_CERTIF_TYPE_SIGNATURE); }
