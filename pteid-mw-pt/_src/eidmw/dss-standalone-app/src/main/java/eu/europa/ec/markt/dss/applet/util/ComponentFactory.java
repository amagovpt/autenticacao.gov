...
public final class ComponentFactory extends BasicComponentFactory {
    ...
    private static final Icon ICON_WINDOW;
    ...
    static {
        ...
        ICON_WAIT = new ImageIcon(ResourceUtils.class.getResource("/eu/europa/ec/markt/dss/applet/wizard/loading.gif"));
        ...
        ICON_WINDOW = new ImageIcon(ResourceUtils.class.getResource("/eu/europa/ec/markt/dss/applet/images/icon.png"));
    }
    ...
    {
    	return ((ImageIcon)ICON_WINDOW).getImage();
    }
...
//    }
    ...
    static class MyCheckbox extends JCheckBox
    {
    	String my_text;
    	public MyCheckbox(String tooltip_text)
    	{
    		my_text = tooltip_text;
    	}
    	...
    	public JToolTip createToolTip()
    	{
    		...
    		tooltip.setTipText(my_text);
    		tooltip.setFixedWidth(30);
    		
    		return tooltip;
    	}
    }
    
    public static JCheckBox createCheckBox(final boolean enabled, String label, String tooltip)
    {
    	final JCheckBox cb = new MyCheckbox(tooltip);
    	cb.setText(label);
     ...
     * @param container
     */
    public static void updateDisplay(final JFrame frame, final Container container) {
        if (container != null) {
