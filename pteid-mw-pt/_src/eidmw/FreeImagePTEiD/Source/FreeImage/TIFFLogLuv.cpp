...
void tiff_ConvertLineXYZToRGB(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, double stonits, int width_in_pixels) {
...
void tiff_ConvertLineRGBToXYZ(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels) {
