...
void DLL_CALLCONV
FreeImage_ConvertLine1To16_565(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels, RGBQUAD *palette) {
...
void DLL_CALLCONV
FreeImage_ConvertLine4To16_565(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels, RGBQUAD *palette) {
	WORD *new_bits = (WORD *)target;
...
void DLL_CALLCONV
FreeImage_ConvertLine8To16_565(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels, RGBQUAD *palette) {
	WORD *new_bits = (WORD *)target;
...
void DLL_CALLCONV
FreeImage_ConvertLine16_555_To16_565(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels) {
...
void DLL_CALLCONV
FreeImage_ConvertLine24To16_565(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels) {
	WORD *new_bits = (WORD *)target;
...
void DLL_CALLCONV
FreeImage_ConvertLine32To16_565(BYTE_FREEIMAGE *target, BYTE_FREEIMAGE *source, int width_in_pixels) {
	WORD *new_bits = (WORD *)target;
