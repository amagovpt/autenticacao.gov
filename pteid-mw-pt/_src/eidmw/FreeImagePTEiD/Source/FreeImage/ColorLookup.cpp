...
typedef struct tagNamedColor {
        ...
        BYTE_FREEIMAGE  r;        // red value
        BYTE_FREEIMAGE  g;        // green value
        BYTE_FREEIMAGE  b;        // blue value
} NamedColor;
...
FreeImage_LookupX11Color(const char *szColor, BYTE_FREEIMAGE *nRed, BYTE_FREEIMAGE *nGreen, BYTE_FREEIMAGE *nBlue) {
    int i;
    ...
    if ( (szColor[0] == 'g' || szColor[0] == 'G') &&
        ...
        *nRed   = (BYTE_FREEIMAGE)(255.0/100.0 * i);
        *nGreen = *nRed;
        *nBlue  = *nRed;
...
BOOL_FREEIMAGE DLL_CALLCONV
FreeImage_LookupSVGColor(const char *szColor, BYTE_FREEIMAGE *nRed, BYTE_FREEIMAGE *nGreen, BYTE_FREEIMAGE *nBlue) {
    int i;
