...
#define TAG_STRIP_BYTE_FREEIMAGE_COUNTS				0x0117
...
#define TAG_GPS_LONG_FREEIMAGEITUDE_REF			0x0003
#define TAG_GPS_LONG_FREEIMAGEITUDE				0x0004
...
#define TAG_GPS_DEST_LONG_FREEIMAGEITUDE_REF		0x0015
#define TAG_GPS_DEST_LONG_FREEIMAGEITUDE			0x0016
...
private:
	...
	*/
	BOOL_FREEIMAGE addMetadataModel(MDMODEL md_model, TagInfo *tag_table);
...
// JPEG Exif profile
BOOL_FREEIMAGE jpeg_read_exif_profile(FIBITMAP *dib, const BYTE_FREEIMAGE *dataptr, unsigned int datalen);

// JPEG / TIFF IPTC profile
BOOL_FREEIMAGE read_iptc_profile(FIBITMAP *dib, const BYTE_FREEIMAGE *dataptr, unsigned int datalen);
BOOL_FREEIMAGE write_iptc_profile(FIBITMAP *dib, BYTE_FREEIMAGE **profile, unsigned *profile_size);
