...
LosslessTransform(const FilenameIO *filenameIO, FREE_IMAGE_JPEG_OPERATION operation, const char *crop, BOOL_FREEIMAGE perfect) {
...
FreeImage_JPEGTransform(const char *src_file, const char *dst_file, FREE_IMAGE_JPEG_OPERATION operation, BOOL_FREEIMAGE perfect) {
	try {
...
BOOL_FREEIMAGE DLL_CALLCONV 
FreeImage_JPEGTransformU(const wchar_t *src_file, const wchar_t *dst_file, FREE_IMAGE_JPEG_OPERATION operation, BOOL_FREEIMAGE perfect) {
#ifdef _WIN32
	try {
		// check the src file format
