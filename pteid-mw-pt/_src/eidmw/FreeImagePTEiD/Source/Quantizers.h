...
protected:
    void Hist3D(LONG_FREEIMAGE *vwt, LONG_FREEIMAGE *vmr, LONG_FREEIMAGE *vmg, LONG_FREEIMAGE *vmb, float *m2, int ReserveSize, RGBQUAD *ReservePalette);
	void M3D(LONG_FREEIMAGE *vwt, LONG_FREEIMAGE *vmr, LONG_FREEIMAGE *vmg, LONG_FREEIMAGE *vmb, float *m2);
	LONG_FREEIMAGE Vol(Box *cube, LONG_FREEIMAGE *mmt);
	LONG_FREEIMAGE Bottom(Box *cube, BYTE_FREEIMAGE dir, LONG_FREEIMAGE *mmt);
	LONG_FREEIMAGE Top(Box *cube, BYTE_FREEIMAGE dir, int pos, LONG_FREEIMAGE *mmt);
	float Var(Box *cube);
	float Maximize(Box *cube, BYTE_FREEIMAGE dir, int first, int last , int *cut,
				   LONG_FREEIMAGE whole_r, LONG_FREEIMAGE whole_g, LONG_FREEIMAGE whole_b, LONG_FREEIMAGE whole_w);
	bool Cut(Box *set1, Box *set2);
	void Mark(Box *cube, int label, BYTE_FREEIMAGE *tag);
