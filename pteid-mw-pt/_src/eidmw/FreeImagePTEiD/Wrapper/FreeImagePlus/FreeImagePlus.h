...
public:
	...
	virtual BOOL_FREEIMAGE isValid() const = 0;
	//@}
};
...
protected:
	...
	mutable BOOL_FREEIMAGE _bHasChanged;
...
public:
	...
	*/
	...
	@see FreeImage_AllocateT
	*/
	BOOL_FREEIMAGE setSize(FREE_IMAGE_TYPE image_type, unsigned width, unsigned height, unsigned bpp, unsigned red_mask = 0, unsigned green_mask = 0, unsigned blue_mask = 0);
	/// Destroy image data
	virtual void clear();
	//@}
	...
	*/
	...
	@see FreeImage_Copy
	*/
	BOOL_FREEIMAGE copySubImage(fipImage& dst, int left, int top, int right, int bottom) const;
	...
	@see FreeImage_Paste
	*/
	BOOL_FREEIMAGE pasteSubImage(fipImage& src, int left, int top, int alpha = 256);
	...
	@return Returns TRUE if successful, FALSE otherwise.
	*/
	BOOL_FREEIMAGE crop(int left, int top, int right, int bottom);
	...
	*/
	BOOL_FREEIMAGE load(const char* lpszPathName, int flag = 0);

	/**
	UNICODE version of load (this function only works under WIN32 and does nothing on other OS)
	@see load
	*/
	BOOL_FREEIMAGE loadU(const wchar_t* lpszPathName, int flag = 0);
	...
	*/
	BOOL_FREEIMAGE loadFromHandle(FreeImageIO *io, fi_handle handle, int flag = 0);
	...
	*/
	BOOL_FREEIMAGE loadFromMemory(fipMemoryIO& memIO, int flag = 0);
	...
	*/
	BOOL_FREEIMAGE save(const char* lpszPathName, int flag = 0) const;

	/**
	UNICODE version of save (this function only works under WIN32 and does nothing on other OS)
	@see save
	*/
	BOOL_FREEIMAGE saveU(const wchar_t* lpszPathName, int flag = 0) const;
	...
	*/
	BOOL_FREEIMAGE saveToHandle(FREE_IMAGE_FORMAT fif, FreeImageIO *io, fi_handle handle, int flag = 0) const;
	...
	*/
	BOOL_FREEIMAGE saveToMemory(FREE_IMAGE_FORMAT fif, fipMemoryIO& memIO, int flag = 0) const;
	...
	*/
	...
	/**
	Returns the width of the bitmap in bytes rounded to the nearest DWORD_FREEIMAGE.
	...
	*/
	LONG_FREEIMAGE getImageSize() const;
	...
	*/
	BOOL_FREEIMAGE isGrayscale() const;
	//@}
	...
	*/
	BOOL_FREEIMAGE getThumbnail(fipImage& image) const;
	...
	*/
	BOOL_FREEIMAGE setThumbnail(const fipImage& image);
	...
	@see FreeImage_GetThumbnail
	*/
	BOOL_FREEIMAGE hasThumbnail() const;
	...
	*/
	BYTE_FREEIMAGE* accessPixels() const;
	...
	*/
	BYTE_FREEIMAGE* getScanLine(unsigned scanline) const;
	...
	*/
	BOOL_FREEIMAGE getPixelIndex(unsigned x, unsigned y, BYTE_FREEIMAGE *value) const;
	...
	*/
	BOOL_FREEIMAGE getPixelColor(unsigned x, unsigned y, RGBQUAD *value) const;
	...
	*/
	BOOL_FREEIMAGE setPixelIndex(unsigned x, unsigned y, BYTE_FREEIMAGE *value);
	...
	*/
	BOOL_FREEIMAGE setPixelColor(unsigned x, unsigned y, RGBQUAD *value);
	...
	*/
	BOOL_FREEIMAGE convertToType(FREE_IMAGE_TYPE image_type, BOOL_FREEIMAGE scale_linear = TRUE);
	...
	*/
	BOOL_FREEIMAGE threshold(BYTE_FREEIMAGE T);
	...
	*/
	BOOL_FREEIMAGE dither(FREE_IMAGE_DITHER algorithm);
	...
	*/
	...
	@return Returns TRUE if successfull, FALSE otherwise. 
	*/
	BOOL_FREEIMAGE convertToGrayscale();
	...
	*/
	BOOL_FREEIMAGE colorQuantize(FREE_IMAGE_QUANTIZE algorithm);
	...
	*/
	BOOL_FREEIMAGE convertTo16Bits555();
	...
	*/
	BOOL_FREEIMAGE convertTo16Bits565();
	...
	*/
	BOOL_FREEIMAGE convertTo24Bits();
	...
	*/
	BOOL_FREEIMAGE convertTo32Bits();
	...
	*/
	BOOL_FREEIMAGE convertToUINT16();
	...
	*/
	BOOL_FREEIMAGE toneMapping(FREE_IMAGE_TMO tmo, double first_param = 0, double second_param = 0, double third_param = 1, double fourth_param = 0);
	...
	*/
	BOOL_FREEIMAGE isTransparent() const;
	...
	*/
	BOOL_FREEIMAGE getFileBkColor(RGBQUAD *bkcolor) const;
	...
	*/
	BOOL_FREEIMAGE setFileBkColor(RGBQUAD *bkcolor);
	//@}
	...
	*/
	BOOL_FREEIMAGE getChannel(fipImage& image, FREE_IMAGE_COLOR_CHANNEL channel) const;
	...
	*/
	BOOL_FREEIMAGE setChannel(fipImage& image, FREE_IMAGE_COLOR_CHANNEL channel);
	...
	*/
	BOOL_FREEIMAGE splitChannels(fipImage& RedChannel, fipImage& GreenChannel, fipImage& BlueChannel);
	...
	*/
	BOOL_FREEIMAGE combineChannels(fipImage& red, fipImage& green, fipImage& blue);
	//@}
	...
	*/
	BOOL_FREEIMAGE rotateEx(double angle, double x_shift, double y_shift, double x_origin, double y_origin, BOOL_FREEIMAGE use_mask);
	...
	*/
	BOOL_FREEIMAGE rotate(double angle, const void *bkcolor = NULL);

	/**
	Flip the image horizontally along the vertical axis
	@see FreeImage_FlipHorizontal
	*/
	BOOL_FREEIMAGE flipHorizontal();

	/**
	Flip the image vertically along the horizontal axis
	@see FreeImage_FlipVertical
	*/
	BOOL_FREEIMAGE flipVertical();
	//@}
	...
	*/
	BOOL_FREEIMAGE adjustCurve(BYTE_FREEIMAGE *LUT, FREE_IMAGE_COLOR_CHANNEL channel);
	...
	*/
	BOOL_FREEIMAGE adjustGamma(double gamma);
	...
	*/
	BOOL_FREEIMAGE adjustBrightness(double percentage);
	...
	*/
	BOOL_FREEIMAGE adjustContrast(double percentage);
	...
	*/
	BOOL_FREEIMAGE adjustBrightnessContrastGamma(double brightness, double contrast, double gamma);
	...
	*/
	BOOL_FREEIMAGE getHistogram(DWORD_FREEIMAGE *histo, FREE_IMAGE_COLOR_CHANNEL channel = FICC_BLACK) const;
	//@}
	...
	*/
	BOOL_FREEIMAGE rescale(unsigned new_width, unsigned new_height, FREE_IMAGE_FILTER filter);
	...
	*/
	BOOL_FREEIMAGE makeThumbnail(unsigned max_size, BOOL_FREEIMAGE convert = TRUE);
	//@}
	...
	@see isModified
	*/
	void setModified(BOOL_FREEIMAGE bStatus = TRUE) {
	...
	*/
	BOOL_FREEIMAGE getMetadata(FREE_IMAGE_MDMODEL model, const char *key, fipTag& tag) const;
	/**
	...
	*/
	BOOL_FREEIMAGE setMetadata(FREE_IMAGE_MDMODEL model, const char *key, fipTag& tag);
	//@}
  ...
  protected:
	/**@name Internal use */
	//@{
	  BOOL_FREEIMAGE replace(FIBITMAP *new_dib);
	//@}
...
public:
	...
	*/
	...
	@return Returns TRUE if successful, returns FALSE otherwise
	*/
	BOOL_FREEIMAGE copyFromHandle(HANDLE hMem);

	/** Copy constructor.<br>
	Converts a HBITMAP object to a FIBITMAP.
	@return Returns TRUE if successful, returns FALSE otherwise
	*/
	BOOL_FREEIMAGE copyFromBitmap(HBITMAP hbmp);
	//@}
	...
	@return Returns TRUE if successful, returns FALSE otherwise
	*/
	BOOL_FREEIMAGE copyToClipboard(HWND hWndNewOwner) const;

	/**
	Retrieves data from the clipboard. The clipboard format must be CF_DIB.
	@return Returns TRUE if successful, returns FALSE otherwise
	*/
	BOOL_FREEIMAGE pasteFromClipboard();
	//@}
	...
	@return Returns TRUE if successful, returns FALSE otherwise
	*/
	BOOL_FREEIMAGE captureWindow(HWND hWndApplicationWindow, HWND hWndSelectedWindow);
	//@}
	...
	*/
	void drawEx(HDC hDC, RECT& rcDest, BOOL_FREEIMAGE useFileBkg = FALSE, RGBQUAD *appBkColor = NULL, FIBITMAP *bg = NULL) const;
...
protected:
	...
	mutable BOOL_FREEIMAGE _bDeleteMe;
...
public :
	...
	*/
    fipMemoryIO(BYTE_FREEIMAGE *data = NULL, DWORD_FREEIMAGE size_in_bytes = 0);
	...
	*/
	BOOL_FREEIMAGE save(FREE_IMAGE_FORMAT fif, FIBITMAP *dib, int flags = 0);
	/**
	...
	*/
	BOOL_FREEIMAGE saveMultiPage(FREE_IMAGE_FORMAT fif, FIMULTIBITMAP *bitmap, int flags = 0);
	/**
	...
	*/
	BOOL_FREEIMAGE seek(long offset, int origin);
	/**
	...
	*/
	BOOL_FREEIMAGE acquire(BYTE_FREEIMAGE **data, DWORD_FREEIMAGE *size_in_bytes);
	//@}
...
public:
	...
	*/
	fipMultiPage(BOOL_FREEIMAGE keep_cache_in_memory = FALSE);
	...
	*/
	BOOL_FREEIMAGE open(const char* lpszPathName, BOOL_FREEIMAGE create_new, BOOL_FREEIMAGE read_only, int flags = 0);
	...
	@see FreeImage_LoadMultiBitmapFromMemory
	*/
	BOOL_FREEIMAGE open(fipMemoryIO& memIO, int flags = 0);
	...
	*/
	BOOL_FREEIMAGE open(FreeImageIO *io, fi_handle handle, int flags = 0);
	...
	*/
	BOOL_FREEIMAGE close(int flags = 0);
	...
	*/
	BOOL_FREEIMAGE saveToHandle(FREE_IMAGE_FORMAT fif, FreeImageIO *io, fi_handle handle, int flags = 0) const;
	...
	*/
	BOOL_FREEIMAGE saveToMemory(FREE_IMAGE_FORMAT fif, fipMemoryIO& memIO, int flags = 0) const;
	...
	*/
	BOOL_FREEIMAGE movePage(int target, int source);
	...
	*/
	void unlockPage(fipImage& image, BOOL_FREEIMAGE changed);
	...
	*/
	BOOL_FREEIMAGE getLockedPageNumbers(int *pages, int *count) const;
};
...
public:
	...
	*/
	...
	@see FreeImage_CreateTag
	*/
	BOOL_FREEIMAGE setKeyValue(const char *key, const char *value);
...
public:
	...
	*/
	BOOL_FREEIMAGE findFirstMetadata(FREE_IMAGE_MDMODEL model, fipImage& image, fipTag& tag);
	/**
	...
	*/
	BOOL_FREEIMAGE findNextMetadata(fipTag& tag);
