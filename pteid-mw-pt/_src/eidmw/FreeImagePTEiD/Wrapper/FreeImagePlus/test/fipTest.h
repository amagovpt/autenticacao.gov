...
BOOL_FREEIMAGE testCloneMultiPage(const char *input, const char *output, int output_flag);
/// Test the above functions
...
BOOL_FREEIMAGE testStreamMultiPageOpen(const char *input, int flags);
/// test multipage stream (save as)
BOOL_FREEIMAGE testStreamMultiPageSave(const char *input, const char *output, int input_flag, int output_flag);
/// test multipage stream (open, modify, save as)
BOOL_FREEIMAGE testStreamMultiPageOpenSave(const char *input, const char *output, int input_flag, int output_flag);
/// Test the above functions
