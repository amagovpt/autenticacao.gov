...
BOOL_FREEIMAGE fipMetadataFind::isValid() const {
...
BOOL_FREEIMAGE fipMetadataFind::findFirstMetadata(FREE_IMAGE_MDMODEL model, fipImage& image, fipTag& tag) {
	FITAG *firstTag = NULL;
...
BOOL_FREEIMAGE fipMetadataFind::findNextMetadata(fipTag& tag) {
	FITAG *nextTag = NULL;
