...
void testMPageCache(const char *src_filename, const char *dst_filename) {
	...
	BOOL_FREEIMAGE keep_cache_in_memory = FALSE;
...
BOOL_FREEIMAGE testCloneMultiPage(FREE_IMAGE_FORMAT fif, const char *input, const char *output, int output_flag) {
...
void testLockDeleteMultiPage(const char *input) {
	...
	BOOL_FREEIMAGE bReadOnly = FALSE;
	BOOL_FREEIMAGE bMemoryCache = TRUE;
