...
#ifdef WIN64
#define PKCS11_LIB "..\\_Binaries35\\x64\\Debug\\pteid35pkcs11D.dll"
#else
#define PKCS11_LIB "..\\_Binaries35\\Debug\\pteid35pkcs11D.dll"
#endif
#define RTLD_LAZY	1
#define RTLD_NOW	2
...
#include <dlfcn.h>
#include <unistd.h>
#define PKCS11_LIB "/usr/local/lib/libpteidpkcs11.so" 
#endif
#include <stdlib.h>
