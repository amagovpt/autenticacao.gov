...
public:
	dlgWndAskCmd(DlgCmdOperation operation, bool isValidateOtp, QString &Header, std::wstring *inOutId = NULL,
				 std::wstring *userName = NULL, bool callbackWasCalled = false, bool askForId = false,
