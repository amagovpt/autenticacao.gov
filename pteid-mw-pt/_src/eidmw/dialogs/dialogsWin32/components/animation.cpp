...
void PteidControls::Paint_Circle_Animation(HWND hWnd, HDC hdc, int circle_x, int circle_y, int outer_circle_diameter,
...
void PteidControls::Circle_Animation_OnPaint(HWND hWnd, HDC hdc, const RECT *animation_rect, PAINTSTRUCT *ps,
											 int angle) {
	if (hdc) {
		HDC hdcTo;
		...
		Paint_Circle_Animation(hWnd, hdcTo, animation_rect->left, animation_rect->top, outer_circle_diam,
							   outer_circle_diam - 30, angle);
