...
DEFINE_LANG_STR(UnlockDialogHeader) = {L"To unlock your PIN code you must know the matching PUK code",
									   L"Para desbloquear o PIN terá de saber qual o respectivo código de desbloqueio",
									   L"", L""};
...
DEFINE_LANG_STR(EnterYourNewPinCodeAgainToConfirm) = {L"Enter your New PIN code again to confirm",
													  L"Introduza novamente o novo código PIN", L"", L""};
DEFINE_LANG_STR(ErrorTheNewPinCodesAreNotIdentical) = {L"PINs do no match.", L"PINs não correspondem.", L"", L""};
DEFINE_LANG_STR(RetryEnterYourNewPinCode) = {L"Retry: Enter your New PIN code", L"Repetir: Introduza o novo código PIN",
											 L"", L""};
...
DEFINE_LANG_STR(SignaturePinCmd) = {L"Insert Digital Mobile Key's Signature PIN",
									L"Inserir PIN da assinatura da Chave Móvel Digital", L"", L""};
...
DEFINE_LANG_STR(PleaseEnterTheCorrectEidCard) = {L"Please enter the correct eID card.", L"Introduza um cartão válido.",
												 L"", L""};
...
DEFINE_LANG_STR(YouAreAboutToMakeALegallyBindingElectronic) = {
	...
	L"Vai realizar uma assinatura eletrónica válida com o seu Cartão de Cidadão.", L"", L""};
DEFINE_LANG_STR(YouAreAboutToMakeALegallyBindingElectronicWithCmd) = {
	L"You are about to make a legally binding electronic signature with Digital Mobile Key.",
	L"Vai realizar uma assinatura eletrónica válida com a Chave Móvel Digital.", L"", L""};
DEFINE_LANG_STR(PleaseEnterYourPin) = {L"Please enter your PIN", L"Introduza o código PIN", L"", L""};
DEFINE_LANG_STR(PleaseEnterYourPinOnThePinpadReader) = {L"Please enter your PIN on the pinpad reader.",
														L"Por favor, introduza o PIN no seu leitor PINPAD.", L"", L""};
DEFINE_LANG_STR(ToContinueOrClickTheCancelButton) = {L"to continue or click the Cancel button.",
													 L"para continuar ou clique em cancelar", L"", L""};
DEFINE_LANG_STR(Warning) = {L"Warning:", L"Aviso:", L"", L""};
DEFINE_LANG_STR(InOrderToAuthenticateYourself) = {L"in order to authenticate yourself.", L"para se autenticar.", L"",
												  L""};
DEFINE_LANG_STR(ChangeYourPinOnTheReader) = {L"Change your PIN on the reader.", L"Change your PIN on the reader.", L"",
											 L""};
DEFINE_LANG_STR(PleaseEnterYourPuk) = {L"Please enter your PUK", L"Introduza o cod. PUK", L"", L""};
DEFINE_LANG_STR(PleaseEnterYourPukOnThePinpadReader) = {L"Please enter your PUK on the pinpad reader.",
														L"Por favor, introduza o código PUK no seu leitor PINPAD.", L"",
														L""};
...
DEFINE_LANG_STR(UnlockDialogInstructions) = {
	L"1) Enter your PUK code and press 'OK'. \n2) Enter your new PIN and press 'OK'.3) Enter your new PIN again and "
	L"press 'OK'.",
	L"1) Por favor insira o seu código PUK e pressione 'OK' \n2) Introduza o seu novo PIN e pressione 'OK'. \n3) "
	L"Introduza novamente o seu novo PIN e pressione 'OK'.",
	L"", L""};
DEFINE_LANG_STR(UnlockWithoutPUKInstructions) = {
	L"1) Enter your new PIN and press 'OK'. \n2) Enter your new PIN again and press 'OK'.",
	L"1) Por favor introduza o seu novo PIN e pressione 'OK'\n2) Introduza novamente o seu novo PIN e pressione 'OK'.",
	L"", L""};
DEFINE_LANG_STR(PinpadCanBeDisabled) = {
	L"The pinpad functionality can be disabled in Application Configuration. Check manual.",
	L"A funcionalidade PINPAD pode ser desativada na Configuração da Aplicação. Ver manual.", L"", L""};
DEFINE_LANG_STR(MobileNumber) = {L"Mobile number", L"Número de telemóvel", L"", L""};
DEFINE_LANG_STR(InsertMobileNumber) = {L"Insert associated mobile number", L"Inserir número de telemóvel associado",
									   L"", L""};
...
DEFINE_LANG_STR(TheChosenCertificateIsFrom) = {L"Signing with certificate from ", L"Assinatura com certificado de", L"",
											   L""};
DEFINE_LANG_STR(AssociatedWithNumber) = {L"with associated mobile number", L"com número de telemóvel associado", L"",
										 L""};
DEFINE_LANG_STR(Error) = {L"ERROR", L"ERRO", L"", L""};
DEFINE_LANG_STR(PleaseWait) = {L"PLEASE WAIT", L"POR FAVOR AGUARDE", L"", L""};
DEFINE_LANG_STR(IncorrectPin) = {L"The PIN of the Citizen Card is incorrect.",
								 L"O PIN do Cartão de Cidadão introduzido está incorrecto.", L"", L""};
DEFINE_LANG_STR(SelectDevice) = {L"Select the signature device", L"Selecione o meio de assinatura", L"", L""};
DEFINE_LANG_STR(SendingOtp) = {L"Sending confirmation code to server.",
							   L"Enviando o código de confirmação para o servidor.", L"", L""};
DEFINE_LANG_STR(ObtainingCMDCert) = {L"Obtaining certificate of Digital Mobile Key",
									 L"Obter certificado da Chave Móvel Digital", L"", L""};
DEFINE_LANG_STR(ConnectingWithServer) = {L"Connecting with server.", L"A conectar com o servidor.", L"", L""};
DEFINE_LANG_STR(ActivateOrManageCMD) = {L"Click to activate or manage your Chave Móvel Digital signature",
...
DEFINE_LANG_STR(BiometricAppInfo) = {L"With the mobile app gov.pt, you can use your biometric data to confirm the signature.", L"Utilizando os seus dados biométricos na aplicação móvel gov.pt" ,  L"", L"" };
...
DEFINE_LANG_STR(InsertOTP) = { L"Inserting the one time password sent to your phone in the next 2 minutes.", L"Inserindo, nos próximos 2 minutos, o código que foi enviado para o seu telemóvel.", L"", L"" };
