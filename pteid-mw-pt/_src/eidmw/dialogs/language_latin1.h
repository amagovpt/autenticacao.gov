...
DEFINE_LANG_STR(RenewingPinCode) = {L"Change PIN code.", L"Alterar código PIN.", L"", L""};
...
DEFINE_LANG_STR(IncorrectPin) = {L"The PIN is incorrect.", L"O PIN introduzido está incorrecto.", L"", L""};
