...
DEFINE_LANG_STR(AnApplicationWantsToAccessTheCard) = {L"An Application wants to access the card !", L"Uma aplicação esta a tentar ler o cartao !", L"Une application essaye d'acc�der � la carte !", L"Eine Anwendung will auf die Karte zugreifen!"};
DEFINE_LANG_STR(ReadIdentityData) = {L"Read Identity data", L"A Ler dados do cartao", L"Lire les informations d'identit�e", L"Identit�tsdaten lesen"};
...
DEFINE_LANG_STR(EnterYour) = {L"Enter your", L"Entrar", L"Entrez votre", L"Geben Sie Ihre"};
...
DEFINE_LANG_STR(ConfirmNewPin) = {L"Confirm new PIN", L"Confirmar código PIN", L"Confimez", L"Neue PIN best�tigen"};
...
DEFINE_LANG_STR(EnterYourNewPinCodeAgainToConfirm) = {L"Enter your New PIN code again to confirm", L"Introduza novamente o novo código PIN", L"Confimez votre nouveau code PIN", L"Neue PIN-Kennzahl erneut best�tigen"};
DEFINE_LANG_STR(ErrorTheNewPinCodesAreNotIdentical) = {L"Error: The new PIN codes are not identical", L"Erro: os PINS não são iguais", L"Erreur: Les codes PIN ne sont pas identiques", L"Fehler: Die PIN-Kennzahlen sind nicht identisch"};
DEFINE_LANG_STR(RetryEnterYourNewPinCode) = {L"Retry: Enter your New PIN code", L"Repetir: Introduza o novo código PIN", L"R�essayez: Entrez votre nouveau code PIN", L"Erneut versuchen: Neue PIN-Kennzahl eingeben"};
DEFINE_LANG_STR(Bad) = {L"Bad", L"Erro", L"Erreur", L"Fehler"};
DEFINE_LANG_STR(Notification) = {L"Notification", L"Notificação", L"Notification", L"Meldung"};
DEFINE_LANG_STR(RemainingAttempts) = {L"remaining attempts", L"tentativas restantes", L"essais restants", L"�brige Versuche"};
DEFINE_LANG_STR(TryAgainOrCancel) = {L"Try again or cancel?", L"Tentar novamente on cancelar?", L"Essayez encore ou annulez", L"Erneut versuchen oder abbrechen?"};
...
DEFINE_LANG_STR(AuthenticationPin) = {L"Authentication PIN", L"PIN de autenticacao", L"Authentification PIN", L"Authentisierungs-PIN"};
...
DEFINE_LANG_STR(ThisMayBeATestCard) = {L"This may be a test card.", L"Este pode ser um cartão de testes.", L"Il s'agit peut-�tre d'une carte de test.", L"Dies kann eine Testkarte sein."};
DEFINE_LANG_STR(PleaseEnterTheCorrectEidCard) = {L"Please enter the correct eID card.", L"Introduza um cartão valido.", L"Ins�rez une carte valide.", L"Bitte geben Sie die richtige eID-Karte ein."};
DEFINE_LANG_STR(Caution) = {L"Caution:", L"Atencao:", L"Attention:", L"Achtung:"};
DEFINE_LANG_STR(YouAreAboutToMakeALegallyBindingElectronic) = {L"You are about to make a legally binding electronic signature with your identity card.", L"You are about to make a legally binding electronic signature with your identity card.", L"Vous allez apposer une signature �lectronique juridiquement valide avec votre carte d'identit�", L"Mit Ihrem Personalausweis werden Sie eine rechtsg�ltige elektronische Unterschrift eingeben."};
DEFINE_LANG_STR(PleaseEnterYourPin) = {L"Please enter your PIN", L"Introduza o codigo PIN", L"Entrez votre code PIN", L"Bitte geben Sie Ihre PIN ein"};
DEFINE_LANG_STR(PleaseEnterYourPinOnThePinpadReader) = {L"Please enter your PIN on the pinpad reader", L"Please enter your PIN on the pinpad reader", L"Entrez votre code PIN sur le clavier du lecteur de carte", L"Bitte geben Sie Ihre PIN am Kartenleseger�t ein"};
