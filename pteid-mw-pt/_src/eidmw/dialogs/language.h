...
DEFINE_LANG_STR(RenewingPinCode) = {L"Renewing PIN code", L"Renovar cÃ³digo PIN", L"Changement de code", L"PIN-Kennzahl erneuern"};
...
DEFINE_LANG_STR(ConfirmNewPin) = {L"Confirm new PIN", L"Confirmar cÃ³digo PIN", L"Confimez", L"Neue PIN bestï¿½tigen"};
DEFINE_LANG_STR(EnterYourNewPinCode) = {L"Enter your New PIN code", L"Introduza o novo cÃ³digo PIN", L"Entrez votre nouveau code PIN", L"Neue PIN-Kennzahl eingeben"};
...
DEFINE_LANG_STR(PleaseEnterTheCorrectEidCard) = {L"Please enter the correct eID card.", L"Introduza um cartÃ£o valido.", L"Insï¿½rez une carte valide.", L"Bitte geben Sie die richtige eID-Karte ein."};
...
DEFINE_LANG_STR(PleaseEnterYourPinOnThePinpadReader) = {L"Please enter your PIN on the pinpad reader", L"Please enter your PIN on the pinpad reader", L"Entrez votre code PIN sur le clavier du lecteur de carte", L"Bitte geben Sie Ihre PIN am Kartenlesegerï¿½t ein"};
...
DEFINE_LANG_STR(PleaseEnterYourPukOnThePinpadReader) = {L"Please enter your PUK on the pinpad reader", L"Geef uw PUK in op de kaartlezer", L"Entrez votre code PUK sur le clavier du lecteur de carte", L"Bitte geben Sie Ihren PUK am Kartenlesegerï¿½t ein"};
