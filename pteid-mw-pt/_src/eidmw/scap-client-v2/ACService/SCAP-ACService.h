...
/* SCAP-ACService.h
   Generated by wsdl2h 2.8.28 from http://localhost:8000/ACService.wsdl and typemap.dat
   2016-10-21 15:11:54 GMT
...
@note HINTS:
 - Run soapcpp2 on SCAP-ACService.h to generate the SOAP/XML processing logic.
...
class ns2__SignedAttributesType
{ public:
/// Vector of ds__SignatureType element refs of length 1..unbounded.
    std::vector<ds__SignatureType      > ns3__SignatureAttribute        1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/** @mainpage AttributeClientService Definitions

@section AttributeClientService_bindings Service Bindings

  - @ref AttributeClientServiceBinding

@section AttributeClientService_more More Information
...
@section ns2 Top-level root elements of schema "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService"
  ...
  - <ns2:AttributeRequest> (use wsdl2h option -g to auto-generate type _ns2__AttributeRequest)

  - <ns2:AttributeResponse> (use wsdl2h option -g to auto-generate type _ns2__AttributeResponse)

  - <ns2:PSAAttributeRequest> (use wsdl2h option -g to auto-generate type _ns2__PSAAttributeRequest)

  - <ns2:SingleAttributeResponse> (use wsdl2h option -g to auto-generate type _ns2__SingleAttributeResponse)
