...
extern DWORD PteidGetIASv5PubKey(PCARD_DATA  pCardData, DWORD dwCertSpec, DWORD *pcbPubKey, PBYTE *ppbPubKey)
{
	...
	if (!checkStatusCode(WHERE, dwReturn, SW1, SW2)) {
...
DWORD PteidSignDataGemsafe(PCARD_DATA pCardData, BYTE pin_id, DWORD cbToBeSigned, PBYTE pbToBeSigned, DWORD *pcbSignature, PBYTE *ppbSignature, BOOL pss_padding)
{
   ...
   *ppbSignature = pCardData->pfnCspAlloc(*pcbSignature);
   ...
   if (SW1 != 0x90 && SW2 != 0x00) {
	...
	{
		//Convert the RSA signature to big-endian with the result in ppbSignature
...
DWORD PteidReadCert(PCARD_DATA  pCardData, DWORD dwCertSpec, DWORD *pcbCertif, PBYTE *ppbCertif)
{
   ...
   cbCertif = 2500; //More than enough for any certificate...
   ...
   *ppbCertif = pCardData->pfnCspAlloc(cbCertif);
	...
	unsigned char auth_certificate[] = {
		 
	};
	unsigned char sign_certificate[] = {
		
	};

   DWORD hardcoded_auth_cert_len = sizeof(auth_certificate);
   DWORD hardcoded_sign_cert_len = sizeof(sign_certificate);
   //XX: temporary workaround for development cards not containing consistent keys and certificates
   if (card_type == IAS_V5_CARD) {
       if (dwCertSpec == 2) {
           *pcbCertif = hardcoded_sign_cert_len;
           memcpy(*ppbCertif, sign_certificate, sizeof(sign_certificate));
       }
       else {
           *pcbCertif = hardcoded_auth_cert_len;
