...
public class PTEID_Sod : PTEID_Biometric {
  private HandleRef swigCPtr;

  internal PTEID_Sod(IntPtr cPtr, bool cMemoryOwn) : base(pteidlib_dotNetPINVOKE.PTEID_SodUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if(swigCPtr.Handle != IntPtr.Zero && swigCMemOwn) {
        swigCMemOwn = false;
        pteidlib_dotNetPINVOKE.delete_PTEID_Sod(swigCPtr);
      }
  ...
  public PTEID_ByteArray getData() {
    PTEID_ByteArray ret = new PTEID_ByteArray(pteidlib_dotNetPINVOKE.PTEID_Sod_getData(swigCPtr), false);
