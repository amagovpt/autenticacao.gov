...
static P11_MAP_TYPE const P11_CLASS_TYPES[] = {{CKO_DATA, "CKO_DATA"},
...
static P11_MAP_TYPE const P11_CERTIFICATE_TYPES[] = {
	{CKC_X_509, "CKC_X_509"}, {CKC_X_509_ATTR_CERT, "CKC_X_509_ATTR_CERT"}, {0, 0}};

static P11_MAP_TYPE const P11_KEY_TYPES[] = {
	{CKK_RSA, "CKK_RSA"},		  {CKK_DSA, "CKK_DSA"},	  {CKK_DH, "CKK_DH"},	  {CKK_ECDSA, "CKK_ECDSA"},
	{CKK_EC, "CKK_EC"},			  {CKK_RC2, "CKK_RC2"},	  {CKK_RC4, "CKK_RC4"},	  {CKK_RC5, "CKK_RC5"},
	{CKK_DES, "CKK_DES"},		  {CKK_DES3, "CKK_DES3"}, {CKK_CAST, "CKK_CAST"}, {CKK_CAST3, "CKK_CAST3"},
	{CKK_CAST128, "CKK_CAST128"}, {CKK_IDEA, "CKK_IDEA"}, {CKK_AES, "CKK_AES"},	  {0, 0}};

static P11_MAP_TYPE const P11_ATTR_TYPES[] = {{CKA_CLASS, "CKA_CLASS", T_TYPE},
											  ...
											  {CKA_ALWAYS_AUTHENTICATE, "CKA_ALWAYS_AUTHENTICATE", T_BOOL},
