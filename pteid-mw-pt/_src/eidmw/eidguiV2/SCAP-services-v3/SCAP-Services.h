...
/* 
   Generated by wsdl2h 2.8.105 from https://scap.autenticacao.gov.pt/DSS/ACService?wsdl https://scap.autenticacao.gov.pt/DSS/ASService?wsdl https://scap.autenticacao.gov.pt/SCAPSignature/AuthorizationService?wsdl https://scap.autenticacao.gov.pt/SCAPSignature/SignatureService?wsdl and typemap.dat
   2020-07-30 16:51:00 GMT
...
ns10 = "http://www.cartaodecidadao.pt/ccc/sccc/services/AttributeClientService"
...
ns11 = "http://www.cartaodecidadao.pt/ccc/commons/messages/TypesAttributeManagment"
...
//gsoap ns10  schema namespace:	http://www.cartaodecidadao.pt/ccc/sccc/services/AttributeClientService
...
//gsoap ns11  schema namespace:	http://www.cartaodecidadao.pt/ccc/commons/messages/TypesAttributeManagment
...
class ns9__AttributeSupplierRequestType;
 ...
 *                                                                            *
 * Schema Types and Top-Level Elements and Attributes                         *
 *   http://www.cartaodecidadao.pt/ccc/commons/messages/TypesAttributeManagment*
 *                                                                            *
\******************************************************************************/
...
/// @brief "http://www.w3.org/2000/09/xmldsig#":X509IssuerNameType is a simpleType restriction of type xs:string.
///
typedef std::string ns5__X509IssuerNameType;

/// @brief "http://www.w3.org/2000/09/xmldsig#":X509SerialNumberType is a simpleType restriction of type xs:integer.
///
...
/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 40.
typedef std::string ns4__ProcessIDType : 40;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NameType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__NameType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ValidityType is a simpleType restriction of type xs:date.
///
typedef xsd__date ns4__ValidityType;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":DateType is a simpleType restriction of type xs:date.
///
typedef xsd__date ns4__DateType;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NICType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__NICType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":CompanyNameType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__CompanyNameType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NIPCType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__NIPCType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ExtraIDValueType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__ExtraIDValueType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":AttributeIDType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__AttributeIDType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":EnterpriseURIID is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__EnterpriseURIID : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":LegalActType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 2048.
typedef std::string ns4__LegalActType : 2048;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":SubAttributeValueType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__SubAttributeValueType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":DescriptionType is a simpleType restriction of type xs:string.
///
/// Length of this content is 0 to 255.
typedef std::string ns4__DescriptionType : 255;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":isDelegableType is a simpleType restriction of type xs:boolean.
///
typedef bool ns4__isDelegableType;

/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":EmailAddressType is a simpleType restriction of type xs:string.
///
/// Content pattern is "[^@]+@[^\\.]+\\..+".
...
/// @brief "http://uri.etsi.org/01903/v1.3.2#":SigningTimeType is a simpleType restriction of type xs:dateTime.
///
typedef time_t ns6__SigningTimeType;

/// @brief "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedTimeStampType is a simpleType restriction of type xs:base64Binary.
///
typedef xsd__base64Binary ns6__EncapsulatedTimeStampType;

/// @brief "http://uri.etsi.org/01903/v1.3.2#":IssuerType is a simpleType restriction of type xs:string.
///
typedef std::string ns6__IssuerType;

/// @brief "http://uri.etsi.org/01903/v1.3.2#":IssueTimeType is a simpleType restriction of type xs:dateTime.
///
typedef time_t ns6__IssueTimeType;

/// @brief "http://uri.etsi.org/01903/v1.3.2#":NumberType is a simpleType restriction of type xs:integer.
///
typedef xsd__integer ns6__NumberType;

/// @brief "http://uri.etsi.org/01903/v1.3.2#":ByNameType is a simpleType restriction of type xs:string.
///
typedef std::string ns6__ByNameType;

/// @brief "http://uri.etsi.org/01903/v1.3.2#":ProducedAtType is a simpleType restriction of type xs:dateTime.
///
...
/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/SVG":SVGType is a simpleType restriction of type xs:base64Binary.
///
...
/// @brief "http://www.cartaodecidadao.pt/ccc/commons/messages/TypesAttributeManagment":CrudCodeType is a simpleType restriction of type xs:string.
///
/// @note The enum values are prefixed with "ns11__CrudCodeType__" to prevent name clashes: use wsdl2h option -e to omit this prefix or use option -c++11 for scoped enumerations
enum ns11__CrudCodeType
{
	ns11__CrudCodeType__UPDATE,	///< xs:string value="UPDATE"
	ns11__CrudCodeType__REMOVE,	///< xs:string value="REMOVE"
	ns11__CrudCodeType__CREATE,	///< xs:string value="CREATE"
	ns11__CrudCodeType__IDLE,	///< xs:string value="IDLE"
};
...
///
/// @note class ns2__AttributeRequestType operations:
/// - ns2__AttributeRequestType* soap_new_ns2__AttributeRequestType(soap*) allocate and default initialize
/// - ns2__AttributeRequestType* soap_new_ns2__AttributeRequestType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__AttributeRequestType::soap_type() returns SOAP_TYPE_ns2__AttributeRequestType or derived type identifier
class ns2__AttributeRequestType
{ public:
/// Element "ProcessId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType.
    ns4__ProcessIDType                   ProcessId                      1;	///< Required element.
/// Element "Citizen" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":PersonalDataType.
    ns3__PersonalDataType*               Citizen                        1;	///< Required element.
/// Element "AttributeSuppliers" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":AttributeSupplierListType.
    ns2__AttributeSupplierListType*      AttributeSuppliers             1;	///< Required element.
/// Element "AllEnterprises" of type xs:boolean.
    bool*                                AllEnterprises                 0;	///< Optional element.
/// Element "AppId" of type xs:string.
    std::string*                         AppId                          0;	///< Optional element.
/// Element "AppName" of type xs:string.
    std::string*                         AppName                        0;	///< Optional element.
/// Element "SecretKey" of type xs:string.
...
///
/// @note class ns2__SingleAttributeRequestType operations:
/// - ns2__SingleAttributeRequestType* soap_new_ns2__SingleAttributeRequestType(soap*) allocate and default initialize
/// - ns2__SingleAttributeRequestType* soap_new_ns2__SingleAttributeRequestType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__SingleAttributeRequestType::soap_type() returns SOAP_TYPE_ns2__SingleAttributeRequestType or derived type identifier
class ns2__SingleAttributeRequestType
{ public:
/// Element "ProcessId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType.
    ns4__ProcessIDType                   ProcessId                      1;	///< Required element.
/// Element "Citizen" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":PersonalDataType.
    ns3__PersonalDataType*               Citizen                        1;	///< Required element.
/// Element "AttributeSuppliers" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":AttributeSupplierType.
...
///
/// @note class ns2__PSAAttributeRequestType operations:
/// - ns2__PSAAttributeRequestType* soap_new_ns2__PSAAttributeRequestType(soap*) allocate and default initialize
/// - ns2__PSAAttributeRequestType* soap_new_ns2__PSAAttributeRequestType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__PSAAttributeRequestType::soap_type() returns SOAP_TYPE_ns2__PSAAttributeRequestType or derived type identifier
class ns2__PSAAttributeRequestType
{ public:
/// Element "ProcessId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType.
    ns4__ProcessIDType                   ProcessId                      1;	///< Required element.
/// Element "Citizen" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":PersonalDataType.
    ns3__PersonalDataType*               Citizen                        1;	///< Required element.
/// Element "CompanyId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NIPCType.
    ns4__NIPCType*                       CompanyId                      0;	///< Optional element.
/// Element "CompanyName" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":CompanyNameType.
...
///
/// @note class ns2__AttributeSupplierListType operations:
/// - ns2__AttributeSupplierListType* soap_new_ns2__AttributeSupplierListType(soap*) allocate and default initialize
/// - ns2__AttributeSupplierListType* soap_new_ns2__AttributeSupplierListType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__AttributeSupplierListType::soap_type() returns SOAP_TYPE_ns2__AttributeSupplierListType or derived type identifier
class ns2__AttributeSupplierListType
{ public:
/// Vector of ns3__AttributeSupplierType* of length 1..unbounded.
    std::vector<ns3__AttributeSupplierType*> AttributeSupplier              1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns2__AttributeResponseType operations:
/// - ns2__AttributeResponseType* soap_new_ns2__AttributeResponseType(soap*) allocate and default initialize
/// - ns2__AttributeResponseType* soap_new_ns2__AttributeResponseType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__AttributeResponseType::soap_type() returns SOAP_TYPE_ns2__AttributeResponseType or derived type identifier
class ns2__AttributeResponseType
{ public:
/// Element "ProcessId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType.
    ns4__ProcessIDType                   ProcessId                      1;	///< Required element.
/// Vector of ns2__AttributesType* of length 1..unbounded.
    std::vector<ns2__AttributesType*   > AttributeResponseValues        1;	///< Multiple elements.
...
///
/// @note class ns2__SingleAttributeResponseType operations:
/// - ns2__SingleAttributeResponseType* soap_new_ns2__SingleAttributeResponseType(soap*) allocate and default initialize
/// - ns2__SingleAttributeResponseType* soap_new_ns2__SingleAttributeResponseType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__SingleAttributeResponseType::soap_type() returns SOAP_TYPE_ns2__SingleAttributeResponseType or derived type identifier
class ns2__SingleAttributeResponseType
{ public:
/// Element "ProcessId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType.
    ns4__ProcessIDType                   ProcessId                      1;	///< Required element.
/// Element "AttributeResponseValues" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":AttributesType.
...
///
/// @note class ns2__UnsignedAttributeResponseType operations:
/// - ns2__UnsignedAttributeResponseType* soap_new_ns2__UnsignedAttributeResponseType(soap*) allocate and default initialize
/// - ns2__UnsignedAttributeResponseType* soap_new_ns2__UnsignedAttributeResponseType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__UnsignedAttributeResponseType::soap_type() returns SOAP_TYPE_ns2__UnsignedAttributeResponseType or derived type identifier
class ns2__UnsignedAttributeResponseType
{ public:
/// Element "ProcessId" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ProcessIDType.
    ns4__ProcessIDType                   ProcessId                      1;	///< Required element.
...
/// Element "CompanyName" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":CompanyNameType.
    ns4__CompanyNameType*                CompanyName                    0;	///< Optional element.
/// Element "AttributeResponseValues" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":UnsignedAttributesType.
...
///
/// @note class ns2__AttributesType operations:
/// - ns2__AttributesType* soap_new_ns2__AttributesType(soap*) allocate and default initialize
/// - ns2__AttributesType* soap_new_ns2__AttributesType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__AttributesType::soap_type() returns SOAP_TYPE_ns2__AttributesType or derived type identifier
class ns2__AttributesType
{ public:
/// Element "ATTRSupplier" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":AttributeSupplierType.
    ns3__AttributeSupplierType*          ATTRSupplier                   1;	///< Required element.
/// Element "ResponseResult" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":ResponseResult.
    ns2__ResponseResult*                 ResponseResult                 1;	///< Required element.
/// Element "SignedAttributes" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":SignedAttributesType.
...
///
/// @note class ns2__UnsignedAttributesType operations:
/// - ns2__UnsignedAttributesType* soap_new_ns2__UnsignedAttributesType(soap*) allocate and default initialize
/// - ns2__UnsignedAttributesType* soap_new_ns2__UnsignedAttributesType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__UnsignedAttributesType::soap_type() returns SOAP_TYPE_ns2__UnsignedAttributesType or derived type identifier
class ns2__UnsignedAttributesType
{ public:
/// Element "ResponseResult" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":ResponseResult.
    ns2__ResponseResult*                 ResponseResult                 1;	///< Required element.
/// Element "UnsignedAttributes" of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":UnsignedAttributesBasicType.
...
///
/// @note class ns2__SignedAttributesType operations:
/// - ns2__SignedAttributesType* soap_new_ns2__SignedAttributesType(soap*) allocate and default initialize
/// - ns2__SignedAttributesType* soap_new_ns2__SignedAttributesType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__SignedAttributesType::soap_type() returns SOAP_TYPE_ns2__SignedAttributesType or derived type identifier
class ns2__SignedAttributesType
{ public:
/// Vector of ns5__SignatureType* element refs of length 1..unbounded.
    std::vector<ns5__SignatureType*    > ns3__SignatureAttribute        1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns2__UnsignedAttributesBasicType operations:
/// - ns2__UnsignedAttributesBasicType* soap_new_ns2__UnsignedAttributesBasicType(soap*) allocate and default initialize
/// - ns2__UnsignedAttributesBasicType* soap_new_ns2__UnsignedAttributesBasicType(soap*, int num) allocate and default initialize an array
...
/// - int ns2__UnsignedAttributesBasicType::soap_type() returns SOAP_TYPE_ns2__UnsignedAttributesBasicType or derived type identifier
class ns2__UnsignedAttributesBasicType
{ public:
/// Vector of ns3__AttributeType* element refs of length 1..unbounded.
    std::vector<ns3__AttributeType*    > ns3__Attribute                 1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns2__ResponseResult operations:
/// - ns2__ResponseResult* soap_new_ns2__ResponseResult(soap*) allocate and default initialize
/// - ns2__ResponseResult* soap_new_ns2__ResponseResult(soap*, int num) allocate and default initialize an array
...
/// - int ns2__ResponseResult::soap_type() returns SOAP_TYPE_ns2__ResponseResult or derived type identifier
class ns2__ResponseResult
{ public:
/// Element "ResultCode" of type xs:string.
    std::string                          ResultCode                     1;	///< Required element.
/// Element "ResultMessage" of type xs:string.
    std::string                          ResultMessage                  1;	///< Required element.
/// Element "CitizenIDWithExtraInfo" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":PersonalDataType.
...
///
/// @note class ns5__SignatureType operations:
/// - ns5__SignatureType* soap_new_ns5__SignatureType(soap*) allocate and default initialize
/// - ns5__SignatureType* soap_new_ns5__SignatureType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__SignatureType::soap_type() returns SOAP_TYPE_ns5__SignatureType or derived type identifier
class ns5__SignatureType
{ public:
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"SignedInfo.
    ns5__SignedInfoType*                 ns5__SignedInfo                1;	///< Required element.
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"SignatureValue.
    ns5__SignatureValueType*             ns5__SignatureValue            1;	///< Required element.
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"KeyInfo.
    ns5__KeyInfoType*                    ns5__KeyInfo                   1;	///< Required element.
/// Vector of ns5__ObjectType* element refs of length 0..unbounded.
    std::vector<ns5__ObjectType*       > ns5__Object                    0;	///< Multiple elements.
...
///
/// @note class ns5__SignedInfoType operations:
/// - ns5__SignedInfoType* soap_new_ns5__SignedInfoType(soap*) allocate and default initialize
/// - ns5__SignedInfoType* soap_new_ns5__SignedInfoType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__SignedInfoType::soap_type() returns SOAP_TYPE_ns5__SignedInfoType or derived type identifier
class ns5__SignedInfoType
{ public:
...
/// Vector of ns5__ReferenceType* element refs of length 1..unbounded.
    std::vector<ns5__ReferenceType*    > ns5__Reference                 1;	///< Multiple elements.
/// Attribute "Id" of type xs:ID.
  @ xsd__ID                              Id                             1;	///< Required attribute.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
...
///
/// @note class ns5__CanonicalizationMethodType operations:
/// - ns5__CanonicalizationMethodType* soap_new_ns5__CanonicalizationMethodType(soap*) allocate and default initialize
/// - ns5__CanonicalizationMethodType* soap_new_ns5__CanonicalizationMethodType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__CanonicalizationMethodType::soap_type() returns SOAP_TYPE_ns5__CanonicalizationMethodType or derived type identifier
class ns5__CanonicalizationMethodType
{ public:
...
///
/// @note class ns5__SignatureMethodType operations:
/// - ns5__SignatureMethodType* soap_new_ns5__SignatureMethodType(soap*) allocate and default initialize
/// - ns5__SignatureMethodType* soap_new_ns5__SignatureMethodType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__SignatureMethodType::soap_type() returns SOAP_TYPE_ns5__SignatureMethodType or derived type identifier
class ns5__SignatureMethodType
{ public:
/// Attribute "Algorithm" of type xs:anyURI.
  @ xsd__anyURI                          Algorithm                      1;	///< Required attribute.
...
///
/// @note class ns5__ReferenceType operations:
/// - ns5__ReferenceType* soap_new_ns5__ReferenceType(soap*) allocate and default initialize
/// - ns5__ReferenceType* soap_new_ns5__ReferenceType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__ReferenceType::soap_type() returns SOAP_TYPE_ns5__ReferenceType or derived type identifier
class ns5__ReferenceType
{ public:
...
///
/// @note class ns5__TransformsType operations:
/// - ns5__TransformsType* soap_new_ns5__TransformsType(soap*) allocate and default initialize
/// - ns5__TransformsType* soap_new_ns5__TransformsType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__TransformsType::soap_type() returns SOAP_TYPE_ns5__TransformsType or derived type identifier
class ns5__TransformsType
{ public:
/// Vector of ns5__TransformType* element refs of length 1..unbounded.
    std::vector<ns5__TransformType*    > ns5__Transform                 1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns5__TransformType operations:
/// - ns5__TransformType* soap_new_ns5__TransformType(soap*) allocate and default initialize
/// - ns5__TransformType* soap_new_ns5__TransformType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__TransformType::soap_type() returns SOAP_TYPE_ns5__TransformType or derived type identifier
class ns5__TransformType
{ public:
/// Attribute "Algorithm" of type xs:anyURI.
  @ xsd__anyURI                          Algorithm                      1;	///< Required attribute.
...
///
/// @note class ns5__DigestMethodType operations:
/// - ns5__DigestMethodType* soap_new_ns5__DigestMethodType(soap*) allocate and default initialize
/// - ns5__DigestMethodType* soap_new_ns5__DigestMethodType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__DigestMethodType::soap_type() returns SOAP_TYPE_ns5__DigestMethodType or derived type identifier
class ns5__DigestMethodType
{ public:
/// Attribute "Algorithm" of type xs:anyURI.
  @ xsd__anyURI                          Algorithm                      1;	///< Required attribute.
...
///
/// @note class ns5__KeyInfoType operations:
/// - ns5__KeyInfoType* soap_new_ns5__KeyInfoType(soap*) allocate and default initialize
/// - ns5__KeyInfoType* soap_new_ns5__KeyInfoType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__KeyInfoType::soap_type() returns SOAP_TYPE_ns5__KeyInfoType or derived type identifier
class ns5__KeyInfoType
{ public:
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"X509Data.
...
///
/// @note class ns5__X509DataType operations:
/// - ns5__X509DataType* soap_new_ns5__X509DataType(soap*) allocate and default initialize
/// - ns5__X509DataType* soap_new_ns5__X509DataType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__X509DataType::soap_type() returns SOAP_TYPE_ns5__X509DataType or derived type identifier
class ns5__X509DataType
{ public:
/// Vector of ns5__X509CertificateType* element refs of length 1..unbounded.
    std::vector<ns5__X509CertificateType*> ns5__X509Certificate           1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns5__ObjectType operations:
/// - ns5__ObjectType* soap_new_ns5__ObjectType(soap*) allocate and default initialize
/// - ns5__ObjectType* soap_new_ns5__ObjectType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__ObjectType::soap_type() returns SOAP_TYPE_ns5__ObjectType or derived type identifier
class ns5__ObjectType
{ public:
...
/// Union for choice in ns5__ObjectType.
    ...
    {
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"QualifyingProperties.
    ns6__QualifyingPropertiesType*       ns6__QualifyingProperties     ;	///< Choice of optional element (one of multiple choices).
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"SVGList.
    ns7__SVGListType*                    ns7__SVGList                  ;	///< Choice of optional element (one of multiple choices).
/// Element reference "http://www.w3.org/2000/09/xmldsig#:"Attribute.
    ns3__AttributeType*                  ns3__Attribute                ;	///< Choice of optional element (one of multiple choices).
    }                                    union_ObjectType              ;
//  END OF CHOICE
/// Attribute "Id" of type xs:ID.
  @ xsd__ID                              Id                             1;	///< Required attribute.
...
///
/// @note class ns3__AttributeType operations:
/// - ns3__AttributeType* soap_new_ns3__AttributeType(soap*) allocate and default initialize
/// - ns3__AttributeType* soap_new_ns3__AttributeType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__AttributeType::soap_type() returns SOAP_TYPE_ns3__AttributeType or derived type identifier
class ns3__AttributeType
{ public:
/// Element "AttributeSupplier" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":AttributeSupplierType.
    ns3__AttributeSupplierType*          AttributeSupplier              1;	///< Required element.
/// Element "Date" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":DateType.
    ns4__DateType                        Date                           1;	///< Required element.
/// Element "Validity" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ValidityType.
    ns4__ValidityType                    Validity                       1;	///< Required element.
/// Element "PersonalData" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":PersonalDataType.
    ns3__PersonalDataType*               PersonalData                   1;	///< Required element.
/// Element "MainAttribute" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":MainAttributeType.
...
///
/// @note class ns3__AttributeSupplierType operations:
/// - ns3__AttributeSupplierType* soap_new_ns3__AttributeSupplierType(soap*) allocate and default initialize
/// - ns3__AttributeSupplierType* soap_new_ns3__AttributeSupplierType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__AttributeSupplierType::soap_type() returns SOAP_TYPE_ns3__AttributeSupplierType or derived type identifier
class ns3__AttributeSupplierType
{ public:
/// Element "Id" of type xs:anyURI.
    xsd__anyURI                          Id                             1;	///< Required element.
/// Element "Name" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NameType.
    ns4__NameType                        Name                           1;	///< Required element.
/// @note The enum values are prefixed with "_ns3__AttributeSupplierType_Type__" to prevent name clashes: use wsdl2h option -e to omit this prefix or use option -c++11 for scoped enumerations
    enum _ns3__AttributeSupplierType_Type
    {
	_ns3__AttributeSupplierType_Type__INSTITUTION,	///< xs:string value="INSTITUTION"
	_ns3__AttributeSupplierType_Type__ENTERPRISE,	///< xs:string value="ENTERPRISE"
    }
                                        *Type                           0;	///< Optional element.
/// Element "Watermark" of type xs:string.
    std::string*                         Watermark                      0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns3__PersonalDataType operations:
/// - ns3__PersonalDataType* soap_new_ns3__PersonalDataType(soap*) allocate and default initialize
/// - ns3__PersonalDataType* soap_new_ns3__PersonalDataType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__PersonalDataType::soap_type() returns SOAP_TYPE_ns3__PersonalDataType or derived type identifier
class ns3__PersonalDataType
{ public:
/// Element "Name" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NameType.
    ns4__NameType                        Name                           1;	///< Required element.
/// Element "NIC" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NICType.
    ns4__NICType                         NIC                            1;	///< Required element.
/// Element "ExtraIDList" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":ExtraIDListType.
...
///
/// @note class ns3__ExtraIDListType operations:
/// - ns3__ExtraIDListType* soap_new_ns3__ExtraIDListType(soap*) allocate and default initialize
/// - ns3__ExtraIDListType* soap_new_ns3__ExtraIDListType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__ExtraIDListType::soap_type() returns SOAP_TYPE_ns3__ExtraIDListType or derived type identifier
class ns3__ExtraIDListType
{ public:
/// Vector of ns3__ExtraIDType* of length 1..unbounded.
    std::vector<ns3__ExtraIDType*      > ExtraID                        1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns3__ExtraIDType operations:
/// - ns3__ExtraIDType* soap_new_ns3__ExtraIDType(soap*) allocate and default initialize
/// - ns3__ExtraIDType* soap_new_ns3__ExtraIDType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__ExtraIDType::soap_type() returns SOAP_TYPE_ns3__ExtraIDType or derived type identifier
class ns3__ExtraIDType
{ public:
/// Element "Name" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":NameType.
    ns4__NameType                        Name                           1;	///< Required element.
/// Element "Value" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":ExtraIDValueType.
...
///
/// @note class ns3__MainAttributeType operations:
/// - ns3__MainAttributeType* soap_new_ns3__MainAttributeType(soap*) allocate and default initialize
/// - ns3__MainAttributeType* soap_new_ns3__MainAttributeType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__MainAttributeType::soap_type() returns SOAP_TYPE_ns3__MainAttributeType or derived type identifier
class ns3__MainAttributeType
{ public:
/// Element "AttributeID" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":AttributeIDType.
    ns4__AttributeIDType                 AttributeID                    1;	///< Required element.
/// Element "Description" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":DescriptionType.
    ns4__DescriptionType*                Description                    0;	///< Optional element.
/// Element "LegalActList" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":LegalActListType.
    ns3__LegalActListType*               LegalActList                   0;	///< Optional element.
/// Element "SubAttributeList" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":SubAttributeListType.
...
///
/// @note class ns3__LegalActListType operations:
/// - ns3__LegalActListType* soap_new_ns3__LegalActListType(soap*) allocate and default initialize
/// - ns3__LegalActListType* soap_new_ns3__LegalActListType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__LegalActListType::soap_type() returns SOAP_TYPE_ns3__LegalActListType or derived type identifier
class ns3__LegalActListType
{ public:
/// Vector of ns4__LegalActType of length 1..unbounded.
    std::vector<ns4__LegalActType      > LegalAct                       1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns3__SubAttributeListType operations:
/// - ns3__SubAttributeListType* soap_new_ns3__SubAttributeListType(soap*) allocate and default initialize
/// - ns3__SubAttributeListType* soap_new_ns3__SubAttributeListType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__SubAttributeListType::soap_type() returns SOAP_TYPE_ns3__SubAttributeListType or derived type identifier
class ns3__SubAttributeListType
{ public:
/// Vector of ns3__SubAttributeType* of length 1..unbounded.
    std::vector<ns3__SubAttributeType* > SubAttribute                   1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns3__SubAttributeType operations:
/// - ns3__SubAttributeType* soap_new_ns3__SubAttributeType(soap*) allocate and default initialize
/// - ns3__SubAttributeType* soap_new_ns3__SubAttributeType(soap*, int num) allocate and default initialize an array
...
/// - int ns3__SubAttributeType::soap_type() returns SOAP_TYPE_ns3__SubAttributeType or derived type identifier
class ns3__SubAttributeType
{ public:
/// Element "AttributeID" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":AttributeIDType.
    ns4__AttributeIDType                 AttributeID                    1;	///< Required element.
/// Element "Description" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":DescriptionType.
    ns4__DescriptionType*                Description                    0;	///< Optional element.
/// Element "Value" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Types":SubAttributeValueType.
    ns4__SubAttributeValueType*          Value                          0;	///< Optional element.
/// Element "LegalActList" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":LegalActListType.
    ns3__LegalActListType*               LegalActList                   0;	///< Optional element.
/// Element "OperationCode" of type "http://www.cartaodecidadao.pt/ccc/commons/messages/TypesAttributeManagment":CrudCodeType.
    enum ns11__CrudCodeType*             OperationCode                  0;	///< Optional element.
...
///
/// @note class ns6__QualifyingPropertiesType operations:
/// - ns6__QualifyingPropertiesType* soap_new_ns6__QualifyingPropertiesType(soap*) allocate and default initialize
/// - ns6__QualifyingPropertiesType* soap_new_ns6__QualifyingPropertiesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__QualifyingPropertiesType::soap_type() returns SOAP_TYPE_ns6__QualifyingPropertiesType or derived type identifier
class ns6__QualifyingPropertiesType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SignedProperties.
    ns6__SignedPropertiesType*           ns6__SignedProperties          1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"UnsignedProperties.
    ns6__UnsignedPropertiesType*         ns6__UnsignedProperties        0;	///< Optional element.
/// Attribute "Target" of type xs:anyURI.
...
///
/// @note class ns6__SignedPropertiesType operations:
/// - ns6__SignedPropertiesType* soap_new_ns6__SignedPropertiesType(soap*) allocate and default initialize
/// - ns6__SignedPropertiesType* soap_new_ns6__SignedPropertiesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__SignedPropertiesType::soap_type() returns SOAP_TYPE_ns6__SignedPropertiesType or derived type identifier
class ns6__SignedPropertiesType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SignedSignatureProperties.
...
///
/// @note class ns6__SignedSignaturePropertiesType operations:
/// - ns6__SignedSignaturePropertiesType* soap_new_ns6__SignedSignaturePropertiesType(soap*) allocate and default initialize
/// - ns6__SignedSignaturePropertiesType* soap_new_ns6__SignedSignaturePropertiesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__SignedSignaturePropertiesType::soap_type() returns SOAP_TYPE_ns6__SignedSignaturePropertiesType or derived type identifier
class ns6__SignedSignaturePropertiesType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SigningTime.
    ns6__SigningTimeType                 ns6__SigningTime               1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SigningCertificate.
    ns6__SigningCertificateType*         ns6__SigningCertificate        1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SignerRole.
...
///
/// @note class ns6__SigningCertificateType operations:
/// - ns6__SigningCertificateType* soap_new_ns6__SigningCertificateType(soap*) allocate and default initialize
/// - ns6__SigningCertificateType* soap_new_ns6__SigningCertificateType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__SigningCertificateType::soap_type() returns SOAP_TYPE_ns6__SigningCertificateType or derived type identifier
class ns6__SigningCertificateType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"Cert.
...
///
/// @note class ns6__CertType operations:
/// - ns6__CertType* soap_new_ns6__CertType(soap*) allocate and default initialize
/// - ns6__CertType* soap_new_ns6__CertType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CertType::soap_type() returns SOAP_TYPE_ns6__CertType or derived type identifier
class ns6__CertType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CertDigest.
    ns6__CertDigestType*                 ns6__CertDigest                1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"IssuerSerial.
...
///
/// @note class ns6__CertDigestType operations:
/// - ns6__CertDigestType* soap_new_ns6__CertDigestType(soap*) allocate and default initialize
/// - ns6__CertDigestType* soap_new_ns6__CertDigestType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CertDigestType::soap_type() returns SOAP_TYPE_ns6__CertDigestType or derived type identifier
class ns6__CertDigestType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"DigestMethod.
    ns5__DigestMethodType*               ns5__DigestMethod              1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"DigestValue.
    ns5__DigestValueType*                ns5__DigestValue               1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns6__IssuerSerialType operations:
/// - ns6__IssuerSerialType* soap_new_ns6__IssuerSerialType(soap*) allocate and default initialize
/// - ns6__IssuerSerialType* soap_new_ns6__IssuerSerialType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__IssuerSerialType::soap_type() returns SOAP_TYPE_ns6__IssuerSerialType or derived type identifier
class ns6__IssuerSerialType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"X509IssuerName.
    ns5__X509IssuerNameType              ns5__X509IssuerName            1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"X509SerialNumber.
...
///
/// @note class ns6__SignerRoleType operations:
/// - ns6__SignerRoleType* soap_new_ns6__SignerRoleType(soap*) allocate and default initialize
/// - ns6__SignerRoleType* soap_new_ns6__SignerRoleType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__SignerRoleType::soap_type() returns SOAP_TYPE_ns6__SignerRoleType or derived type identifier
class ns6__SignerRoleType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"ClaimedRoles.
...
///
/// @note class ns6__ClaimedRolesListType operations:
/// - ns6__ClaimedRolesListType* soap_new_ns6__ClaimedRolesListType(soap*) allocate and default initialize
/// - ns6__ClaimedRolesListType* soap_new_ns6__ClaimedRolesListType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__ClaimedRolesListType::soap_type() returns SOAP_TYPE_ns6__ClaimedRolesListType or derived type identifier
class ns6__ClaimedRolesListType
{ public:
/// Vector of ns6__ClaimedRoleType* element refs of length 1..unbounded.
    std::vector<ns6__ClaimedRoleType*  > ns6__ClaimedRole               1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns6__ClaimedRoleType operations:
/// - ns6__ClaimedRoleType* soap_new_ns6__ClaimedRoleType(soap*) allocate and default initialize
/// - ns6__ClaimedRoleType* soap_new_ns6__ClaimedRoleType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__ClaimedRoleType::soap_type() returns SOAP_TYPE_ns6__ClaimedRoleType or derived type identifier
class ns6__ClaimedRoleType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SignatureAttribute.
...
///
/// @note class ns6__UnsignedPropertiesType operations:
/// - ns6__UnsignedPropertiesType* soap_new_ns6__UnsignedPropertiesType(soap*) allocate and default initialize
/// - ns6__UnsignedPropertiesType* soap_new_ns6__UnsignedPropertiesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__UnsignedPropertiesType::soap_type() returns SOAP_TYPE_ns6__UnsignedPropertiesType or derived type identifier
class ns6__UnsignedPropertiesType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"UnsignedSignatureProperties.
...
///
/// @note class ns6__UnsignedSignaturePropertiesType operations:
/// - ns6__UnsignedSignaturePropertiesType* soap_new_ns6__UnsignedSignaturePropertiesType(soap*) allocate and default initialize
/// - ns6__UnsignedSignaturePropertiesType* soap_new_ns6__UnsignedSignaturePropertiesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__UnsignedSignaturePropertiesType::soap_type() returns SOAP_TYPE_ns6__UnsignedSignaturePropertiesType or derived type identifier
class ns6__UnsignedSignaturePropertiesType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CounterSignature.
    ns6__CounterSignatureType*           ns6__CounterSignature          0;	///< Optional element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SignatureTimeStamp.
    ns6__SignatureTimeStampType*         ns6__SignatureTimeStamp        1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CompleteCertificateRefs.
    ns6__CompleteCertificateRefsType*    ns6__CompleteCertificateRefs   1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CompleteRevocationRefs.
    ns6__CompleteRevocationRefsType*     ns6__CompleteRevocationRefs    1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"SigAndRefsTimeStamp.
    ns6__SigAndRefsTimeStampType*        ns6__SigAndRefsTimeStamp       1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CertificateValues.
    ns6__CertificateValuesType*          ns6__CertificateValues         1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"RevocationValues.
    ns6__RevocationValuesType*           ns6__RevocationValues          1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"ArchiveTimeStamp.
...
///
/// @note class ns6__CounterSignatureType operations:
/// - ns6__CounterSignatureType* soap_new_ns6__CounterSignatureType(soap*) allocate and default initialize
/// - ns6__CounterSignatureType* soap_new_ns6__CounterSignatureType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CounterSignatureType::soap_type() returns SOAP_TYPE_ns6__CounterSignatureType or derived type identifier
class ns6__CounterSignatureType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"Signature.
...
///
/// @note class ns6__SignatureTimeStampType operations:
/// - ns6__SignatureTimeStampType* soap_new_ns6__SignatureTimeStampType(soap*) allocate and default initialize
/// - ns6__SignatureTimeStampType* soap_new_ns6__SignatureTimeStampType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__SignatureTimeStampType::soap_type() returns SOAP_TYPE_ns6__SignatureTimeStampType or derived type identifier
class ns6__SignatureTimeStampType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CanonicalizationMethod.
    ns5__CanonicalizationMethodType*     ns5__CanonicalizationMethod    1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"EncapsulatedTimeStamp.
...
///
/// @note class ns6__CompleteCertificateRefsType operations:
/// - ns6__CompleteCertificateRefsType* soap_new_ns6__CompleteCertificateRefsType(soap*) allocate and default initialize
/// - ns6__CompleteCertificateRefsType* soap_new_ns6__CompleteCertificateRefsType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CompleteCertificateRefsType::soap_type() returns SOAP_TYPE_ns6__CompleteCertificateRefsType or derived type identifier
class ns6__CompleteCertificateRefsType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CertRefs.
...
///
/// @note class ns6__CertRefsType operations:
/// - ns6__CertRefsType* soap_new_ns6__CertRefsType(soap*) allocate and default initialize
/// - ns6__CertRefsType* soap_new_ns6__CertRefsType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CertRefsType::soap_type() returns SOAP_TYPE_ns6__CertRefsType or derived type identifier
class ns6__CertRefsType
{ public:
/// Vector of ns6__CertType* element refs of length 1..unbounded.
    std::vector<ns6__CertType*         > ns6__Cert                      1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns6__CompleteRevocationRefsType operations:
/// - ns6__CompleteRevocationRefsType* soap_new_ns6__CompleteRevocationRefsType(soap*) allocate and default initialize
/// - ns6__CompleteRevocationRefsType* soap_new_ns6__CompleteRevocationRefsType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CompleteRevocationRefsType::soap_type() returns SOAP_TYPE_ns6__CompleteRevocationRefsType or derived type identifier
class ns6__CompleteRevocationRefsType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CRLRefs.
    ns6__CRLRefsType*                    ns6__CRLRefs                   1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"OCSPRefs.
...
///
/// @note class ns6__CRLRefsType operations:
/// - ns6__CRLRefsType* soap_new_ns6__CRLRefsType(soap*) allocate and default initialize
/// - ns6__CRLRefsType* soap_new_ns6__CRLRefsType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CRLRefsType::soap_type() returns SOAP_TYPE_ns6__CRLRefsType or derived type identifier
class ns6__CRLRefsType
{ public:
/// Vector of ns6__CRLRefType* element refs of length 1..unbounded.
    std::vector<ns6__CRLRefType*       > ns6__CRLRef                    1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns6__CRLRefType operations:
/// - ns6__CRLRefType* soap_new_ns6__CRLRefType(soap*) allocate and default initialize
/// - ns6__CRLRefType* soap_new_ns6__CRLRefType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CRLRefType::soap_type() returns SOAP_TYPE_ns6__CRLRefType or derived type identifier
class ns6__CRLRefType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"DigestAlgAndValue.
    ns6__DigestAlgAndValueType*          ns6__DigestAlgAndValue         1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CRLIdentifier.
...
///
/// @note class ns6__DigestAlgAndValueType operations:
/// - ns6__DigestAlgAndValueType* soap_new_ns6__DigestAlgAndValueType(soap*) allocate and default initialize
/// - ns6__DigestAlgAndValueType* soap_new_ns6__DigestAlgAndValueType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__DigestAlgAndValueType::soap_type() returns SOAP_TYPE_ns6__DigestAlgAndValueType or derived type identifier
class ns6__DigestAlgAndValueType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"DigestMethod.
    ns5__DigestMethodType*               ns5__DigestMethod              1;	///< Required element.
...
///
/// @note class ns6__CRLIdentifierType operations:
/// - ns6__CRLIdentifierType* soap_new_ns6__CRLIdentifierType(soap*) allocate and default initialize
/// - ns6__CRLIdentifierType* soap_new_ns6__CRLIdentifierType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CRLIdentifierType::soap_type() returns SOAP_TYPE_ns6__CRLIdentifierType or derived type identifier
class ns6__CRLIdentifierType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"Issuer.
    _XML                                 ns6__Issuer                    1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"IssueTime.
    _XML                                 ns6__IssueTime                 1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"Number.
...
///
/// @note class ns6__OCSPRefsType operations:
/// - ns6__OCSPRefsType* soap_new_ns6__OCSPRefsType(soap*) allocate and default initialize
/// - ns6__OCSPRefsType* soap_new_ns6__OCSPRefsType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__OCSPRefsType::soap_type() returns SOAP_TYPE_ns6__OCSPRefsType or derived type identifier
class ns6__OCSPRefsType
{ public:
/// Vector of ns6__OCSPRefType* element refs of length 1..unbounded.
    std::vector<ns6__OCSPRefType*      > ns6__OCSPRef                   1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns6__OCSPRefType operations:
/// - ns6__OCSPRefType* soap_new_ns6__OCSPRefType(soap*) allocate and default initialize
/// - ns6__OCSPRefType* soap_new_ns6__OCSPRefType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__OCSPRefType::soap_type() returns SOAP_TYPE_ns6__OCSPRefType or derived type identifier
class ns6__OCSPRefType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"OCSPIdentifier.
...
///
/// @note class ns6__OCSPIdentifierType operations:
/// - ns6__OCSPIdentifierType* soap_new_ns6__OCSPIdentifierType(soap*) allocate and default initialize
/// - ns6__OCSPIdentifierType* soap_new_ns6__OCSPIdentifierType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__OCSPIdentifierType::soap_type() returns SOAP_TYPE_ns6__OCSPIdentifierType or derived type identifier
class ns6__OCSPIdentifierType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"ResponderID.
    ns6__ResponderIDType*                ns6__ResponderID               1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"ProducedAt.
...
///
/// @note class ns6__ResponderIDType operations:
/// - ns6__ResponderIDType* soap_new_ns6__ResponderIDType(soap*) allocate and default initialize
/// - ns6__ResponderIDType* soap_new_ns6__ResponderIDType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__ResponderIDType::soap_type() returns SOAP_TYPE_ns6__ResponderIDType or derived type identifier
class ns6__ResponderIDType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"ByName.
...
///
/// @note class ns6__SigAndRefsTimeStampType operations:
/// - ns6__SigAndRefsTimeStampType* soap_new_ns6__SigAndRefsTimeStampType(soap*) allocate and default initialize
/// - ns6__SigAndRefsTimeStampType* soap_new_ns6__SigAndRefsTimeStampType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__SigAndRefsTimeStampType::soap_type() returns SOAP_TYPE_ns6__SigAndRefsTimeStampType or derived type identifier
class ns6__SigAndRefsTimeStampType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CanonicalizationMethod.
    ns5__CanonicalizationMethodType*     ns5__CanonicalizationMethod    1;	///< Required element.
...
///
/// @note class ns6__CertificateValuesType operations:
/// - ns6__CertificateValuesType* soap_new_ns6__CertificateValuesType(soap*) allocate and default initialize
/// - ns6__CertificateValuesType* soap_new_ns6__CertificateValuesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CertificateValuesType::soap_type() returns SOAP_TYPE_ns6__CertificateValuesType or derived type identifier
class ns6__CertificateValuesType
{ public:
/// Vector of ns6__EncapsulatedX509CertificateType* element refs of length 1..unbounded.
    std::vector<ns6__EncapsulatedX509CertificateType*> ns6__EncapsulatedX509Certificate 1;	///< Multiple elements.
/// Attribute "Id" of type xs:ID.
  @ xsd__ID                              Id                             1;	///< Required attribute.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
...
///
/// @note class ns6__RevocationValuesType operations:
/// - ns6__RevocationValuesType* soap_new_ns6__RevocationValuesType(soap*) allocate and default initialize
/// - ns6__RevocationValuesType* soap_new_ns6__RevocationValuesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__RevocationValuesType::soap_type() returns SOAP_TYPE_ns6__RevocationValuesType or derived type identifier
class ns6__RevocationValuesType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CRLValues.
    ns6__CRLValuesType*                  ns6__CRLValues                 1;	///< Required element.
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"OCSPValues.
...
///
/// @note class ns6__CRLValuesType operations:
/// - ns6__CRLValuesType* soap_new_ns6__CRLValuesType(soap*) allocate and default initialize
/// - ns6__CRLValuesType* soap_new_ns6__CRLValuesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__CRLValuesType::soap_type() returns SOAP_TYPE_ns6__CRLValuesType or derived type identifier
class ns6__CRLValuesType
{ public:
/// Vector of ns6__EncapsulatedCRLValueType* element refs of length 1..unbounded.
    std::vector<ns6__EncapsulatedCRLValueType*> ns6__EncapsulatedCRLValue      1;	///< Multiple elements.
/// Attribute "Id" of type xs:ID.
  @ xsd__ID                              Id                             1;	///< Required attribute.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
...
///
/// @note class ns6__OCSPValuesType operations:
/// - ns6__OCSPValuesType* soap_new_ns6__OCSPValuesType(soap*) allocate and default initialize
/// - ns6__OCSPValuesType* soap_new_ns6__OCSPValuesType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__OCSPValuesType::soap_type() returns SOAP_TYPE_ns6__OCSPValuesType or derived type identifier
class ns6__OCSPValuesType
{ public:
/// Vector of ns6__EncapsulatedOCSPValueType* element refs of length 1..unbounded.
    std::vector<ns6__EncapsulatedOCSPValueType*> ns6__EncapsulatedOCSPValue     1;	///< Multiple elements.
/// Attribute "Id" of type xs:ID.
  @ xsd__ID                              Id                             1;	///< Required attribute.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
...
///
/// @note class ns6__ArchiveTimeStampType operations:
/// - ns6__ArchiveTimeStampType* soap_new_ns6__ArchiveTimeStampType(soap*) allocate and default initialize
/// - ns6__ArchiveTimeStampType* soap_new_ns6__ArchiveTimeStampType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__ArchiveTimeStampType::soap_type() returns SOAP_TYPE_ns6__ArchiveTimeStampType or derived type identifier
class ns6__ArchiveTimeStampType
{ public:
/// Element reference "http://uri.etsi.org/01903/v1.3.2#:"CanonicalizationMethod.
    ns5__CanonicalizationMethodType*     ns5__CanonicalizationMethod    1;	///< Required element.
...
///
/// @note class ns7__SVGListType operations:
/// - ns7__SVGListType* soap_new_ns7__SVGListType(soap*) allocate and default initialize
/// - ns7__SVGListType* soap_new_ns7__SVGListType(soap*, int num) allocate and default initialize an array
...
/// - int ns7__SVGListType::soap_type() returns SOAP_TYPE_ns7__SVGListType or derived type identifier
class ns7__SVGListType
{ public:
/// Vector of ns7__SVGType element refs of length 1..unbounded.
    std::vector<ns7__SVGType           > ns7__SVG                       1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
/// @brief "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeSupplierService":AttributeSupplierRequestType is a complexType.
///
/// @note class ns9__AttributeSupplierRequestType operations:
/// - ns9__AttributeSupplierRequestType* soap_new_ns9__AttributeSupplierRequestType(soap*) allocate and default initialize
/// - ns9__AttributeSupplierRequestType* soap_new_ns9__AttributeSupplierRequestType(soap*, int num) allocate and default initialize an array
/// - ns9__AttributeSupplierRequestType* soap_new_req_ns9__AttributeSupplierRequestType(soap*, ...) allocate, set required members
/// - ns9__AttributeSupplierRequestType* soap_new_set_ns9__AttributeSupplierRequestType(soap*, ...) allocate, set all public members
/// - ns9__AttributeSupplierRequestType::soap_default(soap*) default initialize members
/// - int soap_read_ns9__AttributeSupplierRequestType(soap*, ns9__AttributeSupplierRequestType*) deserialize from a stream
/// - int soap_write_ns9__AttributeSupplierRequestType(soap*, ns9__AttributeSupplierRequestType*) serialize to a stream
/// - ns9__AttributeSupplierRequestType* ns9__AttributeSupplierRequestType::soap_dup(soap*) returns deep copy of ns9__AttributeSupplierRequestType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - ns9__AttributeSupplierRequestType::soap_del() deep deletes ns9__AttributeSupplierRequestType data members, use only after ns9__AttributeSupplierRequestType::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int ns9__AttributeSupplierRequestType::soap_type() returns SOAP_TYPE_ns9__AttributeSupplierRequestType or derived type identifier
class ns9__AttributeSupplierRequestType
{ public:
/// Element "hiddenEnterprises" of type xs:boolean.
    bool*                                hiddenEnterprises              0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns9__AttributeSupplierResponseType operations:
/// - ns9__AttributeSupplierResponseType* soap_new_ns9__AttributeSupplierResponseType(soap*) allocate and default initialize
/// - ns9__AttributeSupplierResponseType* soap_new_ns9__AttributeSupplierResponseType(soap*, int num) allocate and default initialize an array
...
/// - int ns9__AttributeSupplierResponseType::soap_type() returns SOAP_TYPE_ns9__AttributeSupplierResponseType or derived type identifier
class ns9__AttributeSupplierResponseType
{ public:
/// Vector of ns3__AttributeSupplierType* of length 0..unbounded.
    std::vector<ns3__AttributeSupplierType*> AttributeSupplier              0;	///< Multiple elements.
/// Element "ErrorMessage" of type xs:string.
    std::string*                         ErrorMessage                   0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
...
///
/// @note class ns1__PersonalData operations:
/// - ns1__PersonalData* soap_new_ns1__PersonalData(soap*) allocate and default initialize
/// - ns1__PersonalData* soap_new_ns1__PersonalData(soap*, int num) allocate and default initialize an array
...
/// - int ns1__PersonalData::soap_type() returns SOAP_TYPE_ns1__PersonalData or derived type identifier
class ns1__PersonalData
{ public:
/// Element "Name" of type xs:string.
    std::string                          Name                           1;	///< Required element.
/// Element "NIC" of type xs:string.
...
///
/// @note class ns1__AttributeListType operations:
/// - ns1__AttributeListType* soap_new_ns1__AttributeListType(soap*) allocate and default initialize
/// - ns1__AttributeListType* soap_new_ns1__AttributeListType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__AttributeListType::soap_type() returns SOAP_TYPE_ns1__AttributeListType or derived type identifier
class ns1__AttributeListType
{ public:
/// Vector of ns1__AttributeType* of length 1..unbounded.
    std::vector<ns1__AttributeType*    > Attribute                      1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns1__AttributeType operations:
/// - ns1__AttributeType* soap_new_ns1__AttributeType(soap*) allocate and default initialize
/// - ns1__AttributeType* soap_new_ns1__AttributeType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__AttributeType::soap_type() returns SOAP_TYPE_ns1__AttributeType or derived type identifier
class ns1__AttributeType
{ public:
/// Element "AttributeSupplier" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":AttributeSupplierType.
    ns1__AttributeSupplierType*          AttributeSupplier              1;	///< Required element.
/// Element "MainAttribute" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":MainAttributeType.
...
///
/// @note class ns1__AttributeSupplierType operations:
/// - ns1__AttributeSupplierType* soap_new_ns1__AttributeSupplierType(soap*) allocate and default initialize
/// - ns1__AttributeSupplierType* soap_new_ns1__AttributeSupplierType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__AttributeSupplierType::soap_type() returns SOAP_TYPE_ns1__AttributeSupplierType or derived type identifier
class ns1__AttributeSupplierType
{ public:
...
///
/// @note class ns1__MainAttributeType operations:
/// - ns1__MainAttributeType* soap_new_ns1__MainAttributeType(soap*) allocate and default initialize
/// - ns1__MainAttributeType* soap_new_ns1__MainAttributeType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__MainAttributeType::soap_type() returns SOAP_TYPE_ns1__MainAttributeType or derived type identifier
class ns1__MainAttributeType
{ public:
/// Element "AttributeID" of type xs:string.
    std::string                          AttributeID                    1;	///< Required element.
/// Element "Description" of type xs:string.
    std::string*                         Description                    0;	///< Optional element.
/// Element "LegalActList" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":LegalActListType.
    ns1__LegalActListType*               LegalActList                   0;	///< Optional element.
/// Element "SubAttributeList" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":SubAttributeListType.
    ns1__SubAttributeListType*           SubAttributeList               1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns1__LegalActListType operations:
/// - ns1__LegalActListType* soap_new_ns1__LegalActListType(soap*) allocate and default initialize
/// - ns1__LegalActListType* soap_new_ns1__LegalActListType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__LegalActListType::soap_type() returns SOAP_TYPE_ns1__LegalActListType or derived type identifier
class ns1__LegalActListType
{ public:
/// Vector of std::string of length 1..unbounded.
    std::vector<std::string            > LegalAct                       1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns1__SubAttributeListType operations:
/// - ns1__SubAttributeListType* soap_new_ns1__SubAttributeListType(soap*) allocate and default initialize
/// - ns1__SubAttributeListType* soap_new_ns1__SubAttributeListType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__SubAttributeListType::soap_type() returns SOAP_TYPE_ns1__SubAttributeListType or derived type identifier
class ns1__SubAttributeListType
{ public:
/// Vector of ns1__SubAttributeType* of length 1..unbounded.
    std::vector<ns1__SubAttributeType* > SubAttribute                   1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns1__SubAttributeType operations:
/// - ns1__SubAttributeType* soap_new_ns1__SubAttributeType(soap*) allocate and default initialize
/// - ns1__SubAttributeType* soap_new_ns1__SubAttributeType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__SubAttributeType::soap_type() returns SOAP_TYPE_ns1__SubAttributeType or derived type identifier
class ns1__SubAttributeType
{ public:
/// Element "AttributeID" of type xs:string.
    std::string                          AttributeID                    1;	///< Required element.
...
///
/// @note class ns1__Status operations:
/// - ns1__Status* soap_new_ns1__Status(soap*) allocate and default initialize
/// - ns1__Status* soap_new_ns1__Status(soap*, int num) allocate and default initialize an array
...
/// - int ns1__Status::soap_type() returns SOAP_TYPE_ns1__Status or derived type identifier
class ns1__Status
{ public:
...
///
/// @note class ns1__TransactionTypeList operations:
/// - ns1__TransactionTypeList* soap_new_ns1__TransactionTypeList(soap*) allocate and default initialize
/// - ns1__TransactionTypeList* soap_new_ns1__TransactionTypeList(soap*, int num) allocate and default initialize an array
...
/// - int ns1__TransactionTypeList::soap_type() returns SOAP_TYPE_ns1__TransactionTypeList or derived type identifier
class ns1__TransactionTypeList
{ public:
/// Vector of ns1__TransactionType* of length 1..unbounded.
    std::vector<ns1__TransactionType*  > Transaction                    1;	///< Multiple elements.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
///
/// @note class ns1__TransactionType operations:
/// - ns1__TransactionType* soap_new_ns1__TransactionType(soap*) allocate and default initialize
/// - ns1__TransactionType* soap_new_ns1__TransactionType(soap*, int num) allocate and default initialize an array
...
/// - int ns1__TransactionType::soap_type() returns SOAP_TYPE_ns1__TransactionType or derived type identifier
class ns1__TransactionType
{ public:
...
/// Element "AttributeSupplierCertificateChain" of type xs:string.
...
///
/// @note class _ns1__AuthorizationRequest operations:
/// - _ns1__AuthorizationRequest* soap_new__ns1__AuthorizationRequest(soap*) allocate and default initialize
/// - _ns1__AuthorizationRequest* soap_new__ns1__AuthorizationRequest(soap*, int num) allocate and default initialize an array
...
/// - int _ns1__AuthorizationRequest::soap_type() returns SOAP_TYPE__ns1__AuthorizationRequest or derived type identifier
class _ns1__AuthorizationRequest
{ public:
/// Element "AppId" of type xs:string.
    std::string                          AppId                          1;	///< Required element.
/// Element "TOTP" of type xs:string.
    std::string                          TOTP                           1;	///< Required element.
/// Element "DocumentSignature" of type xs:base64Binary.
    xsd__base64Binary                    DocumentSignature              1;	///< Required element.
/// Element "DocumentHash" of type xs:base64Binary.
    xsd__base64Binary                    DocumentHash                   1;	///< Required element.
/// Element "SignatureCertificate" of type xs:string.
    std::string                          SignatureCertificate           1;	///< Required element.
/// Element "PersonalData" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":PersonalData.
    ns1__PersonalData*                   PersonalData                   1;	///< Required element.
/// Element "AttributeList" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":AttributeListType.
...
///
/// @note class _ns1__AuthorizationResponse operations:
/// - _ns1__AuthorizationResponse* soap_new__ns1__AuthorizationResponse(soap*) allocate and default initialize
/// - _ns1__AuthorizationResponse* soap_new__ns1__AuthorizationResponse(soap*, int num) allocate and default initialize an array
...
/// - int _ns1__AuthorizationResponse::soap_type() returns SOAP_TYPE__ns1__AuthorizationResponse or derived type identifier
class _ns1__AuthorizationResponse
{ public:
/// Element "Status" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":Status.
    ns1__Status*                         Status                         1;	///< Required element.
/// Element "ProcessId" of type xs:string.
    std::string*                         ProcessId                      0;	///< Optional element.
/// Element "TransactionList" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":TransactionTypeList.
...
///
/// @note class _ns1__SignatureRequest operations:
/// - _ns1__SignatureRequest* soap_new__ns1__SignatureRequest(soap*) allocate and default initialize
/// - _ns1__SignatureRequest* soap_new__ns1__SignatureRequest(soap*, int num) allocate and default initialize an array
...
/// - int _ns1__SignatureRequest::soap_type() returns SOAP_TYPE__ns1__SignatureRequest or derived type identifier
class _ns1__SignatureRequest
{ public:
/// Element "AppId" of type xs:string.
    std::string                          AppId                          1;	///< Required element.
...
/// Element "Transaction" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":TransactionType.
...
///
/// @note class _ns1__SignatureResponse operations:
/// - _ns1__SignatureResponse* soap_new__ns1__SignatureResponse(soap*) allocate and default initialize
/// - _ns1__SignatureResponse* soap_new__ns1__SignatureResponse(soap*, int num) allocate and default initialize an array
...
/// - int _ns1__SignatureResponse::soap_type() returns SOAP_TYPE__ns1__SignatureResponse or derived type identifier
class _ns1__SignatureResponse
{ public:
/// Element "Status" of type "http://www.cartaodecidadao.pt/ccc/tipos/SCAPSignature":Status.
    ns1__Status*                         Status                         1;	///< Required element.
...
/// @brief "http://www.w3.org/2000/09/xmldsig#":X509CertificateType is a complexType with simpleContent extension of type xs:base64Binary.
///
/// @note class ns5__X509CertificateType operations:
/// - ns5__X509CertificateType* soap_new_ns5__X509CertificateType(soap*) allocate and default initialize
/// - ns5__X509CertificateType* soap_new_ns5__X509CertificateType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__X509CertificateType::soap_type() returns SOAP_TYPE_ns5__X509CertificateType or derived type identifier
class ns5__X509CertificateType
{ public:
/// __item wraps simpleContent of type xs:base64Binary.
...
/// @brief "http://www.w3.org/2000/09/xmldsig#":DigestValueType is a complexType with simpleContent extension of type xs:base64Binary.
///
/// @note class ns5__DigestValueType operations:
/// - ns5__DigestValueType* soap_new_ns5__DigestValueType(soap*) allocate and default initialize
/// - ns5__DigestValueType* soap_new_ns5__DigestValueType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__DigestValueType::soap_type() returns SOAP_TYPE_ns5__DigestValueType or derived type identifier
class ns5__DigestValueType
{ public:
/// __item wraps simpleContent of type xs:base64Binary.
    xsd__base64Binary                    __item                        ;
...
/// @brief "http://www.w3.org/2000/09/xmldsig#":SignatureValueType is a complexType with simpleContent extension of type xs:base64Binary.
///
/// @note class ns5__SignatureValueType operations:
/// - ns5__SignatureValueType* soap_new_ns5__SignatureValueType(soap*) allocate and default initialize
/// - ns5__SignatureValueType* soap_new_ns5__SignatureValueType(soap*, int num) allocate and default initialize an array
...
/// - int ns5__SignatureValueType::soap_type() returns SOAP_TYPE_ns5__SignatureValueType or derived type identifier
class ns5__SignatureValueType
{ public:
/// __item wraps simpleContent of type xs:base64Binary.
    xsd__base64Binary                    __item                        ;
...
/// @brief "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedX509CertificateType is a complexType with simpleContent extension of type xs:base64Binary.
///
/// @note class ns6__EncapsulatedX509CertificateType operations:
/// - ns6__EncapsulatedX509CertificateType* soap_new_ns6__EncapsulatedX509CertificateType(soap*) allocate and default initialize
/// - ns6__EncapsulatedX509CertificateType* soap_new_ns6__EncapsulatedX509CertificateType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__EncapsulatedX509CertificateType::soap_type() returns SOAP_TYPE_ns6__EncapsulatedX509CertificateType or derived type identifier
class ns6__EncapsulatedX509CertificateType
{ public:
/// __item wraps simpleContent of type xs:base64Binary.
    xsd__base64Binary                    __item                        ;
...
/// @brief "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedCRLValueType is a complexType with simpleContent extension of type xs:base64Binary.
///
/// @note class ns6__EncapsulatedCRLValueType operations:
/// - ns6__EncapsulatedCRLValueType* soap_new_ns6__EncapsulatedCRLValueType(soap*) allocate and default initialize
/// - ns6__EncapsulatedCRLValueType* soap_new_ns6__EncapsulatedCRLValueType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__EncapsulatedCRLValueType::soap_type() returns SOAP_TYPE_ns6__EncapsulatedCRLValueType or derived type identifier
class ns6__EncapsulatedCRLValueType
{ public:
/// __item wraps simpleContent of type xs:base64Binary.
    xsd__base64Binary                    __item                        ;
...
/// @brief "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedOCSPValueType is a complexType with simpleContent extension of type xs:base64Binary.
///
/// @note class ns6__EncapsulatedOCSPValueType operations:
/// - ns6__EncapsulatedOCSPValueType* soap_new_ns6__EncapsulatedOCSPValueType(soap*) allocate and default initialize
/// - ns6__EncapsulatedOCSPValueType* soap_new_ns6__EncapsulatedOCSPValueType(soap*, int num) allocate and default initialize an array
...
/// - int ns6__EncapsulatedOCSPValueType::soap_type() returns SOAP_TYPE_ns6__EncapsulatedOCSPValueType or derived type identifier
class ns6__EncapsulatedOCSPValueType
{ public:
/// __item wraps simpleContent of type xs:base64Binary.
    xsd__base64Binary                    __item                        ;
...
/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":AttributeRequest of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":AttributeRequestType.
typedef ns2__AttributeRequestType _ns2__AttributeRequest;

/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":AttributeResponse of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":AttributeResponseType.
typedef ns2__AttributeResponseType _ns2__AttributeResponse;

/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":PSAAttributeRequest of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":PSAAttributeRequestType.
typedef ns2__PSAAttributeRequestType _ns2__PSAAttributeRequest;

/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":SingleAttributeResponse of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeClientService":SingleAttributeResponseType.
...
/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":Signature of type "http://www.w3.org/2000/09/xmldsig#":SignatureType.
typedef ns5__SignatureType _ns5__Signature;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":SignedInfo of type "http://www.w3.org/2000/09/xmldsig#":SignedInfoType.
typedef ns5__SignedInfoType _ns5__SignedInfo;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":CanonicalizationMethod of type "http://www.w3.org/2000/09/xmldsig#":CanonicalizationMethodType.
typedef ns5__CanonicalizationMethodType _ns5__CanonicalizationMethod;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":SignatureMethod of type "http://www.w3.org/2000/09/xmldsig#":SignatureMethodType.
typedef ns5__SignatureMethodType _ns5__SignatureMethod;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":Reference of type "http://www.w3.org/2000/09/xmldsig#":ReferenceType.
typedef ns5__ReferenceType _ns5__Reference;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":Transforms of type "http://www.w3.org/2000/09/xmldsig#":TransformsType.
typedef ns5__TransformsType _ns5__Transforms;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":Transform of type "http://www.w3.org/2000/09/xmldsig#":TransformType.
typedef ns5__TransformType _ns5__Transform;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":DigestMethod of type "http://www.w3.org/2000/09/xmldsig#":DigestMethodType.
typedef ns5__DigestMethodType _ns5__DigestMethod;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":KeyInfo of type "http://www.w3.org/2000/09/xmldsig#":KeyInfoType.
typedef ns5__KeyInfoType _ns5__KeyInfo;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":X509Data of type "http://www.w3.org/2000/09/xmldsig#":X509DataType.
typedef ns5__X509DataType _ns5__X509Data;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":Object of type "http://www.w3.org/2000/09/xmldsig#":ObjectType.
typedef ns5__ObjectType _ns5__Object;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":X509Certificate of type "http://www.w3.org/2000/09/xmldsig#":X509CertificateType.
typedef ns5__X509CertificateType _ns5__X509Certificate;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":DigestValue of type "http://www.w3.org/2000/09/xmldsig#":DigestValueType.
typedef ns5__DigestValueType _ns5__DigestValue;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":SignatureValue of type "http://www.w3.org/2000/09/xmldsig#":SignatureValueType.
typedef ns5__SignatureValueType _ns5__SignatureValue;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":X509IssuerName of type "http://www.w3.org/2000/09/xmldsig#":X509IssuerNameType.
typedef ns5__X509IssuerNameType _ns5__X509IssuerName;

/// @brief Top-level root element "http://www.w3.org/2000/09/xmldsig#":X509SerialNumber of type "http://www.w3.org/2000/09/xmldsig#":X509SerialNumberType.
...
/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":Attribute of type "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":AttributeType.
typedef ns3__AttributeType _ns3__Attribute;

/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/commons/messages/Attribute":SignatureAttribute of type "http://www.w3.org/2000/09/xmldsig#":SignatureType.
...
/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":QualifyingProperties of type "http://uri.etsi.org/01903/v1.3.2#":QualifyingPropertiesType.
typedef ns6__QualifyingPropertiesType _ns6__QualifyingProperties;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SignedProperties of type "http://uri.etsi.org/01903/v1.3.2#":SignedPropertiesType.
typedef ns6__SignedPropertiesType _ns6__SignedProperties;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SignedSignatureProperties of type "http://uri.etsi.org/01903/v1.3.2#":SignedSignaturePropertiesType.
typedef ns6__SignedSignaturePropertiesType _ns6__SignedSignatureProperties;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SigningCertificate of type "http://uri.etsi.org/01903/v1.3.2#":SigningCertificateType.
typedef ns6__SigningCertificateType _ns6__SigningCertificate;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":Cert of type "http://uri.etsi.org/01903/v1.3.2#":CertType.
typedef ns6__CertType _ns6__Cert;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CertDigest of type "http://uri.etsi.org/01903/v1.3.2#":CertDigestType.
typedef ns6__CertDigestType _ns6__CertDigest;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":IssuerSerial of type "http://uri.etsi.org/01903/v1.3.2#":IssuerSerialType.
typedef ns6__IssuerSerialType _ns6__IssuerSerial;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SigningTime of type "http://uri.etsi.org/01903/v1.3.2#":SigningTimeType.
typedef ns6__SigningTimeType _ns6__SigningTime;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SignerRole of type "http://uri.etsi.org/01903/v1.3.2#":SignerRoleType.
typedef ns6__SignerRoleType _ns6__SignerRole;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":ClaimedRoles of type "http://uri.etsi.org/01903/v1.3.2#":ClaimedRolesListType.
typedef ns6__ClaimedRolesListType _ns6__ClaimedRoles;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":ClaimedRole of type "http://uri.etsi.org/01903/v1.3.2#":ClaimedRoleType.
typedef ns6__ClaimedRoleType _ns6__ClaimedRole;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":UnsignedProperties of type "http://uri.etsi.org/01903/v1.3.2#":UnsignedPropertiesType.
typedef ns6__UnsignedPropertiesType _ns6__UnsignedProperties;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":UnsignedSignatureProperties of type "http://uri.etsi.org/01903/v1.3.2#":UnsignedSignaturePropertiesType.
typedef ns6__UnsignedSignaturePropertiesType _ns6__UnsignedSignatureProperties;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CounterSignature of type "http://uri.etsi.org/01903/v1.3.2#":CounterSignatureType.
typedef ns6__CounterSignatureType _ns6__CounterSignature;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SignatureTimeStamp of type "http://uri.etsi.org/01903/v1.3.2#":SignatureTimeStampType.
typedef ns6__SignatureTimeStampType _ns6__SignatureTimeStamp;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedTimeStamp of type "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedTimeStampType.
typedef ns6__EncapsulatedTimeStampType _ns6__EncapsulatedTimeStamp;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CompleteCertificateRefs of type "http://uri.etsi.org/01903/v1.3.2#":CompleteCertificateRefsType.
typedef ns6__CompleteCertificateRefsType _ns6__CompleteCertificateRefs;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CertRefs of type "http://uri.etsi.org/01903/v1.3.2#":CertRefsType.
typedef ns6__CertRefsType _ns6__CertRefs;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CompleteRevocationRefs of type "http://uri.etsi.org/01903/v1.3.2#":CompleteRevocationRefsType.
typedef ns6__CompleteRevocationRefsType _ns6__CompleteRevocationRefs;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CRLRefs of type "http://uri.etsi.org/01903/v1.3.2#":CRLRefsType.
typedef ns6__CRLRefsType _ns6__CRLRefs;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CRLRef of type "http://uri.etsi.org/01903/v1.3.2#":CRLRefType.
typedef ns6__CRLRefType _ns6__CRLRef;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":DigestAlgAndValue of type "http://uri.etsi.org/01903/v1.3.2#":DigestAlgAndValueType.
typedef ns6__DigestAlgAndValueType _ns6__DigestAlgAndValue;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CRLIdentifier of type "http://uri.etsi.org/01903/v1.3.2#":CRLIdentifierType.
typedef ns6__CRLIdentifierType _ns6__CRLIdentifier;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":OCSPRefs of type "http://uri.etsi.org/01903/v1.3.2#":OCSPRefsType.
typedef ns6__OCSPRefsType _ns6__OCSPRefs;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":OCSPRef of type "http://uri.etsi.org/01903/v1.3.2#":OCSPRefType.
typedef ns6__OCSPRefType _ns6__OCSPRef;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":OCSPIdentifier of type "http://uri.etsi.org/01903/v1.3.2#":OCSPIdentifierType.
typedef ns6__OCSPIdentifierType _ns6__OCSPIdentifier;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":ResponderID of type "http://uri.etsi.org/01903/v1.3.2#":ResponderIDType.
typedef ns6__ResponderIDType _ns6__ResponderID;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":SigAndRefsTimeStamp of type "http://uri.etsi.org/01903/v1.3.2#":SigAndRefsTimeStampType.
typedef ns6__SigAndRefsTimeStampType _ns6__SigAndRefsTimeStamp;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CertificateValues of type "http://uri.etsi.org/01903/v1.3.2#":CertificateValuesType.
typedef ns6__CertificateValuesType _ns6__CertificateValues;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedX509Certificate of type "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedX509CertificateType.
typedef ns6__EncapsulatedX509CertificateType _ns6__EncapsulatedX509Certificate;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":RevocationValues of type "http://uri.etsi.org/01903/v1.3.2#":RevocationValuesType.
typedef ns6__RevocationValuesType _ns6__RevocationValues;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":CRLValues of type "http://uri.etsi.org/01903/v1.3.2#":CRLValuesType.
typedef ns6__CRLValuesType _ns6__CRLValues;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedCRLValue of type "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedCRLValueType.
typedef ns6__EncapsulatedCRLValueType _ns6__EncapsulatedCRLValue;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":OCSPValues of type "http://uri.etsi.org/01903/v1.3.2#":OCSPValuesType.
typedef ns6__OCSPValuesType _ns6__OCSPValues;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedOCSPValue of type "http://uri.etsi.org/01903/v1.3.2#":EncapsulatedOCSPValueType.
typedef ns6__EncapsulatedOCSPValueType _ns6__EncapsulatedOCSPValue;

/// @brief Top-level root element "http://uri.etsi.org/01903/v1.3.2#":ArchiveTimeStamp of type "http://uri.etsi.org/01903/v1.3.2#":ArchiveTimeStampType.
...
/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/commons/messages/SVG":SVGList of type "http://www.cartaodecidadao.pt/ccc/commons/messages/SVG":SVGListType.
typedef ns7__SVGListType _ns7__SVGList;

/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/commons/messages/SVG":SVG of type "http://www.cartaodecidadao.pt/ccc/commons/messages/SVG":SVGType.
...
/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeSupplierService":AttributeSupplierRequest of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeSupplierService":AttributeSupplierRequestType.
typedef ns9__AttributeSupplierRequestType _ns9__AttributeSupplierRequest;

/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeSupplierService":AttributeSupplierResponse of type "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeSupplierService":AttributeSupplierResponseType.
...
//gsoap ns1  service name:	AuthorizationServiceSoapBinding 
//gsoap ns1  service type:	SCAPAuthorizationService 
//gsoap ns1  service port:	https://scap.autenticacao.gov.pt/SCAPSignature/AuthorizationService 
//gsoap ns1  service namespace:	http://authorization.documentsignature.scap.gov.pt/ 
//gsoap ns1  service transport:	http://schemas.xmlsoap.org/soap/http 

//gsoap ns10 service name:	AttributeClientServiceBinding 
//gsoap ns10 service type:	AttributeClientService 
//gsoap ns10 service port:	https://scap.autenticacao.gov.pt/DSS/ACService 
//gsoap ns10 service namespace:	http://www.cartaodecidadao.pt/ccc/sccc/services/AttributeClientService 
//gsoap ns10 service transport:	http://schemas.xmlsoap.org/soap/http 

//gsoap ns2  service name:	SignatureServiceSoapBinding 
//gsoap ns2  service type:	SCAPSignatureService 
//gsoap ns2  service port:	https://scap.autenticacao.gov.pt/SCAPSignature/SignatureService 
//gsoap ns2  service namespace:	http://signature.documentsignature.scap.gov.pt/ 
//gsoap ns2  service transport:	http://schemas.xmlsoap.org/soap/http 

//gsoap ns8  service name:	AttributeSupplierBinding 
//gsoap ns8  service type:	AttributeSupplierService 
//gsoap ns8  service port:	https://scap.autenticacao.gov.pt/DSS/ASService 
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__Authorization                                                     *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__Authorization" of service binding "AuthorizationServiceSoapBinding".
...
@code
  int soap_call___ns1__Authorization(
    struct soap *soap,
...
//gsoap ns1  service method-protocol:	Authorization SOAP
//gsoap ns1  service method-style:	Authorization document
//gsoap ns1  service method-encoding:	Authorization literal
//gsoap ns1  service method-input-action:	Authorization http://www.cartaodecidadao.pt/ccc/internalservices/services/SCAPSignature/Operations/Authorization
//gsoap ns1  service method-output-action:	Authorization http://www.cartaodecidadao.pt/ccc/internalservices/services/SCAPSignature/Operations/AuthorizationResponse
int __ns1__Authorization(
...
/** Operation "__ns10__Attributes" of service binding "AttributeClientServiceBinding".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns10__Attributes(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns10 service method-protocol:	Attributes SOAP
//gsoap ns10 service method-style:	Attributes document
//gsoap ns10 service method-encoding:	Attributes literal
//gsoap ns10 service method-input-action:	Attributes http://www.cartaodecidadao.pt/services/ccc/ACS/Operations/Attributes
//gsoap ns10 service method-output-action:	Attributes http://www.cartaodecidadao.pt/services/ccc/ACS/Operations/AttributesResponse
int __ns10__Attributes(
...
/** Operation "__ns2__Signature" of service binding "SignatureServiceSoapBinding".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns2__Signature(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns2  service method-protocol:	Signature SOAP
//gsoap ns2  service method-style:	Signature document
//gsoap ns2  service method-encoding:	Signature literal
//gsoap ns2  service method-input-action:	Signature http://www.cartaodecidadao.pt/ccc/internalservices/services/SCAPSignature/Operations/Signature
//gsoap ns2  service method-output-action:	Signature http://www.cartaodecidadao.pt/ccc/internalservices/services/SCAPSignature/Operations/SignatureResponse
int __ns2__Signature(
...
/** Operation "__ns8__EntityAttributeSuppliers" of service binding "AttributeSupplierBinding".
  ...
  - Addressing input action: "http://www.cartaodecidadao.pt/CCC/Attribute/AttributeSupplier/services/AttributeSupplierService/EntitySupplierList"

  - Addressing output action: "http://www.cartaodecidadao.pt/CCC/Attribute/AttributeSupplier/services/AttributeSupplierService/EntitySupplierListResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns8__EntityAttributeSuppliers(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns8__EntityAttributeSuppliers(
    struct soap *soap,
    // input parameters:
    // output parameters:
    ns9__AttributeSupplierResponseType &ns9__AttributeSupplierResponse
...
//gsoap ns8  service method-protocol:	EntityAttributeSuppliers SOAP
//gsoap ns8  service method-style:	EntityAttributeSuppliers document
//gsoap ns8  service method-encoding:	EntityAttributeSuppliers literal
//gsoap ns8  service method-input-action:	EntityAttributeSuppliers http://www.cartaodecidadao.pt/CCC/Attribute/AttributeSupplier/services/AttributeSupplierService/EntitySupplierList
//gsoap ns8  service method-output-action:	EntityAttributeSuppliers http://www.cartaodecidadao.pt/CCC/Attribute/AttributeSupplier/services/AttributeSupplierService/EntitySupplierListResponse
int __ns8__EntityAttributeSuppliers(
    ns9__AttributeSupplierResponseType &ns9__AttributeSupplierResponse	///< Output parameter
);
...
@section ns10 Top-level root elements of schema "http://www.cartaodecidadao.pt/ccc/sccc/services/AttributeClientService"
...
@section ns11 Top-level root elements of schema "http://www.cartaodecidadao.pt/ccc/commons/messages/TypesAttributeManagment"
...
@section ns9 Top-level root elements of schema "http://www.cartaodecidadao.pt/ccc/sccc/messages/AttributeSupplierService"
  ...
  - <ns9:AttributeSupplierRequest> @ref _ns9__AttributeSupplierRequest
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns9__AttributeSupplierRequest(struct soap*, _ns9__AttributeSupplierRequest*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns9__AttributeSupplierRequest(struct soap*, _ns9__AttributeSupplierRequest*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns9__AttributeSupplierRequest(struct soap*, const char *URL, _ns9__AttributeSupplierRequest*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns9__AttributeSupplierRequest(struct soap*, const char *URL, _ns9__AttributeSupplierRequest*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns9__AttributeSupplierRequest(struct soap*, const char *URL, _ns9__AttributeSupplierRequest*);
    soap_POST_recv__ns9__AttributeSupplierRequest(struct soap*, _ns9__AttributeSupplierRequest*);
    @endcode
