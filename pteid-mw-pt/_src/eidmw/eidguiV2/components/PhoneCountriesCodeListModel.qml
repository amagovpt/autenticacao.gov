...
ListModel { 
    ...
    ListElement { text: "+34 - Spain" }
    ListElement { text: "-------------------" }
    ListElement { text: "+93 - Afghanistan" }
    ListElement { text: "+355 - Albania" }
    ListElement { text: "+213 - Algeria" }
    ListElement { text: "+684 - American Samoa" }
    ListElement { text: "+376 - Andorra" }
    ListElement { text: "+244 - Angola" }
    ListElement { text: "+809 - Anguilla" }
    ListElement { text: "+268 - Antigua" }
    ListElement { text: "+54 - Argentina" }
    ListElement { text: "+374 - Armenia" }
    ListElement { text: "+297 - Aruba" }
    ListElement { text: "+247 - Ascension Island" }
    ListElement { text: "+61 - Australia" }
    ListElement { text: "+672 - Australian External Territories" }
    ListElement { text: "+43 - Austria" }
    ListElement { text: "+994 - Azerbaijan" }
    ListElement { text: "+242 - Bahamas" }
    ListElement { text: "+246 - Barbados" }
    ListElement { text: "+973 - Bahrain" }
    ListElement { text: "+880 - Bangladesh" }
    ListElement { text: "+375 - Belarus" }
    ListElement { text: "+32 - Belgium" }
    ListElement { text: "+501 - Belize" }
    ListElement { text: "+229 - Benin" }
    ListElement { text: "+809 - Bermuda" }
    ...
    ListElement { text: "+673 - Brunei Darussalm" }
    ...
    ListElement { text: "+86 - China (People's Republic)" }
    ListElement { text: "+886 - China-Taiwan" }
    ListElement { text: "+57 - Colombia" }
    ListElement { text: "+269 - Comoros and Mayotte" }
    ListElement { text: "+242 - Congo" }
    ListElement { text: "+506 - Costa Rica" }
    ListElement { text: "+385 - Croatia" }
    ListElement { text: "+53 - Cuba" }
    ListElement { text: "+357 - Cyprus" }
    ...
    ListElement { text: "+20 - Egypt" }
    ListElement { text: "+503 - El Salvador" }
    ...
    ListElement { text: "+596 - French Antilles" }
    ListElement { text: "+594 - French Guiana" }
    ListElement { text: "+241 - Gabon (Gabonese Republic)" }
    ListElement { text: "+220 - Gambia" }
    ListElement { text: "+995 - Georgia" }
    ListElement { text: "+49 - Germany" }
    ListElement { text: "+233 - Ghana" }
    ListElement { text: "+350 - Gibraltar" }
    ...
    ListElement { text: "+852 - Hong Kong" }
    ListElement { text: "+36 - Hungary" }
    ListElement { text: "+354 - Iceland" }
    ListElement { text: "+91 - India" }
    ListElement { text: "+62 - Indonesia" }
    ListElement { text: "+98 - Iran" }
    ListElement { text: "+964 - Iraq" }
    ListElement { text: "+353 - Ireland (Irish Republic; Eire)" }
    ListElement { text: "+972 - Israel" }
    ListElement { text: "+39 - Italy" }
    ListElement { text: "+225 - Ivory Coast (La Cote d'Ivoire)" }
    ListElement { text: "+876 - Jamaica" }
    ListElement { text: "+81 - Japan" }
    ListElement { text: "+962 - Jordan" }
    ListElement { text: "+7 - Kazakhstan" }
    ListElement { text: "+254 - Kenya" }
    ListElement { text: "+855 - Khmer Republic (Cambodia/Kampuchea)" }
    ...
    ListElement { text: "+856 - Laos" }
    ListElement { text: "+961 - Lebanon" }
    ListElement { text: "+266 - Lesotho" }
    ListElement { text: "+231 - Liberia" }
    ListElement { text: "+370 - Lithuania" }
    ListElement { text: "+218 - Libya" }
    ...
    ListElement { text: "+960 - Maldives" }
    ListElement { text: "+223 - Mali" }
    ListElement { text: "+356 - Malta" }
    ListElement { text: "+692 - Marshall Islands" }
    ListElement { text: "+596 - Martinique (French Antilles)" }
    ListElement { text: "+222 - Mauritania" }
    ListElement { text: "+230 - Mauritius" }
    ...
    ListElement { text: "+977 - Nepal" }
    ListElement { text: "+31 - Netherlands" }
    ListElement { text: "+599 - Netherlands Antilles" }
    ListElement { text: "+869 - Nevis" }
    ListElement { text: "+687 - New Caledonia" }
    ListElement { text: "+64 - New Zealand" }
    ListElement { text: "+505 - Nicaragua" }
    ListElement { text: "+227 - Niger" }
    ...
    ListElement { text: "+92 - Pakistan" }
    ListElement { text: "+680 - Palau" }
    ListElement { text: "+507 - Panama" }
    ListElement { text: "+675 - Papua New Guinea" }
    ListElement { text: "+595 - Paraguay" }
    ...
    ListElement { text: "+40 - Romania" }
    ListElement { text: "+7 - Russia" }
    ...
    ListElement { text: "+421 - Slovakia" }
    ListElement { text: "+386 - Slovenia" }
    ListElement { text: "+677 - Solomon Islands" }
    ListElement { text: "+252 - Somalia" }
    ListElement { text: "+27 - South Africa" }
    ListElement { text: "+34 - Spain" }
    ListElement { text: "+94 - Sri Lanka" }
    ListElement { text: "+290 - St. Helena" }
    ...
    ListElement { text: "+689 - Tahiti (French Polynesia)" }
    ListElement { text: "+886 - Taiwan" }
    ...
    ListElement { text: "+1 868 - Trinidad and Tobago" }
    ListElement { text: "+216 - Tunisia" }
    ListElement { text: "+90 - Turkey" }
    ListElement { text: "+993 - Turkmenistan" }
    ListElement { text: "+688 - Tuvalu (Ellice Islands)" }
    ListElement { text: "+256 - Uganda" }
    ListElement { text: "+380 - Ukraine" }
    ...
    ListElement { text: "+58 - Venezuela" }
    ListElement { text: "+84 - Viet Nam" }
    ListElement { text: "+1 340 - Virgin Islands" }
    ListElement { text: "+681 - Wallis and Futuna" }
