...
/* SCAP-Services.h
   Generated by wsdl2h 2.8.28 from http://localhost:8000/ACService.wsdl http://localhost:8000/ASService.wsdl http://localhost:8000/PDFSignature.wsdl and typemap.dat
   2017-09-15 14:36:33 GMT
...
//  Forward declaration of class pdf__SignRequest.
class pdf__SignRequest;
...
///
/// class pdf__SignRequest operations:
/// - pdf__SignRequest* soap_new_pdf__SignRequest(soap*) allocate
/// - pdf__SignRequest* soap_new_pdf__SignRequest(soap*, int num) allocate array
/// - pdf__SignRequest* soap_new_req_pdf__SignRequest(soap*, ...) allocate, set required members
/// - pdf__SignRequest* soap_new_set_pdf__SignRequest(soap*, ...) allocate, set all public members
/// - pdf__SignRequest::soap_default(soap*) reset members to default
/// - int soap_read_pdf__SignRequest(soap*, pdf__SignRequest*) deserialize from a stream
/// - int soap_write_pdf__SignRequest(soap*, pdf__SignRequest*) serialize to a stream
/// - pdf__SignRequest* pdf__SignRequest::soap_dup(soap*) returns deep copy of pdf__SignRequest, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__SignRequest::soap_del() deep deletes pdf__SignRequest data members, use only after pdf__SignRequest::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__SignRequest
{ public:
...
//gsoap pdf  service name:	PDFSignatureSoapBinding 
//gsoap pdf  service type:	PDFSignature 
//gsoap pdf  service port:	https://preprod.scap.autenticacao.gov.pt/PADES/PDFSignature 
...
/** Operation "__pdf__Sign" of service binding "PDFSignatureSoapBinding".
...
//gsoap pdf  service method-input-action:	Sign http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/Sign
//gsoap pdf  service method-output-action:	Sign http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/SignResponse
int __pdf__Sign(
    pdf__SignRequest*                   pdf__SignRequest_,	///< Input parameter
...
@section pdf Top-level root elements of schema "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature"
  ...
  - <pdf:SignRequest> @ref _pdf__SignRequest
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__pdf__SignRequest(struct soap*, _pdf__SignRequest*);
    // Writer (returns SOAP_OK on success):
    soap_write__pdf__SignRequest(struct soap*, _pdf__SignRequest*);
    @endcode
