...
Item {
    ...
    Item {
        ...
        Item {
            ...
            height: text2.height + raw1.height + raw2.height + raw3.height
                    + raw4.height + 4 * Constants.SIZE_TEXT_BODY
            width: parent.width
            Accessible.role: Accessible.Row
