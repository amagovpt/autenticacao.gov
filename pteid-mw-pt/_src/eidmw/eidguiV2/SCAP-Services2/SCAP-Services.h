...
/* SCAP-Services.h
   Generated by wsdl2h 2.8.28 from http://localhost:8000/ACService.wsdl http://localhost:8000/ASService.wsdl http://localhost:8000/PDFSignatureWithAttach.wsdl and typemap.dat
   2018-03-12 18:32:35 GMT
...
pdf = "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature"
...
//gsoap pdf   schema namespace:	http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature
//gsoap pdf   schema form:	unqualified
...
//  Forward declaration of class pdf__SignRequestWithAttach.
class pdf__SignRequestWithAttach;

//  Forward declaration of class pdf__PersonalDataType.
class pdf__PersonalDataType;

//  Forward declaration of class pdf__AttributeListType.
class pdf__AttributeListType;

//  Forward declaration of class pdf__AttributeType.
class pdf__AttributeType;

//  Forward declaration of class pdf__AttributeSupplierType.
class pdf__AttributeSupplierType;

//  Forward declaration of class pdf__MainAttributeType.
class pdf__MainAttributeType;

//  Forward declaration of class pdf__LegalActListType.
class pdf__LegalActListType;

//  Forward declaration of class pdf__SubAttributeListType.
class pdf__SubAttributeListType;

//  Forward declaration of class pdf__SubAttributeType.
class pdf__SubAttributeType;

//  Forward declaration of class pdf__SignResponse.
class pdf__SignResponse;

//  Forward declaration of class pdf__Status.
class pdf__Status;
...
///
/// @note The enum values are prefixed with "pdf__SignatureOrientationEnumType__" to prevent name clashes: use wsdl2h option -e to omit this prefix or use option -c++11 for scoped enumerations
enum pdf__SignatureOrientationEnumType
{
	pdf__SignatureOrientationEnumType__LANDSCAPE,	///< xs:string value="LANDSCAPE"
	pdf__SignatureOrientationEnumType__PORTRAIT,	///< xs:string value="PORTRAIT"
};
...
/// - ns6__QualifyingPropertiesType* soap_new_ns6__QualifyingPropertiesType(soap*) allocate
/// - ns6__QualifyingPropertiesType* soap_new_ns6__QualifyingPropertiesType(soap*, int num) allocate array
...
/// - ns6__QualifyingPropertiesType::soap_default(soap*) reset members to default
...
/// - ns6__SignedPropertiesType* soap_new_ns6__SignedPropertiesType(soap*) allocate
/// - ns6__SignedPropertiesType* soap_new_ns6__SignedPropertiesType(soap*, int num) allocate array
...
/// - ns6__SignedPropertiesType::soap_default(soap*) reset members to default
...
/// - ns6__SignedSignaturePropertiesType* soap_new_ns6__SignedSignaturePropertiesType(soap*) allocate
/// - ns6__SignedSignaturePropertiesType* soap_new_ns6__SignedSignaturePropertiesType(soap*, int num) allocate array
...
/// - ns6__SignedSignaturePropertiesType::soap_default(soap*) reset members to default
...
/// - ns6__SigningCertificateType* soap_new_ns6__SigningCertificateType(soap*) allocate
/// - ns6__SigningCertificateType* soap_new_ns6__SigningCertificateType(soap*, int num) allocate array
...
/// - ns6__SigningCertificateType::soap_default(soap*) reset members to default
...
/// - ns6__CertType* soap_new_ns6__CertType(soap*) allocate
/// - ns6__CertType* soap_new_ns6__CertType(soap*, int num) allocate array
...
/// - ns6__CertType::soap_default(soap*) reset members to default
...
/// - ns6__CertDigestType* soap_new_ns6__CertDigestType(soap*) allocate
/// - ns6__CertDigestType* soap_new_ns6__CertDigestType(soap*, int num) allocate array
...
/// - ns6__CertDigestType::soap_default(soap*) reset members to default
...
/// - ns6__IssuerSerialType* soap_new_ns6__IssuerSerialType(soap*) allocate
/// - ns6__IssuerSerialType* soap_new_ns6__IssuerSerialType(soap*, int num) allocate array
...
/// - ns6__IssuerSerialType::soap_default(soap*) reset members to default
...
/// - ns6__SignerRoleType* soap_new_ns6__SignerRoleType(soap*) allocate
/// - ns6__SignerRoleType* soap_new_ns6__SignerRoleType(soap*, int num) allocate array
...
/// - ns6__SignerRoleType::soap_default(soap*) reset members to default
...
/// - ns6__ClaimedRolesListType* soap_new_ns6__ClaimedRolesListType(soap*) allocate
/// - ns6__ClaimedRolesListType* soap_new_ns6__ClaimedRolesListType(soap*, int num) allocate array
...
/// - ns6__ClaimedRolesListType::soap_default(soap*) reset members to default
...
/// Vector of ns6__ClaimedRoleType* element refs of length 1..unbounded.
    std::vector<ns6__ClaimedRoleType*  > ns6__ClaimedRole               1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/// - ns6__ClaimedRoleType* soap_new_ns6__ClaimedRoleType(soap*) allocate
/// - ns6__ClaimedRoleType* soap_new_ns6__ClaimedRoleType(soap*, int num) allocate array
...
/// - ns6__ClaimedRoleType::soap_default(soap*) reset members to default
...
/// - ns6__UnsignedPropertiesType* soap_new_ns6__UnsignedPropertiesType(soap*) allocate
/// - ns6__UnsignedPropertiesType* soap_new_ns6__UnsignedPropertiesType(soap*, int num) allocate array
...
/// - ns6__UnsignedPropertiesType::soap_default(soap*) reset members to default
...
/// - ns6__UnsignedSignaturePropertiesType* soap_new_ns6__UnsignedSignaturePropertiesType(soap*) allocate
/// - ns6__UnsignedSignaturePropertiesType* soap_new_ns6__UnsignedSignaturePropertiesType(soap*, int num) allocate array
...
/// - ns6__UnsignedSignaturePropertiesType::soap_default(soap*) reset members to default
...
/// - ns6__CounterSignatureType* soap_new_ns6__CounterSignatureType(soap*) allocate
/// - ns6__CounterSignatureType* soap_new_ns6__CounterSignatureType(soap*, int num) allocate array
...
/// - ns6__CounterSignatureType::soap_default(soap*) reset members to default
...
/// - ns6__SignatureTimeStampType* soap_new_ns6__SignatureTimeStampType(soap*) allocate
/// - ns6__SignatureTimeStampType* soap_new_ns6__SignatureTimeStampType(soap*, int num) allocate array
...
/// - ns6__SignatureTimeStampType::soap_default(soap*) reset members to default
...
/// - ns6__CompleteCertificateRefsType* soap_new_ns6__CompleteCertificateRefsType(soap*) allocate
/// - ns6__CompleteCertificateRefsType* soap_new_ns6__CompleteCertificateRefsType(soap*, int num) allocate array
...
/// - ns6__CompleteCertificateRefsType::soap_default(soap*) reset members to default
...
/// - ns6__CertRefsType* soap_new_ns6__CertRefsType(soap*) allocate
/// - ns6__CertRefsType* soap_new_ns6__CertRefsType(soap*, int num) allocate array
...
/// - ns6__CertRefsType::soap_default(soap*) reset members to default
...
/// Vector of ns6__CertType* element refs of length 1..unbounded.
    std::vector<ns6__CertType*         > ns6__Cert                      1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/// - ns6__CompleteRevocationRefsType* soap_new_ns6__CompleteRevocationRefsType(soap*) allocate
/// - ns6__CompleteRevocationRefsType* soap_new_ns6__CompleteRevocationRefsType(soap*, int num) allocate array
...
/// - ns6__CompleteRevocationRefsType::soap_default(soap*) reset members to default
...
/// - ns6__CRLRefsType* soap_new_ns6__CRLRefsType(soap*) allocate
/// - ns6__CRLRefsType* soap_new_ns6__CRLRefsType(soap*, int num) allocate array
...
/// - ns6__CRLRefsType::soap_default(soap*) reset members to default
...
/// Vector of ns6__CRLRefType* element refs of length 1..unbounded.
    std::vector<ns6__CRLRefType*       > ns6__CRLRef                    1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/// - ns6__CRLRefType* soap_new_ns6__CRLRefType(soap*) allocate
/// - ns6__CRLRefType* soap_new_ns6__CRLRefType(soap*, int num) allocate array
...
/// - ns6__CRLRefType::soap_default(soap*) reset members to default
...
/// - ns6__DigestAlgAndValueType* soap_new_ns6__DigestAlgAndValueType(soap*) allocate
/// - ns6__DigestAlgAndValueType* soap_new_ns6__DigestAlgAndValueType(soap*, int num) allocate array
...
/// - ns6__DigestAlgAndValueType::soap_default(soap*) reset members to default
...
/// - ns6__CRLIdentifierType* soap_new_ns6__CRLIdentifierType(soap*) allocate
/// - ns6__CRLIdentifierType* soap_new_ns6__CRLIdentifierType(soap*, int num) allocate array
...
/// - ns6__CRLIdentifierType::soap_default(soap*) reset members to default
...
/// - ns6__OCSPRefsType* soap_new_ns6__OCSPRefsType(soap*) allocate
/// - ns6__OCSPRefsType* soap_new_ns6__OCSPRefsType(soap*, int num) allocate array
...
/// - ns6__OCSPRefsType::soap_default(soap*) reset members to default
...
/// Vector of ns6__OCSPRefType* element refs of length 1..unbounded.
    std::vector<ns6__OCSPRefType*      > ns6__OCSPRef                   1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
/// - ns6__OCSPRefType* soap_new_ns6__OCSPRefType(soap*) allocate
/// - ns6__OCSPRefType* soap_new_ns6__OCSPRefType(soap*, int num) allocate array
...
/// - ns6__OCSPRefType::soap_default(soap*) reset members to default
...
/// - ns6__OCSPIdentifierType* soap_new_ns6__OCSPIdentifierType(soap*) allocate
/// - ns6__OCSPIdentifierType* soap_new_ns6__OCSPIdentifierType(soap*, int num) allocate array
...
/// - ns6__OCSPIdentifierType::soap_default(soap*) reset members to default
...
/// - ns6__ResponderIDType* soap_new_ns6__ResponderIDType(soap*) allocate
/// - ns6__ResponderIDType* soap_new_ns6__ResponderIDType(soap*, int num) allocate array
...
/// - ns6__ResponderIDType::soap_default(soap*) reset members to default
...
/// - ns6__SigAndRefsTimeStampType* soap_new_ns6__SigAndRefsTimeStampType(soap*) allocate
/// - ns6__SigAndRefsTimeStampType* soap_new_ns6__SigAndRefsTimeStampType(soap*, int num) allocate array
...
/// - ns6__SigAndRefsTimeStampType::soap_default(soap*) reset members to default
...
/// - ns6__CertificateValuesType* soap_new_ns6__CertificateValuesType(soap*) allocate
/// - ns6__CertificateValuesType* soap_new_ns6__CertificateValuesType(soap*, int num) allocate array
...
/// - ns6__CertificateValuesType::soap_default(soap*) reset members to default
...
/// Vector of ns6__EncapsulatedX509CertificateType* element refs of length 1..unbounded.
    std::vector<ns6__EncapsulatedX509CertificateType*> ns6__EncapsulatedX509Certificate 1;
/// Attribute "Id" of XSD type xs:ID.
   @xsd__ID                              Id                             1;	///< Required attribute.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
...
/// - ns6__RevocationValuesType* soap_new_ns6__RevocationValuesType(soap*) allocate
/// - ns6__RevocationValuesType* soap_new_ns6__RevocationValuesType(soap*, int num) allocate array
...
/// - ns6__RevocationValuesType::soap_default(soap*) reset members to default
...
/// - ns6__CRLValuesType* soap_new_ns6__CRLValuesType(soap*) allocate
/// - ns6__CRLValuesType* soap_new_ns6__CRLValuesType(soap*, int num) allocate array
...
/// - ns6__CRLValuesType::soap_default(soap*) reset members to default
...
/// Vector of ns6__EncapsulatedCRLValueType* element refs of length 1..unbounded.
    std::vector<ns6__EncapsulatedCRLValueType*> ns6__EncapsulatedCRLValue      1;
/// Attribute "Id" of XSD type xs:ID.
   @xsd__ID                              Id                             1;	///< Required attribute.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
...
/// - ns6__OCSPValuesType* soap_new_ns6__OCSPValuesType(soap*) allocate
/// - ns6__OCSPValuesType* soap_new_ns6__OCSPValuesType(soap*, int num) allocate array
...
/// - ns6__OCSPValuesType::soap_default(soap*) reset members to default
...
/// Vector of ns6__EncapsulatedOCSPValueType* element refs of length 1..unbounded.
    std::vector<ns6__EncapsulatedOCSPValueType*> ns6__EncapsulatedOCSPValue     1;
/// Attribute "Id" of XSD type xs:ID.
   @xsd__ID                              Id                             1;	///< Required attribute.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
...
/// - ns6__ArchiveTimeStampType* soap_new_ns6__ArchiveTimeStampType(soap*) allocate
/// - ns6__ArchiveTimeStampType* soap_new_ns6__ArchiveTimeStampType(soap*, int num) allocate array
...
/// - ns6__ArchiveTimeStampType::soap_default(soap*) reset members to default
...
/// - ns9__AttributeSupplierResponseType* soap_new_ns9__AttributeSupplierResponseType(soap*) allocate
/// - ns9__AttributeSupplierResponseType* soap_new_ns9__AttributeSupplierResponseType(soap*, int num) allocate array
...
/// - ns9__AttributeSupplierResponseType::soap_default(soap*) reset members to default
...
/// @brief "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":SignRequestWithAttach is a complexType.
///
/// class pdf__SignRequestWithAttach operations:
/// - pdf__SignRequestWithAttach* soap_new_pdf__SignRequestWithAttach(soap*) allocate
/// - pdf__SignRequestWithAttach* soap_new_pdf__SignRequestWithAttach(soap*, int num) allocate array
/// - pdf__SignRequestWithAttach* soap_new_req_pdf__SignRequestWithAttach(soap*, ...) allocate, set required members
/// - pdf__SignRequestWithAttach* soap_new_set_pdf__SignRequestWithAttach(soap*, ...) allocate, set all public members
/// - pdf__SignRequestWithAttach::soap_default(soap*) reset members to default
/// - int soap_read_pdf__SignRequestWithAttach(soap*, pdf__SignRequestWithAttach*) deserialize from a stream
/// - int soap_write_pdf__SignRequestWithAttach(soap*, pdf__SignRequestWithAttach*) serialize to a stream
/// - pdf__SignRequestWithAttach* pdf__SignRequestWithAttach::soap_dup(soap*) returns deep copy of pdf__SignRequestWithAttach, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__SignRequestWithAttach::soap_del() deep deletes pdf__SignRequestWithAttach data members, use only after pdf__SignRequestWithAttach::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__SignRequestWithAttach
{ public:
...
/// Element "PersonalData" of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":PersonalDataType.
    pdf__PersonalDataType*               PersonalData                   1;	///< Required element.
/// Element "AttributeList" of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":AttributeListType.
    pdf__AttributeListType*              AttributeList                  1;	///< Required element.
/// Element "SignatureFieldName" of XSD type xs:string.
    std::string                          SignatureFieldName             1;	///< Required element.
/// MTOM attachment with content types application/pdf.
/// Element "DocumentAttach" of XSD type xs:base64Binary.
    xsd__base64Binary                    DocumentAttach                 1;	///< Required element.
...
/// Element "Orientation" of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":SignatureOrientationEnumType.
    enum pdf__SignatureOrientationEnumType  Orientation                    1;	///< Required element.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
///
/// class pdf__PersonalDataType operations:
/// - pdf__PersonalDataType* soap_new_pdf__PersonalDataType(soap*) allocate
/// - pdf__PersonalDataType* soap_new_pdf__PersonalDataType(soap*, int num) allocate array
/// - pdf__PersonalDataType* soap_new_req_pdf__PersonalDataType(soap*, ...) allocate, set required members
/// - pdf__PersonalDataType* soap_new_set_pdf__PersonalDataType(soap*, ...) allocate, set all public members
/// - pdf__PersonalDataType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__PersonalDataType(soap*, pdf__PersonalDataType*) deserialize from a stream
/// - int soap_write_pdf__PersonalDataType(soap*, pdf__PersonalDataType*) serialize to a stream
/// - pdf__PersonalDataType* pdf__PersonalDataType::soap_dup(soap*) returns deep copy of pdf__PersonalDataType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__PersonalDataType::soap_del() deep deletes pdf__PersonalDataType data members, use only after pdf__PersonalDataType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__PersonalDataType
{ public:
...
///
/// class pdf__AttributeListType operations:
/// - pdf__AttributeListType* soap_new_pdf__AttributeListType(soap*) allocate
/// - pdf__AttributeListType* soap_new_pdf__AttributeListType(soap*, int num) allocate array
/// - pdf__AttributeListType* soap_new_req_pdf__AttributeListType(soap*, ...) allocate, set required members
/// - pdf__AttributeListType* soap_new_set_pdf__AttributeListType(soap*, ...) allocate, set all public members
/// - pdf__AttributeListType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__AttributeListType(soap*, pdf__AttributeListType*) deserialize from a stream
/// - int soap_write_pdf__AttributeListType(soap*, pdf__AttributeListType*) serialize to a stream
/// - pdf__AttributeListType* pdf__AttributeListType::soap_dup(soap*) returns deep copy of pdf__AttributeListType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__AttributeListType::soap_del() deep deletes pdf__AttributeListType data members, use only after pdf__AttributeListType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__AttributeListType
{ public:
/// Vector of pdf__AttributeType* of length 1..unbounded.
    std::vector<pdf__AttributeType*    > Attribute                      1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
///
/// class pdf__AttributeType operations:
/// - pdf__AttributeType* soap_new_pdf__AttributeType(soap*) allocate
/// - pdf__AttributeType* soap_new_pdf__AttributeType(soap*, int num) allocate array
/// - pdf__AttributeType* soap_new_req_pdf__AttributeType(soap*, ...) allocate, set required members
/// - pdf__AttributeType* soap_new_set_pdf__AttributeType(soap*, ...) allocate, set all public members
/// - pdf__AttributeType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__AttributeType(soap*, pdf__AttributeType*) deserialize from a stream
/// - int soap_write_pdf__AttributeType(soap*, pdf__AttributeType*) serialize to a stream
/// - pdf__AttributeType* pdf__AttributeType::soap_dup(soap*) returns deep copy of pdf__AttributeType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__AttributeType::soap_del() deep deletes pdf__AttributeType data members, use only after pdf__AttributeType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__AttributeType
{ public:
/// Element "AttributeSupplier" of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":AttributeSupplierType.
    pdf__AttributeSupplierType*          AttributeSupplier              1;	///< Required element.
/// Element "MainAttribute" of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":MainAttributeType.
    pdf__MainAttributeType*              MainAttribute                  1;	///< Required element.
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
///
/// class pdf__AttributeSupplierType operations:
/// - pdf__AttributeSupplierType* soap_new_pdf__AttributeSupplierType(soap*) allocate
/// - pdf__AttributeSupplierType* soap_new_pdf__AttributeSupplierType(soap*, int num) allocate array
/// - pdf__AttributeSupplierType* soap_new_req_pdf__AttributeSupplierType(soap*, ...) allocate, set required members
/// - pdf__AttributeSupplierType* soap_new_set_pdf__AttributeSupplierType(soap*, ...) allocate, set all public members
/// - pdf__AttributeSupplierType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__AttributeSupplierType(soap*, pdf__AttributeSupplierType*) deserialize from a stream
/// - int soap_write_pdf__AttributeSupplierType(soap*, pdf__AttributeSupplierType*) serialize to a stream
/// - pdf__AttributeSupplierType* pdf__AttributeSupplierType::soap_dup(soap*) returns deep copy of pdf__AttributeSupplierType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__AttributeSupplierType::soap_del() deep deletes pdf__AttributeSupplierType data members, use only after pdf__AttributeSupplierType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__AttributeSupplierType
{ public:
/// Element "Id" of XSD type xs:anyURI.
    xsd__anyURI                          Id                             1;	///< Required element.
...
///
/// class pdf__MainAttributeType operations:
/// - pdf__MainAttributeType* soap_new_pdf__MainAttributeType(soap*) allocate
/// - pdf__MainAttributeType* soap_new_pdf__MainAttributeType(soap*, int num) allocate array
/// - pdf__MainAttributeType* soap_new_req_pdf__MainAttributeType(soap*, ...) allocate, set required members
/// - pdf__MainAttributeType* soap_new_set_pdf__MainAttributeType(soap*, ...) allocate, set all public members
/// - pdf__MainAttributeType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__MainAttributeType(soap*, pdf__MainAttributeType*) deserialize from a stream
/// - int soap_write_pdf__MainAttributeType(soap*, pdf__MainAttributeType*) serialize to a stream
/// - pdf__MainAttributeType* pdf__MainAttributeType::soap_dup(soap*) returns deep copy of pdf__MainAttributeType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__MainAttributeType::soap_del() deep deletes pdf__MainAttributeType data members, use only after pdf__MainAttributeType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__MainAttributeType
{ public:
...
///
/// class pdf__LegalActListType operations:
/// - pdf__LegalActListType* soap_new_pdf__LegalActListType(soap*) allocate
/// - pdf__LegalActListType* soap_new_pdf__LegalActListType(soap*, int num) allocate array
/// - pdf__LegalActListType* soap_new_req_pdf__LegalActListType(soap*, ...) allocate, set required members
/// - pdf__LegalActListType* soap_new_set_pdf__LegalActListType(soap*, ...) allocate, set all public members
/// - pdf__LegalActListType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__LegalActListType(soap*, pdf__LegalActListType*) deserialize from a stream
/// - int soap_write_pdf__LegalActListType(soap*, pdf__LegalActListType*) serialize to a stream
/// - pdf__LegalActListType* pdf__LegalActListType::soap_dup(soap*) returns deep copy of pdf__LegalActListType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__LegalActListType::soap_del() deep deletes pdf__LegalActListType data members, use only after pdf__LegalActListType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__LegalActListType
{ public:
...
///
/// class pdf__SubAttributeListType operations:
/// - pdf__SubAttributeListType* soap_new_pdf__SubAttributeListType(soap*) allocate
/// - pdf__SubAttributeListType* soap_new_pdf__SubAttributeListType(soap*, int num) allocate array
/// - pdf__SubAttributeListType* soap_new_req_pdf__SubAttributeListType(soap*, ...) allocate, set required members
/// - pdf__SubAttributeListType* soap_new_set_pdf__SubAttributeListType(soap*, ...) allocate, set all public members
/// - pdf__SubAttributeListType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__SubAttributeListType(soap*, pdf__SubAttributeListType*) deserialize from a stream
/// - int soap_write_pdf__SubAttributeListType(soap*, pdf__SubAttributeListType*) serialize to a stream
/// - pdf__SubAttributeListType* pdf__SubAttributeListType::soap_dup(soap*) returns deep copy of pdf__SubAttributeListType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__SubAttributeListType::soap_del() deep deletes pdf__SubAttributeListType data members, use only after pdf__SubAttributeListType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__SubAttributeListType
{ public:
/// Vector of pdf__SubAttributeType* of length 1..unbounded.
    std::vector<pdf__SubAttributeType* > SubAttribute                   1;
/// A handle to the soap struct context that manages this instance when instantiated by a context or NULL otherwise (automatically set).
    struct soap                         *soap                          ;
};
...
///
/// class pdf__SubAttributeType operations:
/// - pdf__SubAttributeType* soap_new_pdf__SubAttributeType(soap*) allocate
/// - pdf__SubAttributeType* soap_new_pdf__SubAttributeType(soap*, int num) allocate array
/// - pdf__SubAttributeType* soap_new_req_pdf__SubAttributeType(soap*, ...) allocate, set required members
/// - pdf__SubAttributeType* soap_new_set_pdf__SubAttributeType(soap*, ...) allocate, set all public members
/// - pdf__SubAttributeType::soap_default(soap*) reset members to default
/// - int soap_read_pdf__SubAttributeType(soap*, pdf__SubAttributeType*) deserialize from a stream
/// - int soap_write_pdf__SubAttributeType(soap*, pdf__SubAttributeType*) serialize to a stream
/// - pdf__SubAttributeType* pdf__SubAttributeType::soap_dup(soap*) returns deep copy of pdf__SubAttributeType, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__SubAttributeType::soap_del() deep deletes pdf__SubAttributeType data members, use only after pdf__SubAttributeType::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__SubAttributeType
{ public:
/// Element "AttributeID" of XSD type xs:string.
    std::string                          AttributeID                    1;	///< Required element.
...
///
/// class pdf__SignResponse operations:
/// - pdf__SignResponse* soap_new_pdf__SignResponse(soap*) allocate
/// - pdf__SignResponse* soap_new_pdf__SignResponse(soap*, int num) allocate array
/// - pdf__SignResponse* soap_new_req_pdf__SignResponse(soap*, ...) allocate, set required members
/// - pdf__SignResponse* soap_new_set_pdf__SignResponse(soap*, ...) allocate, set all public members
/// - pdf__SignResponse::soap_default(soap*) reset members to default
/// - int soap_read_pdf__SignResponse(soap*, pdf__SignResponse*) deserialize from a stream
/// - int soap_write_pdf__SignResponse(soap*, pdf__SignResponse*) serialize to a stream
/// - pdf__SignResponse* pdf__SignResponse::soap_dup(soap*) returns deep copy of pdf__SignResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__SignResponse::soap_del() deep deletes pdf__SignResponse data members, use only after pdf__SignResponse::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__SignResponse
{ public:
/// Element "ProcessId" of XSD type xs:string.
    std::string                          ProcessId                      1;	///< Required element.
/// Element "Status" of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":Status.
    pdf__Status*                         Status                         1;	///< Required element.
...
///
/// class pdf__Status operations:
/// - pdf__Status* soap_new_pdf__Status(soap*) allocate
/// - pdf__Status* soap_new_pdf__Status(soap*, int num) allocate array
/// - pdf__Status* soap_new_req_pdf__Status(soap*, ...) allocate, set required members
/// - pdf__Status* soap_new_set_pdf__Status(soap*, ...) allocate, set all public members
/// - pdf__Status::soap_default(soap*) reset members to default
/// - int soap_read_pdf__Status(soap*, pdf__Status*) deserialize from a stream
/// - int soap_write_pdf__Status(soap*, pdf__Status*) serialize to a stream
/// - pdf__Status* pdf__Status::soap_dup(soap*) returns deep copy of pdf__Status, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - pdf__Status::soap_del() deep deletes pdf__Status data members, use only after pdf__Status::soap_dup(NULL) (use soapcpp2 -Ed)
class pdf__Status
{ public:
...
/// - ns6__EncapsulatedX509CertificateType* soap_new_ns6__EncapsulatedX509CertificateType(soap*) allocate
/// - ns6__EncapsulatedX509CertificateType* soap_new_ns6__EncapsulatedX509CertificateType(soap*, int num) allocate array
...
/// - ns6__EncapsulatedX509CertificateType::soap_default(soap*) reset members to default
...
/// - ns6__EncapsulatedCRLValueType* soap_new_ns6__EncapsulatedCRLValueType(soap*) allocate
/// - ns6__EncapsulatedCRLValueType* soap_new_ns6__EncapsulatedCRLValueType(soap*, int num) allocate array
...
/// - ns6__EncapsulatedCRLValueType::soap_default(soap*) reset members to default
...
/// - ns6__EncapsulatedOCSPValueType* soap_new_ns6__EncapsulatedOCSPValueType(soap*) allocate
/// - ns6__EncapsulatedOCSPValueType* soap_new_ns6__EncapsulatedOCSPValueType(soap*, int num) allocate array
...
/// - ns6__EncapsulatedOCSPValueType::soap_default(soap*) reset members to default
...
/// @brief Top-level root element "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":SignRequestWithAttach of XSD type "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature":SignRequestWithAttach.
...
//gsoap pdf  service name:	PDFSignatureWithAttachSoapBinding 
//gsoap pdf  service type:	PDFSignatureWithAttach 
//gsoap pdf  service port:	https://preprod.scap.autenticacao.gov.pt/PADES/PDFSignatureWithAttach 
//gsoap pdf  service namespace:	http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature 
//gsoap pdf  service transport:	http://schemas.xmlsoap.org/soap/http 
...
@section WSDL_bindings Service Bindings
  ...
  - @ref PDFSignatureWithAttachSoapBinding
...
@page PDFSignatureWithAttachSoapBinding Binding "PDFSignatureWithAttachSoapBinding"

@section PDFSignatureWithAttachSoapBinding_operations Operations of Binding "PDFSignatureWithAttachSoapBinding"

  - @ref __pdf__Sign

@section PDFSignatureWithAttachSoapBinding_ports Endpoints of Binding "PDFSignatureWithAttachSoapBinding"

  - https://preprod.scap.autenticacao.gov.pt/PADES/PDFSignatureWithAttach
 ...
 *                                                                            *
 * Service Binding                                                            *
 *   PDFSignatureWithAttachSoapBinding                                        *
 *                                                                            *
\******************************************************************************/
...
/** Operation "__pdf__Sign" of service binding "PDFSignatureWithAttachSoapBinding".

  - SOAP document/literal style messaging

  - Action: "http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/SignAttach"

  - Addressing input action: "http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/SignAttach"

  - Addressing output action: "http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/SignAttachResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___pdf__Sign(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    pdf__SignResponse                  &pdf__SignResponse_
  );
@endcode
...
C++ proxy class (defined in soapPDFSignatureWithAttachSoapBindingProxy.h):
@code
  class PDFSignatureWithAttachSoapBindingProxy;
@endcode
Important: use soapcpp2 option '-j' (or '-i') to generate improved and easy-to-use proxy classes;

C++ service class (defined in soapPDFSignatureWithAttachSoapBindingService.h):
@code
  class PDFSignatureWithAttachSoapBindingService;
@endcode
Important: use soapcpp2 option '-j' (or '-i') to generate improved and easy-to-use service classes;

*/

//gsoap pdf  service method-protocol:	Sign SOAP
//gsoap pdf  service method-style:	Sign document
//gsoap pdf  service method-encoding:	Sign literal
//gsoap pdf  service method-input-action:	Sign http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/SignAttach
//gsoap pdf  service method-output-action:	Sign http://www.cartaodecidadao.pt/services/ccc/PDFSignature/Operations/SignAttachResponse
int __pdf__Sign(
    pdf__SignRequestWithAttach*         pdf__SignRequestWithAttach_,	///< Input parameter
    pdf__SignResponse                  &pdf__SignResponse_	///< Output parameter
);
...
@section PDFSignatureWithAttachSoapBinding_policy_enablers Policy Enablers of Binding "PDFSignatureWithAttachSoapBinding"
...
@section pdf Top-level root elements of schema "http://www.cartaodecidadao.pt/ccc/sccc/services/PDFSignature"

  - <pdf:SignRequestWithAttach> @ref _pdf__SignRequestWithAttach
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__pdf__SignRequestWithAttach(struct soap*, _pdf__SignRequestWithAttach*);
    // Writer (returns SOAP_OK on success):
    soap_write__pdf__SignRequestWithAttach(struct soap*, _pdf__SignRequestWithAttach*);
    @endcode

  - <pdf:SignResponse> @ref _pdf__SignResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__pdf__SignResponse(struct soap*, _pdf__SignResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__pdf__SignResponse(struct soap*, _pdf__SignResponse*);
    @endcode
