...
@set PTEID_DIR_OPENSSL=C:\git\tools\build-scripts\windows\external-libs\openssl-1.1.1i-win32
...
@set PTEID_DIR_OPENSSL_X64=C:\git\tools\build-scripts\windows\external-libs\openssl-1.1.1i-x64
