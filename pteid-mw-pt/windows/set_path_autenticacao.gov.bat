...
@set PTEID_DIR_CURL=C:\git\tools\build-scripts\windows\external-libs\libcurl-7.80.0-x86
...
@set PTEID_DIR_CURL_X64=C:\git\tools\build-scripts\windows\external-libs\libcurl-7.80.0-x64
